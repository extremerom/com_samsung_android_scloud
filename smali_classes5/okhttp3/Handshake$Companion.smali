...
.method private final toImmutableList([Ljava/security/cert/Certificate;)Ljava/util/List;
    ...
    invoke-static {p1}, Ltb/c;->immutableListOf([Ljava/lang/Object;)Ljava/util/List;
...
.method public final get(Ljavax/net/ssl/SSLSession;)Lokhttp3/Handshake;
    ...
    invoke-virtual {v1, v0}, Lokhttp3/j$b;->forJavaName(Ljava/lang/String;)Lokhttp3/j;
    ...
    invoke-virtual {v2, v1}, Lokhttp3/TlsVersion$a;->forJavaName(Ljava/lang/String;)Lokhttp3/TlsVersion;
    ...
    invoke-direct {v3, v1, v0, p1, v4}, Lokhttp3/Handshake;-><init>(Lokhttp3/TlsVersion;Lokhttp3/j;Ljava/util/List;Lkotlin/jvm/functions/Function0;)V
...
.method public final get(Lokhttp3/TlsVersion;Lokhttp3/j;Ljava/util/List;Ljava/util/List;)Lokhttp3/Handshake;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p3}, Ltb/c;->toImmutableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p3

    new-instance v0, Lokhttp3/Handshake;

    invoke-static {p4}, Ltb/c;->toImmutableList(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-direct {v0, p1, p2, p4, v1}, Lokhttp3/Handshake;-><init>(Lokhttp3/TlsVersion;Lokhttp3/j;Ljava/util/List;Lkotlin/jvm/functions/Function0;)V
