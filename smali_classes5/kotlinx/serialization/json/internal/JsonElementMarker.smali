...
.method public constructor <init>(Lob/f;)V
    ...
    invoke-direct {v0, p1, v1}, Lqb/D;-><init>(Lob/f;Lkotlin/jvm/functions/Function2;)V

    iput-object v0, p0, Lkotlinx/serialization/json/internal/JsonElementMarker;->a:Lqb/D;

    return-void
.end method

.method public static final synthetic access$readIfAbsent(Lkotlinx/serialization/json/internal/JsonElementMarker;Lob/f;I)Z
    .locals 0

    invoke-direct {p0, p1, p2}, Lkotlinx/serialization/json/internal/JsonElementMarker;->readIfAbsent(Lob/f;I)Z
...
.method private final readIfAbsent(Lob/f;I)Z
    .locals 1
...
.method public final mark$kotlinx_serialization_json(I)V
    ...
    iget-object v0, p0, Lkotlinx/serialization/json/internal/JsonElementMarker;->a:Lqb/D;

    invoke-virtual {v0, p1}, Lqb/D;->mark(I)V
...
.method public final nextUnmarkedIndex$kotlinx_serialization_json()I
    ...
    invoke-virtual {v0}, Lqb/D;->nextUnmarkedIndex()I
