...
.field public static final l:Lbc/a;
...
.method static constructor <clinit>()V
    ...
    invoke-static {v0}, LA1/c;->c(Ljava/lang/String;)LHb/q;

    move-result-object v0

    const-string v1, "2.5.4.10"

    invoke-static {v1}, LA1/c;->c(Ljava/lang/String;)LHb/q;

    move-result-object v1

    const-string v2, "2.5.4.11"

    invoke-static {v2}, LA1/c;->c(Ljava/lang/String;)LHb/q;

    move-result-object v2

    const-string v3, "2.5.4.12"

    invoke-static {v3}, LA1/c;->c(Ljava/lang/String;)LHb/q;

    move-result-object v3

    const-string v4, "2.5.4.3"

    invoke-static {v4}, LA1/c;->c(Ljava/lang/String;)LHb/q;
    ...
    invoke-virtual {v5}, LHb/q;->r()LHb/q;

    new-instance v5, LHb/q;

    const-string v7, "2.5.4.9"

    invoke-direct {v5, v7}, LHb/q;-><init>(Ljava/lang/String;)V

    invoke-virtual {v5}, LHb/q;->r()LHb/q;

    move-result-object v5

    invoke-static {v6}, LA1/c;->c(Ljava/lang/String;)LHb/q;

    move-result-object v6

    const-string v7, "2.5.4.7"

    invoke-static {v7}, LA1/c;->c(Ljava/lang/String;)LHb/q;

    move-result-object v7

    const-string v8, "2.5.4.8"

    invoke-static {v8}, LA1/c;->c(Ljava/lang/String;)LHb/q;

    move-result-object v8

    const-string v9, "2.5.4.4"

    invoke-static {v9}, LA1/c;->c(Ljava/lang/String;)LHb/q;

    move-result-object v9

    const-string v10, "2.5.4.42"

    invoke-static {v10}, LA1/c;->c(Ljava/lang/String;)LHb/q;

    move-result-object v10

    const-string v11, "2.5.4.43"

    invoke-static {v11}, LA1/c;->c(Ljava/lang/String;)LHb/q;

    move-result-object v11

    const-string v12, "2.5.4.44"

    invoke-static {v12}, LA1/c;->c(Ljava/lang/String;)LHb/q;

    move-result-object v12

    const-string v13, "2.5.4.45"

    invoke-static {v13}, LA1/c;->c(Ljava/lang/String;)LHb/q;

    move-result-object v13

    const-string v14, "2.5.4.13"

    invoke-static {v14}, LA1/c;->c(Ljava/lang/String;)LHb/q;

    move-result-object v14

    const-string v15, "2.5.4.15"

    invoke-static {v15}, LA1/c;->c(Ljava/lang/String;)LHb/q;
    ...
    invoke-static/range {v16 .. v16}, LA1/c;->c(Ljava/lang/String;)LHb/q;
    ...
    invoke-direct {v13, v15}, LHb/q;-><init>(Ljava/lang/String;)V

    invoke-virtual {v13}, LHb/q;->r()LHb/q;

    sget-object v13, Lcc/D;->a:LHb/q;

    sget-object v15, Lcc/D;->b:LHb/q;

    move-object/from16 v29, v15

    sget-object v15, Lcc/D;->c:LHb/q;
    ...
    invoke-direct {v14, v12}, LHb/q;-><init>(Ljava/lang/String;)V

    new-instance v12, Ljava/util/Hashtable;

    invoke-direct {v12}, Ljava/util/Hashtable;-><init>()V

    sput-object v12, Lbc/a;->j:Ljava/util/Hashtable;
    ...
    sput-object v11, Lbc/a;->k:Ljava/util/Hashtable;
...
.method public constructor <init>()V
    ...
    sget-object v0, Lbc/a;->j:Ljava/util/Hashtable;

    invoke-static {v0}, Lsamsung/scsp/story/v1/u;->f(Ljava/util/Hashtable;)Ljava/util/Hashtable;

    move-result-object v0

    iput-object v0, p0, Lbc/a;->i:Ljava/util/Hashtable;

    sget-object v0, Lbc/a;->k:Ljava/util/Hashtable;
...
# virtual methods
.method public final z(Lac/c;)Ljava/lang/String;
    .locals 6
    ...
    iget-object v5, p0, Lbc/a;->i:Ljava/util/Hashtable;

    invoke-static {v0, v4, v5}, Lsamsung/scsp/usage/v1/x;->b(Ljava/lang/StringBuffer;Lac/b;Ljava/util/Hashtable;)V
