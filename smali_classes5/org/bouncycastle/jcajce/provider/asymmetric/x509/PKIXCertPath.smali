...
.method public constructor <init>(Ljava/io/InputStream;Ljava/lang/String;)V
    ...
    iget-object v2, v2, Lorg/bouncycastle/jcajce/util/a;->b:Ljava/lang/Object;
    ...
    invoke-static {p1}, LHb/C0;->a(Ljava/io/InputStream;)I

    move-result v0

    const/4 v3, 0x0

    invoke-direct {p2, p1, v0, v3}, LHb/k;-><init>(Ljava/io/InputStream;IZ)V

    invoke-virtual {p2}, LHb/k;->f()LHb/t;

    move-result-object p1

    instance-of p2, p1, LHb/x;
...
.method private toASN1Object(Ljava/security/cert/X509Certificate;)LHb/t;
    .locals 3
    ...
    invoke-direct {v0, p1}, LHb/k;-><init>([B)V
...
.method private toDEREncoded(LHb/g;)[B
    .locals 2
...
.method public getEncoded(Ljava/lang/String;)[B
    ...
    invoke-direct {p0, v1}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/PKIXCertPath;->toASN1Object(Ljava/security/cert/X509Certificate;)LHb/t;

    move-result-object v1

    invoke-virtual {p1, v1}, LHb/h;->a(LHb/g;)V
    ...
    invoke-direct {v0, p1}, LHb/x;-><init>(LHb/h;)V

    iput v2, v0, LHb/e0;->c:I

    invoke-direct {p0, v0}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/PKIXCertPath;->toDEREncoded(LHb/g;)[B
    ...
    sget-object v1, LUb/b;->M:LHb/q;

    const/4 v4, 0x0

    invoke-direct {p1, v1, v4}, LCc/l;-><init>(LHb/q;LUb/g;)V
    ...
    invoke-direct {p0, v4}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/PKIXCertPath;->toASN1Object(Ljava/security/cert/X509Certificate;)LHb/t;

    move-result-object v4

    invoke-virtual {v1, v4}, LHb/h;->a(LHb/g;)V
    ...
    invoke-direct {v4, v5, v6}, LHb/l;-><init>(J)V

    new-instance v5, LHb/f0;

    invoke-direct {v5}, LHb/f0;-><init>()V

    new-instance v6, LHb/f0;

    invoke-direct {v6, v1, v0}, LHb/y;-><init>(LHb/h;Z)V

    iput v2, v6, LHb/f0;->d:I
    ...
    iput-object v4, v3, LUb/g;->a:LHb/l;

    iput-object v5, v3, LUb/g;->b:LHb/f0;

    iput-object p1, v3, LUb/g;->c:LCc/l;

    iput-object v6, v3, LUb/g;->d:LHb/f0;

    iput-object v0, v3, LUb/g;->e:LHb/f0;

    new-instance p1, LCc/l;

    sget-object v0, LUb/b;->S:LHb/q;

    invoke-direct {p1, v0, v3}, LCc/l;-><init>(LHb/q;LUb/g;)V

    invoke-direct {p0, p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/PKIXCertPath;->toDEREncoded(LHb/g;)[B
    ...
    iput-object v4, v2, LXc/a;->a:Ljava/lang/String;

    sget-object v4, LXc/a;->d:Ljava/util/List;

    invoke-static {v4}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object v4

    iput-object v4, v2, LXc/a;->b:Ljava/util/List;

    iput-object v5, v2, LXc/a;->c:[B

    invoke-virtual {v1, v2}, LXc/b;->a(LXc/a;)V
