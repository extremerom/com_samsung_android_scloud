...
# direct methods
.method public constructor <init>(Lorg/bouncycastle/jcajce/util/b;Lcc/h;)V
    .locals 7

    invoke-static {p2}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CertificateObject;->createBasicConstraints(Lcc/h;)Lcc/g;

    move-result-object v3

    invoke-static {p2}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CertificateObject;->createKeyUsage(Lcc/h;)[Z

    move-result-object v4

    invoke-static {p2}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CertificateObject;->createSigAlgName(Lcc/h;)Ljava/lang/String;

    move-result-object v5

    invoke-static {p2}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CertificateObject;->createSigAlgParams(Lcc/h;)[B
    ...
    invoke-direct/range {v0 .. v6}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CertificateImpl;-><init>(Lorg/bouncycastle/jcajce/util/b;Lcc/h;Lcc/g;[ZLjava/lang/String;[B)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CertificateObject;->attrCarrier:Lpc/b;

    return-void
.end method

.method private static createBasicConstraints(Lcc/h;)Lcc/g;
    .locals 2

    :try_start_0
    const-string v0, "2.5.29.19"

    invoke-static {p0, v0}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CertificateImpl;->getExtensionOctets(Lcc/h;Ljava/lang/String;)[B
    ...
    invoke-static {p0}, Lcc/g;->d(LHb/t;)Lcc/g;
    ...
    invoke-static {v1, p0}, Landroidx/work/impl/c;->f(Ljava/lang/String;Ljava/lang/Exception;)Ljava/lang/String;
...
.method private static createKeyUsage(Lcc/h;)[Z
    .locals 7
...
.method private static createSigAlgName(Lcc/h;)Ljava/lang/String;
    .locals 2

    :try_start_0
    iget-object p0, p0, Lcc/h;->c:Lcc/a;

    invoke-static {p0}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/d;->b(Lcc/a;)Ljava/lang/String;
...
.method private static createSigAlgParams(Lcc/h;)[B
    .locals 2
...
.method private getInternalCertificate()Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CertificateInternal;
    ...
    iget-object v6, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CertificateImpl;->basicConstraints:Lcc/g;
    ...
    invoke-direct/range {v3 .. v11}, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CertificateInternal;-><init>(Lorg/bouncycastle/jcajce/util/b;Lcc/h;Lcc/g;[ZLjava/lang/String;[B[BLjava/security/cert/CertificateEncodingException;)V
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-object v2, p1, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CertificateImpl;->c:Lcc/h;

    iget-object v2, v2, Lcc/h;->d:LHb/c;
...
.method public getBagAttribute(LHb/q;)LHb/g;
    ...
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/x509/X509CertificateObject;->attrCarrier:Lpc/b;
