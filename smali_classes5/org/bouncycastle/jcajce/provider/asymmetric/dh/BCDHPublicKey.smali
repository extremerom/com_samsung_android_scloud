...
# instance fields
.field private transient dhPublicKey:Lic/e;

.field private transient dhSpec:Ljavax/crypto/spec/DHParameterSpec;

.field private transient info:Lcc/u;
...
.method public constructor <init>(Lcc/u;)V
    ...
    iput-object v1, v0, Lorg/bouncycastle/jcajce/provider/asymmetric/dh/BCDHPublicKey;->info:Lcc/u;

    :try_start_0
    invoke-virtual/range {p1 .. p1}, Lcc/u;->e()LHb/t;
    ...
    invoke-virtual {v2}, LHb/l;->p()Ljava/math/BigInteger;

    move-result-object v2

    iput-object v2, v0, Lorg/bouncycastle/jcajce/provider/asymmetric/dh/BCDHPublicKey;->y:Ljava/math/BigInteger;

    iget-object v1, v1, Lcc/u;->a:Lcc/a;

    iget-object v2, v1, Lcc/a;->b:LHb/g;
    ...
    invoke-direct {v0, v2}, Lorg/bouncycastle/jcajce/provider/asymmetric/dh/BCDHPublicKey;->isPKCSParam(LHb/x;)Z
    ...
    invoke-direct {v3, v2}, Ldc/c;-><init>(LHb/x;)V
    ...
    :goto_0
    iget-object v2, v3, Ldc/c;->e:Ldc/d;

    iget-object v4, v3, Ldc/c;->d:LHb/l;

    iget-object v5, v3, Ldc/c;->c:LHb/l;

    iget-object v6, v3, Ldc/c;->b:LHb/l;

    iget-object v3, v3, Ldc/c;->a:LHb/l;
    ...
    invoke-virtual {v6}, LHb/l;->o()Ljava/math/BigInteger;

    move-result-object v11

    invoke-virtual {v5}, LHb/l;->o()Ljava/math/BigInteger;
    ...
    :cond_2
    invoke-virtual {v4}, LHb/l;->o()Ljava/math/BigInteger;
    ...
    iget-object v4, v2, Ldc/d;->a:LHb/c;

    invoke-virtual {v4}, LHb/c;->o()[B

    move-result-object v4

    iget-object v2, v2, Ldc/d;->b:LHb/l;
    ...
    invoke-direct {v3, v4, v2}, Lic/f;-><init>([BI)V
    ...
    invoke-direct/range {v9 .. v16}, Lic/c;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;IILjava/math/BigInteger;Lic/f;)V

    invoke-direct {v7, v8, v2}, Lic/e;-><init>(Ljava/math/BigInteger;Lic/c;)V

    iput-object v7, v0, Lorg/bouncycastle/jcajce/provider/asymmetric/dh/BCDHPublicKey;->dhPublicKey:Lic/e;
    ...
    invoke-direct/range {v8 .. v15}, Lic/c;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;IILjava/math/BigInteger;Lic/f;)V

    invoke-direct {v2, v7, v3}, Lic/e;-><init>(Ljava/math/BigInteger;Lic/c;)V

    iput-object v2, v0, Lorg/bouncycastle/jcajce/provider/asymmetric/dh/BCDHPublicKey;->dhPublicKey:Lic/e;

    :goto_4
    new-instance v1, Loc/a;

    iget-object v2, v0, Lorg/bouncycastle/jcajce/provider/asymmetric/dh/BCDHPublicKey;->dhPublicKey:Lic/e;

    iget-object v2, v2, Lic/b;->b:Lic/c;

    invoke-direct {v1, v2}, Loc/a;-><init>(Lic/c;)V
    ...
    :cond_6
    :goto_5
    invoke-static {v2}, LUb/a;->d(LHb/x;)LUb/a;

    move-result-object v1

    invoke-virtual {v1}, LUb/a;->e()Ljava/math/BigInteger;

    move-result-object v2

    iget-object v3, v1, LUb/a;->b:LHb/l;

    iget-object v4, v1, LUb/a;->a:LHb/l;
    ...
    invoke-direct {v3, v4, v5, v6}, Lic/c;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;I)V

    invoke-direct {v1, v2, v3}, Lic/e;-><init>(Ljava/math/BigInteger;Lic/c;)V

    :goto_6
    iput-object v1, v0, Lorg/bouncycastle/jcajce/provider/asymmetric/dh/BCDHPublicKey;->dhPublicKey:Lic/e;
...
.method public constructor <init>(Lic/e;)V
    ...
    iget-object v1, p1, Lic/b;->b:Lic/c;

    invoke-direct {v0, v1}, Loc/a;-><init>(Lic/c;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/dh/BCDHPublicKey;->dhPublicKey:Lic/e;
...
.method public constructor <init>(Ljava/math/BigInteger;Ljavax/crypto/spec/DHParameterSpec;)V
    ...
    invoke-virtual {p2}, Loc/a;->a()Lic/c;

    move-result-object p2

    invoke-direct {v0, p1, p2}, Lic/e;-><init>(Ljava/math/BigInteger;Lic/c;)V

    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/dh/BCDHPublicKey;->dhPublicKey:Lic/e;
    ...
    invoke-direct {v1, v2, p2, v3}, Lic/c;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;I)V

    invoke-direct {v0, p1, v1}, Lic/e;-><init>(Ljava/math/BigInteger;Lic/c;)V
...
.method public constructor <init>(Ljavax/crypto/interfaces/DHPublicKey;)V
    ...
    invoke-virtual {p1}, Loc/a;->a()Lic/c;

    move-result-object p1

    invoke-direct {v0, v1, p1}, Lic/e;-><init>(Ljava/math/BigInteger;Lic/c;)V
    ...
    invoke-direct {v1, v2, v3, v4}, Lic/c;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;I)V

    invoke-direct {p1, v0, v1}, Lic/e;-><init>(Ljava/math/BigInteger;Lic/c;)V
...
.method public constructor <init>(Ljavax/crypto/spec/DHPublicKeySpec;)V
    ...
    invoke-direct {v2, v3, p1, v4}, Lic/c;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;I)V

    invoke-direct {v0, v1, v2}, Lic/e;-><init>(Ljava/math/BigInteger;Lic/c;)V
...
.method private readObject(Ljava/io/ObjectInputStream;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/dh/BCDHPublicKey;->info:Lcc/u;
...
# virtual methods
.method public engineGetKeyParameters()Lic/e;
    .locals 1

    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/dh/BCDHPublicKey;->dhPublicKey:Lic/e;
...
.method public getEncoded()[B
    ...
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/dh/BCDHPublicKey;->info:Lcc/u;
    ...
    iget-object v2, v1, Loc/a;->a:Ljava/math/BigInteger;

    if-eqz v2, :cond_8

    invoke-virtual {v1}, Loc/a;->a()Lic/c;

    move-result-object v0

    iget-object v1, v0, Lic/c;->g:Lic/f;
    ...
    iget-object v4, v1, Lic/f;->a:[B

    invoke-static {v4}, Lorg/bouncycastle/util/d;->c([B)[B

    move-result-object v4

    iget v1, v1, Lic/f;->b:I

    invoke-direct {v3, v4, v1}, Ldc/d;-><init>([BI)V
    ...
    sget-object v4, Ldc/m;->P0:LHb/q;

    iget-object v5, v0, Lic/c;->b:Ljava/math/BigInteger;

    if-eqz v5, :cond_7

    iget-object v6, v0, Lic/c;->a:Ljava/math/BigInteger;

    if-eqz v6, :cond_6

    iget-object v7, v0, Lic/c;->c:Ljava/math/BigInteger;

    if-eqz v7, :cond_5

    new-instance v8, LHb/l;

    invoke-direct {v8, v5}, LHb/l;-><init>(Ljava/math/BigInteger;)V

    new-instance v5, LHb/l;

    invoke-direct {v5, v6}, LHb/l;-><init>(Ljava/math/BigInteger;)V

    new-instance v6, LHb/l;

    invoke-direct {v6, v7}, LHb/l;-><init>(Ljava/math/BigInteger;)V

    iget-object v0, v0, Lic/c;->d:Ljava/math/BigInteger;

    if-eqz v0, :cond_2

    new-instance v2, LHb/l;

    invoke-direct {v2, v0}, LHb/l;-><init>(Ljava/math/BigInteger;)V
    ...
    invoke-direct {v0, v7}, LHb/h;-><init>(I)V

    invoke-virtual {v0, v8}, LHb/h;->a(LHb/g;)V

    invoke-virtual {v0, v5}, LHb/h;->a(LHb/g;)V
    ...
    invoke-direct {v1, v4, v2}, Lcc/a;-><init>(LHb/q;LHb/g;)V
    ...
    invoke-direct {v0, v2}, LHb/l;-><init>(Ljava/math/BigInteger;)V

    :goto_1
    invoke-static {v1, v0}, Lsamsung/scsp/plan/v1/d0;->o(Lcc/a;LHb/n;)[B
    ...
    invoke-direct {v3, v0, v4, v5}, LUb/a;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;I)V

    invoke-virtual {v3}, LUb/a;->toASN1Primitive()LHb/t;
...
.method public toString()Ljava/lang/String;
    ...
    const-string v3, "DH Public Key ["

    invoke-direct {v2, v3}, Ljava/lang/StringBuffer;-><init>(Ljava/lang/String;)V

    sget-object v3, Lorg/bouncycastle/util/h;->a:Ljava/lang/String;

    invoke-static {v0, v1}, Lsamsung/scsp/gallery/admin/v1/a;->e(Ljava/math/BigInteger;Lic/c;)Ljava/lang/String;
