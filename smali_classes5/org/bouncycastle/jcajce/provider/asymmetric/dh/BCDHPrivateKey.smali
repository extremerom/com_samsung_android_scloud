...
.field private transient dhPrivateKey:Lic/d;

.field private transient dhSpec:Ljavax/crypto/spec/DHParameterSpec;

.field private transient info:LUb/c;
...
.method public constructor <init>(LUb/c;)V
    ...
    iget-object v2, v1, LUb/c;->b:Lcc/a;

    iget-object v2, v2, Lcc/a;->b:LHb/g;
    ...
    iget-object v4, v1, LUb/c;->b:Lcc/a;

    iget-object v4, v4, Lcc/a;->a:LHb/q;

    iput-object v1, v0, Lorg/bouncycastle/jcajce/provider/asymmetric/dh/BCDHPrivateKey;->info:LUb/c;
    ...
    invoke-virtual {v4, v1}, LHb/t;->j(LHb/t;)Z
    ...
    invoke-direct {v6, v4, v3, v1}, Lic/c;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;I)V

    invoke-direct {v2, v5, v6}, Lic/d;-><init>(Ljava/math/BigInteger;Lic/c;)V
    ...
    invoke-direct {v5, v4, v3, v6}, Lic/c;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;I)V

    invoke-direct {v1, v2, v5}, Lic/d;-><init>(Ljava/math/BigInteger;Lic/c;)V

    iput-object v1, v0, Lorg/bouncycastle/jcajce/provider/asymmetric/dh/BCDHPrivateKey;->dhPrivateKey:Lic/d;
    ...
    iget-object v4, v3, Ldc/c;->a:LHb/l;

    invoke-virtual {v4}, LHb/l;->o()Ljava/math/BigInteger;

    move-result-object v7

    iget-object v11, v3, Ldc/c;->c:LHb/l;

    invoke-virtual {v11}, LHb/l;->o()Ljava/math/BigInteger;

    move-result-object v8

    iget-object v12, v3, Ldc/c;->b:LHb/l;

    invoke-virtual {v12}, LHb/l;->o()Ljava/math/BigInteger;

    move-result-object v9

    iget-object v13, v3, Ldc/c;->d:LHb/l;
    ...
    :cond_3
    invoke-virtual {v13}, LHb/l;->o()Ljava/math/BigInteger;
    ...
    invoke-direct/range {v4 .. v10}, Loc/a;-><init>(IILjava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)V
    ...
    invoke-direct/range {v14 .. v21}, Lic/c;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;IILjava/math/BigInteger;Lic/f;)V

    invoke-direct {v2, v4, v5}, Lic/d;-><init>(Ljava/math/BigInteger;Lic/c;)V

    :goto_4
    iput-object v2, v0, Lorg/bouncycastle/jcajce/provider/asymmetric/dh/BCDHPrivateKey;->dhPrivateKey:Lic/d;
...
.method public constructor <init>(Lic/d;)V
    ...
    iget-object v0, p1, Lic/d;->c:Ljava/math/BigInteger;
    ...
    invoke-direct {v0, p1}, Loc/a;-><init>(Lic/c;)V
...
.method private readObject(Ljava/io/ObjectInputStream;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/dh/BCDHPrivateKey;->info:LUb/c;
...
# virtual methods
.method public engineGetKeyParameters()Lic/d;
    .locals 6

    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/dh/BCDHPrivateKey;->dhPrivateKey:Lic/d;
    ...
    invoke-virtual {v0}, Loc/a;->a()Lic/c;

    move-result-object v0

    invoke-direct {v1, v2, v0}, Lic/d;-><init>(Ljava/math/BigInteger;Lic/c;)V
    ...
    invoke-direct {v3, v0, v4, v5}, Lic/c;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;I)V

    invoke-direct {v1, v2, v3}, Lic/d;-><init>(Ljava/math/BigInteger;Lic/c;)V
...
.method public getBagAttribute(LHb/q;)LHb/g;
    ...
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/dh/BCDHPrivateKey;->attrCarrier:Lorg/bouncycastle/jcajce/provider/asymmetric/util/e;
...
.method public getEncoded()[B
    ...
    :try_start_0
    iget-object v1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/dh/BCDHPrivateKey;->info:LUb/c;
    ...
    iget-object v2, v2, Loc/a;->a:Ljava/math/BigInteger;
    ...
    iget-object v2, v1, Lic/c;->g:Lic/f;

    if-eqz v2, :cond_1

    new-instance v3, Ldc/d;

    iget-object v4, v2, Lic/f;->a:[B

    invoke-static {v4}, Lorg/bouncycastle/util/d;->c([B)[B

    move-result-object v4

    iget v2, v2, Lic/f;->b:I

    invoke-direct {v3, v4, v2}, Ldc/d;-><init>([BI)V
    ...
    sget-object v5, Ldc/m;->P0:LHb/q;

    iget-object v6, v1, Lic/c;->b:Ljava/math/BigInteger;

    iget-object v7, v1, Lic/c;->a:Ljava/math/BigInteger;

    iget-object v8, v1, Lic/c;->c:Ljava/math/BigInteger;

    iget-object v1, v1, Lic/c;->d:Ljava/math/BigInteger;
    ...
    invoke-direct {v9, v6}, LHb/l;-><init>(Ljava/math/BigInteger;)V
    ...
    invoke-direct {v7, v8}, LHb/l;-><init>(Ljava/math/BigInteger;)V

    if-eqz v1, :cond_2

    new-instance v8, LHb/l;

    invoke-direct {v8, v1}, LHb/l;-><init>(Ljava/math/BigInteger;)V
    ...
    invoke-direct {v1, v10}, LHb/h;-><init>(I)V

    invoke-virtual {v1, v9}, LHb/h;->a(LHb/g;)V

    invoke-virtual {v1, v6}, LHb/h;->a(LHb/g;)V

    invoke-virtual {v1, v7}, LHb/h;->a(LHb/g;)V

    if-eqz v8, :cond_3

    invoke-virtual {v1, v8}, LHb/h;->a(LHb/g;)V
    ...
    invoke-direct {v4, v5, v3}, Lcc/a;-><init>(LHb/q;LHb/g;)V
    ...
    invoke-direct {v1, v3}, LHb/l;-><init>(Ljava/math/BigInteger;)V

    invoke-direct {v2, v4, v1, v0, v0}, LUb/c;-><init>(Lcc/a;LHb/n;LHb/y;[B)V
    ...
    invoke-direct {v5, v1, v6, v7}, LUb/a;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;I)V

    invoke-virtual {v5}, LUb/a;->toASN1Primitive()LHb/t;
    ...
    invoke-direct {v1, v4}, LHb/l;-><init>(Ljava/math/BigInteger;)V

    invoke-direct {v2, v3, v1, v0, v0}, LUb/c;-><init>(Lcc/a;LHb/n;LHb/y;[B)V
...
.method public toString()Ljava/lang/String;
    ...
    const-string v3, "DH Private Key ["

    invoke-direct {v2, v3}, Ljava/lang/StringBuffer;-><init>(Ljava/lang/String;)V

    sget-object v3, Lorg/bouncycastle/util/h;->a:Ljava/lang/String;

    iget-object v4, v1, Lic/c;->a:Ljava/math/BigInteger;

    iget-object v5, v1, Lic/c;->b:Ljava/math/BigInteger;
