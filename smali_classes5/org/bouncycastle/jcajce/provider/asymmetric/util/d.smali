...
.method static constructor <clinit>()V
    ...
    sget-object v0, Lgc/b;->e:Ljava/util/Vector;
    ...
    sget-object v2, Ldc/f;->a:Ljava/util/Hashtable;
    ...
    sget-object v4, Ldc/f;->b:Ljava/util/Hashtable;
    ...
    sget-object v2, LWb/d;->a:Ljava/util/Hashtable;
    ...
    :cond_2
    sget-object v4, LWb/d;->b:Ljava/util/Hashtable;
    ...
    sget-object v2, LSb/a;->a:Ljava/util/Hashtable;
    ...
    sget-object v2, LXb/a;->a:Ljava/util/Hashtable;
    ...
    sget-object v4, LXb/a;->b:Ljava/util/Hashtable;
    ...
    sget-object v2, LIb/b;->a:Ljava/util/Hashtable;
    ...
    :cond_a
    sget-object v4, LIb/b;->b:Ljava/util/Hashtable;
    ...
    sget-object v2, LLb/b;->a:Ljava/util/Hashtable;
    ...
    :cond_d
    invoke-static {v2}, LLb/b;->b(LHb/q;)Ldc/i;
    ...
    sget-object v2, LNb/a;->a:Ljava/util/Hashtable;
    ...
    :cond_f
    sget-object v4, LNb/a;->b:Ljava/util/Hashtable;
    ...
    invoke-static {v1}, Lgc/b;->d(Ljava/lang/String;)Ldc/i;

    move-result-object v1

    iget-object v1, v1, Ldc/i;->b:Lrc/h;

    iget-object v2, v2, Ldc/i;->b:Lrc/h;
    ...
    iget-object v6, v0, Lrc/h;->d:Ljava/math/BigInteger;

    iget-object v7, v0, Lrc/h;->e:Ljava/math/BigInteger;
...
.method public static a(Lrc/h;)Ljava/security/spec/EllipticCurve;
    .locals 9

    iget-object v0, p0, Lrc/h;->a:Lyc/a;

    invoke-interface {v0}, Lyc/a;->getDimension()I
    ...
    iget-object v0, v0, Lyc/d;->b:Lyc/c;
    ...
    iget-object p0, p0, Lrc/h;->c:Lrc/w;
...
.method public static b(Ljava/security/spec/EllipticCurve;)Lrc/h;
    .locals 10
    ...
    invoke-direct/range {v1 .. v7}, Lrc/f;-><init>(IIIILjava/math/BigInteger;Ljava/math/BigInteger;)V
...
.method public static c(Lrc/p;)Ljava/security/spec/ECPoint;
    .locals 2
...
.method public static d(Ljava/security/spec/ECParameterSpec;Ljava/security/spec/ECPoint;)Lrc/p;
    .locals 0
    ...
    invoke-static {p0}, Lorg/bouncycastle/jcajce/provider/asymmetric/util/d;->b(Ljava/security/spec/EllipticCurve;)Lrc/h;

    move-result-object p0

    invoke-static {p0, p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/util/d;->e(Lrc/h;Ljava/security/spec/ECPoint;)Lrc/p;
...
.method public static e(Lrc/h;Ljava/security/spec/ECPoint;)Lrc/p;
    .locals 1
...
.method public static f(Ljava/security/spec/EllipticCurve;Lqc/d;)Ljava/security/spec/ECParameterSpec;
    .locals 8

    iget-object v0, p1, Lqc/d;->c:Lrc/p;
    ...
    iget-object v2, v0, Lqc/b;->f:Ljava/lang/String;

    iget-object v5, p1, Lqc/d;->d:Ljava/math/BigInteger;

    iget-object v6, p1, Lqc/d;->e:Ljava/math/BigInteger;

    move-object v1, v7

    move-object v3, p0

    invoke-direct/range {v1 .. v6}, Lqc/c;-><init>(Ljava/lang/String;Ljava/security/spec/EllipticCurve;Ljava/security/spec/ECPoint;Ljava/math/BigInteger;Ljava/math/BigInteger;)V
    ...
    iget-object v1, p1, Lqc/d;->e:Ljava/math/BigInteger;

    invoke-virtual {v1}, Ljava/math/BigInteger;->intValue()I

    move-result v1

    iget-object p1, p1, Lqc/d;->d:Ljava/math/BigInteger;
...
.method public static g(Ljava/security/spec/ECParameterSpec;)Lqc/d;
    .locals 9
    ...
    invoke-static {v0, v1}, Lorg/bouncycastle/jcajce/provider/asymmetric/util/d;->e(Lrc/h;Ljava/security/spec/ECPoint;)Lrc/p;
    ...
    invoke-direct/range {v1 .. v7}, Lqc/b;-><init>(Ljava/lang/String;Lrc/h;Lrc/p;Ljava/math/BigInteger;Ljava/math/BigInteger;[B)V
    ...
    invoke-direct/range {v1 .. v6}, Lqc/d;-><init>(Lrc/h;Lrc/p;Ljava/math/BigInteger;Ljava/math/BigInteger;[B)V

    return-object p0
.end method

.method public static h(Ldc/g;Lrc/h;)Ljava/security/spec/ECParameterSpec;
    .locals 8

    iget-object p0, p0, Ldc/g;->a:LHb/t;
    ...
    invoke-static {p0}, Lsamsung/scsp/gallery/v1/m1;->i(LHb/q;)Ldc/i;

    move-result-object v0

    if-nez v0, :cond_0

    sget-object v1, Lorg/bouncycastle/jce/provider/BouncyCastleProvider;->CONFIGURATION:Lmc/a;
    ...
    invoke-static {p0}, Lsamsung/scsp/gallery/v1/m1;->c(LHb/q;)Ljava/lang/String;

    move-result-object v3

    iget-object p0, v0, Ldc/i;->c:Ldc/k;

    invoke-virtual {p0}, Ldc/k;->d()Lrc/p;

    move-result-object p0

    invoke-static {p0}, Lorg/bouncycastle/jcajce/provider/asymmetric/util/d;->c(Lrc/p;)Ljava/security/spec/ECPoint;
    ...
    invoke-static {p0}, Ldc/i;->d(LHb/t;)Ldc/i;

    move-result-object p0

    iget-object v0, p0, Ldc/i;->f:[B
    ...
    iget-object v0, p0, Ldc/i;->e:Ljava/math/BigInteger;
    ...
    iget-object p0, p0, Ldc/i;->e:Ljava/math/BigInteger;
    ...
    iget-object p0, p0, Ldc/i;->d:Ljava/math/BigInteger;
    ...
    :cond_4
    invoke-static {p0}, LLb/e;->d(Ljava/lang/Object;)LLb/e;

    move-result-object p0

    iget-object p1, p0, LLb/e;->a:LHb/q;
    ...
    iget-object p0, p1, Lqc/d;->c:Lrc/p;
...
.method public static i(Lmc/a;Ldc/g;)Lrc/h;
    .locals 2
    ...
    iget-object p1, p1, Ldc/g;->a:LHb/t;

    instance-of v1, p1, LHb/q;

    if-eqz v1, :cond_3

    invoke-static {p1}, LHb/q;->q(Ljava/lang/Object;)LHb/q;
    ...
    :cond_1
    :goto_0
    invoke-static {p1}, Lsamsung/scsp/gallery/v1/m1;->i(LHb/q;)Ldc/i;
    ...
    :cond_2
    iget-object p0, v0, Ldc/i;->b:Lrc/h;
    ...
    iget-object p0, p0, Lqc/d;->a:Lrc/h;
    ...
    :goto_1
    iget-object p0, p0, Ldc/i;->b:Lrc/h;
...
.method public static j(Lmc/a;Ljava/security/spec/ECParameterSpec;)Lic/l;
    .locals 6
    ...
    iget-object v1, p0, Lqc/d;->a:Lrc/h;

    iget-object v2, p0, Lqc/d;->c:Lrc/p;

    iget-object v3, p0, Lqc/d;->d:Ljava/math/BigInteger;

    iget-object v4, p0, Lqc/d;->e:Ljava/math/BigInteger;
    ...
    :cond_0
    invoke-static {p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/util/d;->g(Ljava/security/spec/ECParameterSpec;)Lqc/d;

    move-result-object p1

    invoke-static {p0, p1}, Lsamsung/scsp/gallery/v1/m1;->f(Lmc/a;Lqc/d;)Lic/l;
