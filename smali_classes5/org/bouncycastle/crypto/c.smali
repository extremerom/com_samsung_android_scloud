...
.method static constructor <clinit>()V
    ...
    new-instance v5, Lic/k;

    const-string v6, "b869c82b35d70e1b1ff91b28e37a62ecdc34409b"

    invoke-static {v6}, LVc/c;->c(Ljava/lang/String;)[B

    move-result-object v6

    const/16 v7, 0x7b

    invoke-direct {v5, v6, v7}, Lic/k;-><init>([BI)V

    invoke-direct {v0, v1, v2, v4, v5}, Lic/h;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Lic/k;)V
    ...
    invoke-static {v7}, LVc/c;->c(Ljava/lang/String;)[B

    move-result-object v7

    const/16 v8, 0x107

    invoke-direct {v6, v7, v8}, Lic/k;-><init>([BI)V

    invoke-direct {v1, v2, v4, v5, v6}, Lic/h;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Lic/k;)V
    ...
    invoke-static {v8}, LVc/c;->c(Ljava/lang/String;)[B

    move-result-object v8

    const/16 v9, 0x5c

    invoke-direct {v7, v8, v9}, Lic/k;-><init>([BI)V

    invoke-direct {v2, v4, v5, v6, v7}, Lic/h;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Lic/k;)V
    ...
    invoke-direct {v3, v8, v9}, Lic/k;-><init>([BI)V

    invoke-direct {v4, v5, v6, v7, v3}, Lic/h;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Lic/k;)V

    filled-new-array {v0, v1, v2, v4}, [Lic/h;
    ...
    invoke-static {v0}, Lorg/bouncycastle/crypto/c;->b(Lic/h;)Lic/c;

    move-result-object v0

    invoke-static {v1}, Lorg/bouncycastle/crypto/c;->b(Lic/h;)Lic/c;

    move-result-object v1

    invoke-static {v2}, Lorg/bouncycastle/crypto/c;->b(Lic/h;)Lic/c;

    move-result-object v2

    invoke-static {v4}, Lorg/bouncycastle/crypto/c;->b(Lic/h;)Lic/c;

    move-result-object v3

    filled-new-array {v0, v1, v2, v3}, [Lic/c;
...
.method public static b(Lic/h;)Lic/c;
    .locals 9

    iget-object v0, p0, Lic/h;->c:Ljava/math/BigInteger;
    ...
    iget-object v1, p0, Lic/h;->d:Lic/k;

    iget-object v2, v1, Lic/k;->a:[B

    invoke-static {v2}, Lorg/bouncycastle/util/d;->c([B)[B

    move-result-object v2

    iget v1, v1, Lic/k;->b:I

    invoke-direct {v8, v2, v1}, Lic/f;-><init>([BI)V

    iget-object v2, p0, Lic/h;->c:Ljava/math/BigInteger;

    iget-object v3, p0, Lic/h;->a:Ljava/math/BigInteger;

    iget-object v4, p0, Lic/h;->b:Ljava/math/BigInteger;
