...
.method private verifyLabel(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v2, v0, p1}, Landroidx/compose/ui/input/pointer/a;->C(IILjava/lang/String;)Ljava/lang/String;
...
.method public getCACerts()Lorg/spongycastle/est/CACertsResponse;
    ...
    invoke-virtual {v1, v0}, Lorg/spongycastle/est/HttpUtil$Headers;->getFirstValue(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v3, v0}, Lorg/spongycastle/est/HttpUtil$Headers;->getFirstValue(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v1, v0, v4, v2, v3}, Lorg/spongycastle/est/ESTException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;ILjava/io/InputStream;)V
    ...
    new-instance v2, Lorg/spongycastle/cmc/SimplePKIResponse;
    ...
    invoke-direct {v2, v0}, Lorg/spongycastle/cmc/SimplePKIResponse;-><init>(Lorg/spongycastle/asn1/cms/ContentInfo;)V

    invoke-virtual {v2}, Lorg/spongycastle/cmc/SimplePKIResponse;->getCertificates()Lorg/spongycastle/util/Store;

    move-result-object v0

    invoke-virtual {v2}, Lorg/spongycastle/cmc/SimplePKIResponse;->getCRLs()Lorg/spongycastle/util/Store;
    ...
    invoke-direct {v2, v1, v0, v3, v4}, Lorg/spongycastle/est/ESTException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;ILjava/io/InputStream;)V
    ...
    instance-of v0, v1, Lorg/spongycastle/est/ESTException;
    ...
    invoke-direct {v0, v2, v1, v3, v4}, Lorg/spongycastle/est/ESTException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;ILjava/io/InputStream;)V
    ...
    invoke-direct {v0, v1, v4, v2, v3}, Lorg/spongycastle/est/ESTException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;ILjava/io/InputStream;)V
...
.method public getCSRAttributes()Lorg/spongycastle/est/CSRRequestResponse;
    ...
    invoke-interface {v4}, Lorg/spongycastle/est/ESTClientProvider;->makeClient()Lorg/spongycastle/est/ESTClient;

    move-result-object v4

    new-instance v5, Lorg/spongycastle/est/ESTRequestBuilder;

    const-string v6, "GET"

    invoke-direct {v5, v6, v3}, Lorg/spongycastle/est/ESTRequestBuilder;-><init>(Ljava/lang/String;Ljava/net/URL;)V

    invoke-virtual {v5, v4}, Lorg/spongycastle/est/ESTRequestBuilder;->withClient(Lorg/spongycastle/est/ESTClient;)Lorg/spongycastle/est/ESTRequestBuilder;

    move-result-object v5

    invoke-virtual {v5}, Lorg/spongycastle/est/ESTRequestBuilder;->build()Lorg/spongycastle/est/ESTRequest;

    move-result-object v5

    invoke-interface {v4, v5}, Lorg/spongycastle/est/ESTClient;->doRequest(Lorg/spongycastle/est/ESTRequest;)Lorg/spongycastle/est/ESTResponse;
    ...
    :try_start_1
    invoke-virtual {v4}, Lorg/spongycastle/est/ESTResponse;->getStatusCode()I
    ...
    invoke-virtual {v5}, Lorg/spongycastle/est/ESTRequest;->getURL()Ljava/net/URL;
    ...
    invoke-virtual {v4}, Lorg/spongycastle/est/ESTResponse;->getInputStream()Ljava/io/InputStream;

    move-result-object v5

    invoke-direct {v1, v0, v2, v3, v5}, Lorg/spongycastle/est/ESTException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;ILjava/io/InputStream;)V
    ...
    :cond_2
    :try_start_2
    invoke-virtual {v4}, Lorg/spongycastle/est/ESTResponse;->getContentLength()Ljava/lang/Long;
    ...
    invoke-direct {v0, v5}, Lorg/spongycastle/asn1/ASN1InputStream;-><init>(Ljava/io/InputStream;)V
    ...
    new-instance v5, Lorg/spongycastle/est/CSRAttributesResponse;

    invoke-static {v0}, Lorg/spongycastle/asn1/est/CsrAttrs;->getInstance(Ljava/lang/Object;)Lorg/spongycastle/asn1/est/CsrAttrs;

    move-result-object v0

    invoke-direct {v5, v0}, Lorg/spongycastle/est/CSRAttributesResponse;-><init>(Lorg/spongycastle/asn1/est/CsrAttrs;)V
    :try_end_2
    ...
    invoke-direct {v1, v3, v0, v4, v2}, Lorg/spongycastle/est/ESTException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;ILjava/io/InputStream;)V
    ...
    invoke-virtual {v4}, Lorg/spongycastle/est/ESTResponse;->getSource()Lorg/spongycastle/est/Source;

    move-result-object v1

    invoke-direct {v0, v5, v1}, Lorg/spongycastle/est/CSRRequestResponse;-><init>(Lorg/spongycastle/est/CSRAttributesResponse;Lorg/spongycastle/est/Source;)V
    ...
    invoke-direct {v2, v1, v0, v3, v5}, Lorg/spongycastle/est/ESTException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;ILjava/io/InputStream;)V
...
.method public handleEnrollResponse(Lorg/spongycastle/est/ESTResponse;)Lorg/spongycastle/est/EnrollmentResponse;
    ...
    invoke-direct {v1, v0, v2, v3, p1}, Lorg/spongycastle/est/ESTException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;ILjava/io/InputStream;)V
    ...
    invoke-direct {v0, v1, v2, v3, p1}, Lorg/spongycastle/est/ESTException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;ILjava/io/InputStream;)V
