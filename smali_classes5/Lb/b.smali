...
.method static constructor <clinit>()V
    ...
    invoke-static {v3}, LLb/b;->a(Ljava/lang/String;)Ljava/math/BigInteger;

    move-result-object v5

    const-string v10, "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF6C611070995AD10045841B09B761B893"

    invoke-static {v10}, LLb/b;->a(Ljava/lang/String;)Ljava/math/BigInteger;
    ...
    invoke-static/range {v17 .. v17}, LLb/b;->a(Ljava/lang/String;)Ljava/math/BigInteger;

    move-result-object v6

    const-string v18, "A6"

    invoke-static/range {v18 .. v18}, LLb/b;->a(Ljava/lang/String;)Ljava/math/BigInteger;

    move-result-object v7

    sget-object v15, Lrc/a;->b:Ljava/math/BigInteger;
    ...
    invoke-direct/range {v4 .. v9}, Lrc/g;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)V

    new-instance v4, Lic/l;

    const-string v5, "8D91E471E0989CDA27DF505A453F2B7635294F2DDF23E3B122ACC99C9E9F1E14"

    invoke-static {v5}, LLb/b;->a(Ljava/lang/String;)Ljava/math/BigInteger;

    move-result-object v6

    invoke-virtual {v12, v15, v6}, Lrc/h;->c(Ljava/math/BigInteger;Ljava/math/BigInteger;)Lrc/p;

    move-result-object v13

    invoke-static {v13}, Lrc/w;->d(Lrc/p;)V
    ...
    invoke-direct/range {v11 .. v16}, Lic/l;-><init>(Lrc/h;Lrc/p;Ljava/math/BigInteger;Ljava/math/BigInteger;[B)V

    sget-object v7, LLb/a;->h:LHb/q;
    ...
    invoke-direct/range {v19 .. v24}, Lrc/g;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)V
    ...
    invoke-virtual {v8, v6, v5}, Lrc/h;->c(Ljava/math/BigInteger;Ljava/math/BigInteger;)Lrc/p;

    move-result-object v21

    invoke-static/range {v21 .. v21}, Lrc/w;->d(Lrc/p;)V
    ...
    invoke-direct/range {v19 .. v24}, Lic/l;-><init>(Lrc/h;Lrc/p;Ljava/math/BigInteger;Ljava/math/BigInteger;[B)V

    sget-object v4, LLb/a;->k:LHb/q;
    ...
    invoke-static {v9}, LLb/b;->a(Ljava/lang/String;)Ljava/math/BigInteger;
    ...
    invoke-virtual {v8, v6, v10}, Lrc/h;->c(Ljava/math/BigInteger;Ljava/math/BigInteger;)Lrc/p;
    ...
    invoke-static {v8}, LLb/b;->a(Ljava/lang/String;)Ljava/math/BigInteger;
    ...
    invoke-static {v12}, LLb/b;->a(Ljava/lang/String;)Ljava/math/BigInteger;

    move-result-object v21

    const-string v13, "805A"

    invoke-static {v13}, LLb/b;->a(Ljava/lang/String;)Ljava/math/BigInteger;
    ...
    new-instance v14, Lic/l;

    sget-object v15, Lrc/a;->a:Ljava/math/BigInteger;

    const-string v16, "41ECE55743711A8C3CBF3783CD08C0EE4D4DC440D4641A8F366E550DFDB3BB67"

    move-object/from16 v17, v2

    invoke-static/range {v16 .. v16}, LLb/b;->a(Ljava/lang/String;)Ljava/math/BigInteger;

    move-result-object v2

    invoke-virtual {v11, v15, v2}, Lrc/h;->c(Ljava/math/BigInteger;Ljava/math/BigInteger;)Lrc/p;
    ...
    new-instance v10, Lic/l;

    invoke-static/range {v16 .. v16}, LLb/b;->a(Ljava/lang/String;)Ljava/math/BigInteger;

    move-result-object v11

    invoke-virtual {v9, v15, v11}, Lrc/h;->c(Ljava/math/BigInteger;Ljava/math/BigInteger;)Lrc/p;
    ...
    sget-object v9, Lrc/a;->e:Ljava/math/BigInteger;
    ...
    invoke-direct/range {v11 .. v16}, Lrc/g;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)V

    new-instance v10, Lic/l;

    const-string v11, "91E38443A5E82C0D880923425712B2BB658B9196932E02C78B2582FE742DAA28"

    invoke-static {v11}, LLb/b;->a(Ljava/lang/String;)Ljava/math/BigInteger;
    ...
    invoke-virtual {v3, v11, v12}, Lrc/h;->c(Ljava/math/BigInteger;Ljava/math/BigInteger;)Lrc/p;

    move-result-object v20

    invoke-static/range {v20 .. v20}, Lrc/w;->d(Lrc/p;)V
    ...
    invoke-direct/range {v18 .. v23}, Lic/l;-><init>(Lrc/h;Lrc/p;Ljava/math/BigInteger;Ljava/math/BigInteger;[B)V

    sget-object v3, LVb/a;->e:LHb/q;
    ...
    new-instance v13, Lic/l;

    sget-object v14, Lrc/a;->d:Ljava/math/BigInteger;
    ...
    invoke-static {v15}, LLb/b;->a(Ljava/lang/String;)Ljava/math/BigInteger;

    move-result-object v15

    invoke-virtual {v12, v14, v15}, Lrc/h;->c(Ljava/math/BigInteger;Ljava/math/BigInteger;)Lrc/p;
    ...
    invoke-static {v14}, LLb/b;->a(Ljava/lang/String;)Ljava/math/BigInteger;
    ...
    sget-object v15, Lrc/a;->c:Ljava/math/BigInteger;
    ...
    invoke-virtual {v13, v15, v11}, Lrc/h;->c(Ljava/math/BigInteger;Ljava/math/BigInteger;)Lrc/p;
    ...
    invoke-direct/range {v22 .. v27}, Lrc/g;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)V
    ...
    invoke-virtual {v11, v13, v14}, Lrc/h;->c(Ljava/math/BigInteger;Ljava/math/BigInteger;)Lrc/p;

    move-result-object v24

    invoke-static/range {v24 .. v24}, Lrc/w;->d(Lrc/p;)V
    ...
    invoke-direct/range {v22 .. v27}, Lic/l;-><init>(Lrc/h;Lrc/p;Ljava/math/BigInteger;Ljava/math/BigInteger;[B)V

    sget-object v9, LVb/a;->h:LHb/q;
...
.method public static b(LHb/q;)Ldc/i;
    .locals 7
    ...
    invoke-direct {v2, v1, v0}, Ldc/k;-><init>(Lrc/p;Z)V

    iget-object v0, p0, Lic/l;->g:[B

    invoke-static {v0}, Lorg/bouncycastle/util/d;->c([B)[B

    move-result-object v5

    iget-object v1, p0, Lic/l;->f:Lrc/h;

    iget-object v3, p0, Lic/l;->i:Ljava/math/BigInteger;

    iget-object v4, p0, Lic/l;->j:Ljava/math/BigInteger;

    move-object v0, v6

    invoke-direct/range {v0 .. v5}, Ldc/i;-><init>(Lrc/h;Ldc/k;Ljava/math/BigInteger;Ljava/math/BigInteger;[B)V
...
.method public static d(Ljava/lang/String;)LHb/q;
    .locals 1
