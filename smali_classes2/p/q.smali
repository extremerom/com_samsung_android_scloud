...
.field public final f:Lcom/airbnb/lottie/v;
...
# direct methods
.method public constructor <init>(Lcom/airbnb/lottie/v;Lv/c;Lu/i;)V
    .locals 7
    ...
    iput-object v0, p0, Lp/q;->c:Landroid/graphics/PathMeasure;

    const/4 v0, 0x2

    new-array v0, v0, [F

    iput-object v0, p0, Lp/q;->d:[F

    new-instance v0, Lp/c;

    invoke-direct {v0}, Lp/c;-><init>()V

    iput-object v0, p0, Lp/q;->q:Lp/c;

    iput-object p1, p0, Lp/q;->f:Lcom/airbnb/lottie/v;

    iget-object p1, p3, Lu/i;->a:Ljava/lang/String;

    iput-object p1, p0, Lp/q;->e:Ljava/lang/String;

    iget-object p1, p3, Lu/i;->b:Lcom/airbnb/lottie/model/content/PolystarShape$Type;

    iput-object p1, p0, Lp/q;->g:Lcom/airbnb/lottie/model/content/PolystarShape$Type;
    ...
    iput-object v3, p0, Lp/q;->l:Lq/i;

    iget-object v3, p3, Lu/i;->g:Lt/b;

    invoke-virtual {v3}, Lt/b;->a()Lq/e;
    ...
    iput-object v4, p0, Lp/q;->n:Lq/i;

    iget-object v4, p3, Lu/i;->i:Lt/b;

    invoke-virtual {v4}, Lt/b;->a()Lq/e;
    ...
    invoke-virtual {v6}, Lt/b;->a()Lq/e;

    move-result-object v6

    check-cast v6, Lq/i;

    iput-object v6, p0, Lp/q;->m:Lq/i;

    iget-object p3, p3, Lu/i;->h:Lt/b;

    invoke-virtual {p3}, Lt/b;->a()Lq/e;

    move-result-object p3

    check-cast p3, Lq/i;

    iput-object p3, p0, Lp/q;->o:Lq/i;
    ...
    invoke-virtual {p2, v1}, Lv/c;->f(Lq/e;)V

    invoke-virtual {p2, v2}, Lv/c;->f(Lq/e;)V

    invoke-virtual {p2, v3}, Lv/c;->f(Lq/e;)V

    invoke-virtual {p2, v4}, Lv/c;->f(Lq/e;)V

    if-ne p1, v5, :cond_1

    iget-object p3, p0, Lp/q;->m:Lq/i;

    invoke-virtual {p2, p3}, Lv/c;->f(Lq/e;)V

    iget-object p3, p0, Lp/q;->o:Lq/i;
    ...
    iget-object p1, p0, Lp/q;->m:Lq/i;

    invoke-virtual {p1, p0}, Lq/e;->a(Lq/a;)V

    iget-object p1, p0, Lp/q;->o:Lq/i;
...
.method public final a()V
    ...
    iput-boolean v0, p0, Lp/q;->r:Z

    iget-object v0, p0, Lp/q;->f:Lcom/airbnb/lottie/v;
...
.method public final c(Landroid/graphics/ColorFilter;Lz/c;)V
    ...
    sget-object v0, Lcom/airbnb/lottie/y;->r:Ljava/lang/Float;

    if-ne p1, v0, :cond_0

    iget-object p1, p0, Lp/q;->j:Lq/i;
    ...
    :cond_0
    sget-object v0, Lcom/airbnb/lottie/y;->s:Ljava/lang/Float;

    if-ne p1, v0, :cond_1

    iget-object p1, p0, Lp/q;->l:Lq/i;
    ...
    :cond_2
    sget-object v0, Lcom/airbnb/lottie/y;->t:Ljava/lang/Float;

    if-ne p1, v0, :cond_3

    iget-object v0, p0, Lp/q;->m:Lq/i;

    if-eqz v0, :cond_3

    invoke-virtual {v0, p2}, Lq/e;->k(Lz/c;)V

    goto :goto_0

    :cond_3
    sget-object v0, Lcom/airbnb/lottie/y;->u:Ljava/lang/Float;

    if-ne p1, v0, :cond_4

    iget-object p1, p0, Lp/q;->n:Lq/i;
    ...
    :cond_4
    sget-object v0, Lcom/airbnb/lottie/y;->v:Ljava/lang/Float;

    if-ne p1, v0, :cond_5

    iget-object v0, p0, Lp/q;->o:Lq/i;
    ...
    :cond_5
    sget-object v0, Lcom/airbnb/lottie/y;->w:Ljava/lang/Float;

    if-ne p1, v0, :cond_6

    iget-object p1, p0, Lp/q;->p:Lq/i;
...
.method public final getName()Ljava/lang/String;
    ...
    iget-object v0, p0, Lp/q;->e:Ljava/lang/String;
...
.method public final getPath()Landroid/graphics/Path;
    ...
    iget-boolean v1, v0, Lp/q;->r:Z

    iget-object v9, v0, Lp/q;->a:Landroid/graphics/Path;
    ...
    iget-boolean v1, v0, Lp/q;->h:Z

    const/4 v10, 0x1

    if-eqz v1, :cond_1

    iput-boolean v10, v0, Lp/q;->r:Z

    return-object v9

    :cond_1
    sget-object v1, Lp/p;->a:[I

    iget-object v2, v0, Lp/q;->g:Lcom/airbnb/lottie/model/content/PolystarShape$Type;
    ...
    iget-object v11, v0, Lp/q;->k:Lq/e;

    const/16 v16, 0x0

    iget-object v2, v0, Lp/q;->n:Lq/i;

    const/high16 v3, 0x42c80000    # 100.0f

    iget-object v4, v0, Lp/q;->p:Lq/i;
    ...
    iget-object v7, v0, Lp/q;->l:Lq/i;

    iget-object v8, v0, Lp/q;->j:Lq/i;
    ...
    iget-object v7, v1, Lp/q;->b:Landroid/graphics/Path;
    ...
    iget-object v2, v1, Lp/q;->c:Landroid/graphics/PathMeasure;
    ...
    invoke-virtual/range {v26 .. v26}, Lq/e;->f()Ljava/lang/Object;
    ...
    invoke-static {v6, v5, v0, v5}, LA1/c;->a(FFFF)F
    ...
    iget-object v1, v0, Lp/q;->q:Lp/c;

    invoke-virtual {v1, v9}, Lp/c;->c(Landroid/graphics/Path;)V

    const/4 v1, 0x1

    iput-boolean v1, v0, Lp/q;->r:Z
