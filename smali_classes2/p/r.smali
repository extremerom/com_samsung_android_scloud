...
.method public constructor <init>(Lcom/airbnb/lottie/v;Lv/c;Lu/j;)V
    ...
    iput-object v0, p0, Lp/r;->a:Landroid/graphics/Path;

    new-instance v0, Landroid/graphics/RectF;

    invoke-direct {v0}, Landroid/graphics/RectF;-><init>()V

    iput-object v0, p0, Lp/r;->b:Landroid/graphics/RectF;

    new-instance v0, Lp/c;

    invoke-direct {v0}, Lp/c;-><init>()V

    iput-object v0, p0, Lp/r;->i:Lp/c;

    const/4 v0, 0x0

    iput-object v0, p0, Lp/r;->j:Lq/e;

    iget-object v0, p3, Lu/j;->b:Ljava/lang/Object;
    ...
    iput-boolean v0, p0, Lp/r;->d:Z

    iput-object p1, p0, Lp/r;->e:Lcom/airbnb/lottie/v;
...
.method public final a()V
    ...
    iput-boolean v0, p0, Lp/r;->k:Z

    iget-object v0, p0, Lp/r;->e:Lcom/airbnb/lottie/v;
...
.method public final b(Ljava/util/List;Ljava/util/List;)V
    ...
    iget-object v2, v1, Lp/w;->c:Lcom/airbnb/lottie/model/content/ShapeTrimPath$Type;

    sget-object v3, Lcom/airbnb/lottie/model/content/ShapeTrimPath$Type;->SIMULTANEOUSLY:Lcom/airbnb/lottie/model/content/ShapeTrimPath$Type;

    if-ne v2, v3, :cond_0

    iget-object v0, p0, Lp/r;->i:Lp/c;

    iget-object v0, v0, Lp/c;->a:Ljava/util/ArrayList;

    invoke-virtual {v0, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    invoke-virtual {v1, p0}, Lp/w;->c(Lq/a;)V
...
.method public final c(Landroid/graphics/ColorFilter;Lz/c;)V
    ...
    sget-object v0, Lcom/airbnb/lottie/y;->g:Landroid/graphics/PointF;

    if-ne p1, v0, :cond_0

    iget-object p1, p0, Lp/r;->g:Lq/e;
    ...
    :cond_1
    sget-object v0, Lcom/airbnb/lottie/y;->h:Ljava/lang/Float;

    if-ne p1, v0, :cond_2

    iget-object p1, p0, Lp/r;->h:Lq/i;
...
.method public final getPath()Landroid/graphics/Path;
    ...
    iget-boolean v1, v0, Lp/r;->k:Z

    iget-object v2, v0, Lp/r;->a:Landroid/graphics/Path;
    ...
    iget-boolean v1, v0, Lp/r;->d:Z

    const/4 v3, 0x1

    if-eqz v1, :cond_1

    iput-boolean v3, v0, Lp/r;->k:Z

    return-object v2

    :cond_1
    iget-object v1, v0, Lp/r;->g:Lq/e;
    ...
    iget-object v10, v0, Lp/r;->b:Landroid/graphics/RectF;
    ...
    iget-object v1, v0, Lp/r;->i:Lp/c;

    invoke-virtual {v1, v2}, Lp/c;->c(Landroid/graphics/Path;)V

    const/4 v1, 0x1

    iput-boolean v1, v0, Lp/r;->k:Z
