...
.method public final create(Landroid/content/Context;Ljava/util/concurrent/Executor;Landroidx/work/Clock;Z)Landroidx/work/impl/WorkDatabase;
    ...
    invoke-static {p1, v3}, Landroidx/room/Room;->inMemoryDatabaseBuilder(Landroid/content/Context;Ljava/lang/Class;)Landroidx/room/RoomDatabase$Builder;
    ...
    invoke-static {p1, v3, p4}, Landroidx/room/Room;->databaseBuilder(Landroid/content/Context;Ljava/lang/Class;Ljava/lang/String;)Landroidx/room/RoomDatabase$Builder;

    move-result-object p4

    new-instance v3, LJ2/e;

    invoke-direct {v3, p1, v0}, LJ2/e;-><init>(Landroid/content/Context;I)V

    invoke-virtual {p4, v3}, Landroidx/room/RoomDatabase$Builder;->openHelperFactory(Landroidx/sqlite/db/SupportSQLiteOpenHelper$Factory;)Landroidx/room/RoomDatabase$Builder;
    ...
    invoke-direct {p3, p1, p4, v3}, Landroidx/work/impl/RescheduleMigration;-><init>(Landroid/content/Context;II)V

    new-array p4, v2, [Landroidx/room/migration/Migration;
    ...
    invoke-direct {p3, p1, p4, v0}, Landroidx/work/impl/RescheduleMigration;-><init>(Landroid/content/Context;II)V
