...
.method public abstract cancelAllWork()Lcom/google/common/util/concurrent/O;
    .annotation build Landroidx/annotation/NonNull;
    .end annotation
...
.method public abstract cancelAllWorkByTag(Ljava/lang/String;)Lcom/google/common/util/concurrent/O;
    .param p1    # Ljava/lang/String;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
...
.method public abstract cancelUniqueWork(Ljava/lang/String;)Lcom/google/common/util/concurrent/O;
    .param p1    # Ljava/lang/String;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
...
.method public abstract cancelWorkById(Ljava/util/UUID;)Lcom/google/common/util/concurrent/O;
...
.method public abstract enqueue(Landroidx/work/WorkContinuation;)Lcom/google/common/util/concurrent/O;
...
.method public abstract enqueue(Landroidx/work/WorkRequest;)Lcom/google/common/util/concurrent/O;
...
.method public abstract enqueue(Ljava/util/List;)Lcom/google/common/util/concurrent/O;
    .param p1    # Ljava/util/List;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
...
.method public abstract enqueueUniquePeriodicWork(Ljava/lang/String;Landroidx/work/ExistingPeriodicWorkPolicy;Landroidx/work/PeriodicWorkRequest;)Lcom/google/common/util/concurrent/O;
    .param p1    # Ljava/lang/String;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
...
.method public final enqueueUniqueWork(Ljava/lang/String;Landroidx/work/ExistingWorkPolicy;Landroidx/work/OneTimeWorkRequest;)Lcom/google/common/util/concurrent/O;
    .locals 0
    .param p1    # Ljava/lang/String;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-virtual {p0, p1, p2, p3}, Landroidx/work/multiprocess/RemoteWorkManager;->enqueueUniqueWork(Ljava/lang/String;Landroidx/work/ExistingWorkPolicy;Ljava/util/List;)Lcom/google/common/util/concurrent/O;
...
.method public abstract enqueueUniqueWork(Ljava/lang/String;Landroidx/work/ExistingWorkPolicy;Ljava/util/List;)Lcom/google/common/util/concurrent/O;
    .param p1    # Ljava/lang/String;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
...
.method public abstract setForegroundAsync(Ljava/lang/String;Landroidx/work/ForegroundInfo;)Lcom/google/common/util/concurrent/O;
    .param p1    # Ljava/lang/String;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
...
.method public abstract setProgress(Ljava/util/UUID;Landroidx/work/Data;)Lcom/google/common/util/concurrent/O;
    .param p1    # Ljava/util/UUID;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
