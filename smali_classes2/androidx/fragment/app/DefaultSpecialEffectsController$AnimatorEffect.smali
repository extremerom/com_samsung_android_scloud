...
.method public onCancel(Landroid/view/ViewGroup;)V
    ...
    invoke-virtual {v0}, Landroidx/fragment/app/DefaultSpecialEffectsController$AnimationInfo;->isPop()Z

    move-result v0

    new-instance v3, Landroidx/fragment/app/Fragment$SeslOnTransitionCallback$TransitionInfo;

    const/4 v4, 0x0

    invoke-direct {v3, v2, v0, v4}, Landroidx/fragment/app/Fragment$SeslOnTransitionCallback$TransitionInfo;-><init>(ZZF)V

    invoke-interface {p1, v3}, Landroidx/fragment/app/Fragment$SeslOnTransitionCallback;->onTransitionCancelled(Landroidx/fragment/app/Fragment$SeslOnTransitionCallback$TransitionInfo;)V
...
.method public onProgress(Landroidx/activity/BackEventCompat;Landroid/view/ViewGroup;)V
    ...
    :goto_0
    iget-object v8, p0, Landroidx/fragment/app/DefaultSpecialEffectsController$AnimatorEffect;->animatorInfo:Landroidx/fragment/app/DefaultSpecialEffectsController$AnimationInfo;

    invoke-virtual {v8}, Landroidx/fragment/app/DefaultSpecialEffectsController$AnimationInfo;->isPop()Z

    move-result v8

    new-instance v9, Landroidx/fragment/app/Fragment$SeslOnTransitionCallback$TransitionInfo;

    invoke-virtual {p1}, Landroidx/activity/BackEventCompat;->getProgress()F

    move-result p1

    invoke-direct {v9, v7, v8, p1}, Landroidx/fragment/app/Fragment$SeslOnTransitionCallback$TransitionInfo;-><init>(ZZF)V

    invoke-interface {v2, v9}, Landroidx/fragment/app/Fragment$SeslOnTransitionCallback;->onTransitionProgressed(Landroidx/fragment/app/Fragment$SeslOnTransitionCallback$TransitionInfo;)V
...
.method public onStart(Landroid/view/ViewGroup;)V
    ...
    invoke-virtual {p1, v7}, Landroid/animation/AnimatorSet;->setTarget(Ljava/lang/Object;)V
