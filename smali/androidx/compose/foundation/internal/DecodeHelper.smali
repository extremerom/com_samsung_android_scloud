...
.method public final decodeSpanStyle()Landroidx/compose/ui/text/SpanStyle;
    ...
    new-instance v15, Landroidx/compose/foundation/internal/MutableSpanStyle;
    ...
    :goto_0
    iget-object v1, v0, Landroidx/compose/foundation/internal/DecodeHelper;->parcel:Landroid/os/Parcel;
    ...
    invoke-direct/range {p0 .. p0}, Landroidx/compose/foundation/internal/DecodeHelper;->decodeByte()B
    ...
    invoke-direct/range {p0 .. p0}, Landroidx/compose/foundation/internal/DecodeHelper;->dataAvailable()I

    move-result v1

    if-lt v1, v3, :cond_0

    invoke-virtual/range {p0 .. p0}, Landroidx/compose/foundation/internal/DecodeHelper;->decodeColor-0d7_KjU()J

    move-result-wide v1

    move-object/from16 v4, v21

    invoke-virtual {v4, v1, v2}, Landroidx/compose/foundation/internal/MutableSpanStyle;->setColor-8_81llA(J)V
    ...
    invoke-virtual/range {p0 .. p0}, Landroidx/compose/foundation/internal/DecodeHelper;->decodeTextUnit-XSAIIZE()J

    move-result-wide v1

    invoke-virtual {v4, v1, v2}, Landroidx/compose/foundation/internal/MutableSpanStyle;->setFontSize--R2X_6o(J)V
    ...
    invoke-virtual/range {p0 .. p0}, Landroidx/compose/foundation/internal/DecodeHelper;->decodeFontWeight()Landroidx/compose/ui/text/font/FontWeight;

    move-result-object v1

    invoke-virtual {v4, v1}, Landroidx/compose/foundation/internal/MutableSpanStyle;->setFontWeight(Landroidx/compose/ui/text/font/FontWeight;)V
    ...
    invoke-virtual/range {p0 .. p0}, Landroidx/compose/foundation/internal/DecodeHelper;->decodeFontStyle-_-LCdwA()I
    ...
    invoke-virtual {v4, v1}, Landroidx/compose/foundation/internal/MutableSpanStyle;->setFontStyle-mLjRB2g(Landroidx/compose/ui/text/font/FontStyle;)V
    ...
    invoke-virtual/range {p0 .. p0}, Landroidx/compose/foundation/internal/DecodeHelper;->decodeFontSynthesis-GVVA2EU()I
    ...
    invoke-virtual {v4, v1}, Landroidx/compose/foundation/internal/MutableSpanStyle;->setFontSynthesis-tDdu0R4(Landroidx/compose/ui/text/font/FontSynthesis;)V
    ...
    invoke-direct/range {p0 .. p0}, Landroidx/compose/foundation/internal/DecodeHelper;->decodeString()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v4, v1}, Landroidx/compose/foundation/internal/MutableSpanStyle;->setFontFeatureSettings(Ljava/lang/String;)V
    ...
    invoke-virtual {v4, v1, v2}, Landroidx/compose/foundation/internal/MutableSpanStyle;->setLetterSpacing--R2X_6o(J)V
    ...
    invoke-direct/range {p0 .. p0}, Landroidx/compose/foundation/internal/DecodeHelper;->decodeBaselineShift-y9eOQZs()F
    ...
    invoke-virtual {v4, v1}, Landroidx/compose/foundation/internal/MutableSpanStyle;->setBaselineShift-_isdbwI(Landroidx/compose/ui/text/style/BaselineShift;)V
    ...
    invoke-direct/range {p0 .. p0}, Landroidx/compose/foundation/internal/DecodeHelper;->decodeTextGeometricTransform()Landroidx/compose/ui/text/style/TextGeometricTransform;

    move-result-object v1

    invoke-virtual {v4, v1}, Landroidx/compose/foundation/internal/MutableSpanStyle;->setTextGeometricTransform(Landroidx/compose/ui/text/style/TextGeometricTransform;)V
    ...
    invoke-virtual {v4, v1, v2}, Landroidx/compose/foundation/internal/MutableSpanStyle;->setBackground-8_81llA(J)V
    ...
    invoke-direct/range {p0 .. p0}, Landroidx/compose/foundation/internal/DecodeHelper;->decodeTextDecoration()Landroidx/compose/ui/text/style/TextDecoration;

    move-result-object v1

    invoke-virtual {v4, v1}, Landroidx/compose/foundation/internal/MutableSpanStyle;->setTextDecoration(Landroidx/compose/ui/text/style/TextDecoration;)V
    ...
    invoke-direct/range {p0 .. p0}, Landroidx/compose/foundation/internal/DecodeHelper;->decodeShadow()Landroidx/compose/ui/graphics/Shadow;

    move-result-object v1

    invoke-virtual {v4, v1}, Landroidx/compose/foundation/internal/MutableSpanStyle;->setShadow(Landroidx/compose/ui/graphics/Shadow;)V

    goto/16 :goto_1

    :cond_d
    :goto_2
    invoke-virtual {v4}, Landroidx/compose/foundation/internal/MutableSpanStyle;->toSpanStyle()Landroidx/compose/ui/text/SpanStyle;
