...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lb8/b$a;-><init>(Lkotlin/jvm/internal/DefaultConstructorMarker;)V
...
.method private final setLastSyncTime(Landroid/accounts/Account;Ljava/lang/String;)Z
    ...
    const-string v7, "ChangeLastSyncTimeForContacts"
...
.method public execute(Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    const-string v2, "ChangeLastSyncTimeForContacts"

    const-string v3, "Contacts sync time change result: "
    ...
    :try_start_0
    const-string v5, "Changing last sync time for contacts to 6 months ago"
    ...
    :cond_0
    invoke-direct {p0, v8, v7}, Lb8/b;->setLastSyncTime(Landroid/accounts/Account;Ljava/lang/String;)Z
    ...
    const-string/jumbo v10, "\uc5f0\ub77d\ucc98 \ub9c8\uc9c0\ub9c9 \ub3d9\uae30\ud654 \uc2dc\uac04\uc744 6\uac1c\uc6d4 \uc804\uc73c\ub85c \ubcc0\uacbd\ud588\uc2b5\ub2c8\ub2e4."

    goto :goto_0

    :cond_1
    const-string/jumbo v10, "\uc5f0\ub77d\ucc98 \ub3d9\uae30\ud654 \uc2dc\uac04 \ubcc0\uacbd\uc5d0 \uc2e4\ud328\ud588\uc2b5\ub2c8\ub2e4."
    ...
    :goto_1
    const-string v5, "Error changing contacts sync time"
