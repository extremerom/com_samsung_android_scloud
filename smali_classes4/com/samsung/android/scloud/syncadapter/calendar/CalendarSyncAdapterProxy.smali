.class public Lcom/samsung/android/scloud/syncadapter/calendar/CalendarSyncAdapterProxy;
.super Lcom/samsung/android/scloud/syncadapter/core/core/c;
.source "SourceFile"


# static fields
.field private static final TAG:Ljava/lang/String; = "CalendarSyncAdapterProxy"


# instance fields
.field private authority:Ljava/lang/String;

.field private final calendarSync:Lcom/samsung/android/scloud/syncadapter/calendar/CalendarSyncAdapter;

.field private canceled:Z

.field private final eventTelemetry:La8/u;

.field private final taskSync:Lcom/samsung/android/scloud/syncadapter/calendar/CalendarTaskSyncAdapter;

.field private final taskTelemetry:La8/u;
...
.method public constructor <init>(Landroid/content/Context;Z)V
    ...
    iput-boolean p2, p0, Lcom/samsung/android/scloud/syncadapter/calendar/CalendarSyncAdapterProxy;->canceled:Z

    new-instance p2, Lcom/samsung/android/scloud/syncadapter/calendar/model/Calendar;

    invoke-direct {p2}, Lcom/samsung/android/scloud/syncadapter/calendar/model/Calendar;-><init>()V

    new-instance v0, Lcom/samsung/android/scloud/syncadapter/calendar/model/Task;

    invoke-direct {v0}, Lcom/samsung/android/scloud/syncadapter/calendar/model/Task;-><init>()V

    new-instance v1, Lcom/samsung/android/scloud/syncadapter/calendar/model/ServerChanges;

    invoke-direct {v1}, Lcom/samsung/android/scloud/syncadapter/calendar/model/ServerChanges;-><init>()V

    new-instance v2, Lcom/samsung/android/scloud/syncadapter/calendar/CalendarTaskSyncAdapter;

    invoke-direct {v2, p1, v0, v1}, Lcom/samsung/android/scloud/syncadapter/calendar/CalendarTaskSyncAdapter;-><init>(Landroid/content/Context;Lcom/samsung/android/scloud/syncadapter/core/dapi/i;Lcom/samsung/android/scloud/syncadapter/calendar/model/ServerChanges;)V

    iput-object v2, p0, Lcom/samsung/android/scloud/syncadapter/calendar/CalendarSyncAdapterProxy;->taskSync:Lcom/samsung/android/scloud/syncadapter/calendar/CalendarTaskSyncAdapter;

    new-instance v0, La8/u;

    invoke-direct {v0, v2}, La8/u;-><init>(La8/r;)V

    iput-object v0, p0, Lcom/samsung/android/scloud/syncadapter/calendar/CalendarSyncAdapterProxy;->taskTelemetry:La8/u;

    new-instance v0, Lcom/samsung/android/scloud/syncadapter/calendar/CalendarSyncAdapter;

    invoke-direct {v0, p1, p2, v1, v2}, Lcom/samsung/android/scloud/syncadapter/calendar/CalendarSyncAdapter;-><init>(Landroid/content/Context;Lcom/samsung/android/scloud/syncadapter/core/dapi/i;Lcom/samsung/android/scloud/syncadapter/calendar/model/ServerChanges;Lcom/samsung/android/scloud/syncadapter/calendar/CalendarTaskSyncAdapter;)V

    iput-object v0, p0, Lcom/samsung/android/scloud/syncadapter/calendar/CalendarSyncAdapterProxy;->calendarSync:Lcom/samsung/android/scloud/syncadapter/calendar/CalendarSyncAdapter;

    new-instance p1, La8/u;

    invoke-direct {p1, v0}, La8/u;-><init>(La8/r;)V

    iput-object p1, p0, Lcom/samsung/android/scloud/syncadapter/calendar/CalendarSyncAdapterProxy;->eventTelemetry:La8/u;
...
.method public static synthetic a()Ljava/lang/Long;
    ...
    invoke-static {}, Lcom/samsung/android/scloud/syncadapter/calendar/CalendarSyncAdapterProxy;->lambda$initTelemetry$1()Ljava/lang/Long;
...
.method public static synthetic b(Lcom/samsung/android/scloud/syncadapter/calendar/CalendarSyncAdapterProxy;Landroid/content/ContentProviderClient;Landroid/accounts/Account;)Ljava/lang/Long;
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/samsung/android/scloud/syncadapter/calendar/CalendarSyncAdapterProxy;->lambda$initTelemetry$0(Landroid/content/ContentProviderClient;Landroid/accounts/Account;)Ljava/lang/Long;
...
.method private calculateContentQuotaInfo(Landroid/accounts/Account;Landroid/content/ContentProviderClient;)Ljava/util/HashMap;
    ...
    iget-object v1, p0, Lcom/samsung/android/scloud/syncadapter/calendar/CalendarSyncAdapterProxy;->eventTelemetry:La8/u;

    invoke-virtual {v1, p1, p2}, La8/u;->d(Landroid/accounts/Account;Landroid/content/ContentProviderClient;)J

    move-result-wide v1

    iget-object v3, p0, Lcom/samsung/android/scloud/syncadapter/calendar/CalendarSyncAdapterProxy;->taskTelemetry:La8/u;
    ...
    const-string p2, "local_deleted_count"
...
.method private initTelemetry(Landroid/accounts/Account;Landroid/content/ContentProviderClient;)V
    ...
    iget-object v0, p0, Lcom/samsung/android/scloud/syncadapter/calendar/CalendarSyncAdapterProxy;->calendarSync:Lcom/samsung/android/scloud/syncadapter/calendar/CalendarSyncAdapter;
    ...
    iget-object p1, p0, Lcom/samsung/android/scloud/syncadapter/calendar/CalendarSyncAdapterProxy;->calendarSync:Lcom/samsung/android/scloud/syncadapter/calendar/CalendarSyncAdapter;
...
.method private synthetic lambda$initTelemetry$0(Landroid/content/ContentProviderClient;Landroid/accounts/Account;)Ljava/lang/Long;
    ...
    iget-object v0, p0, Lcom/samsung/android/scloud/syncadapter/calendar/CalendarSyncAdapterProxy;->eventTelemetry:La8/u;

    invoke-virtual {v0, p2, p1}, La8/u;->d(Landroid/accounts/Account;Landroid/content/ContentProviderClient;)J

    move-result-wide v0

    iget-object v2, p0, Lcom/samsung/android/scloud/syncadapter/calendar/CalendarSyncAdapterProxy;->taskTelemetry:La8/u;
...
.method private onPerformSyncInternal(Landroid/accounts/Account;Landroid/os/Bundle;Ljava/lang/String;Landroid/content/ContentProviderClient;Landroid/content/SyncResult;)V
    ...
    const-string v9, "8kLTKS0V1y"

    const-string v10, "resultCode: "

    const-string v11, "CalendarSyncAdapterProxy"

    const-string v12, "onPerformSync - started."

    invoke-static {v11, v12}, Lcom/samsung/android/scloud/common/util/LOG;->i(Ljava/lang/String;Ljava/lang/String;)V

    const/4 v15, 0x0

    :try_start_0
    iget-object v12, v1, Lcom/samsung/android/scloud/syncadapter/calendar/CalendarSyncAdapterProxy;->calendarSync:Lcom/samsung/android/scloud/syncadapter/calendar/CalendarSyncAdapter;

    invoke-virtual {v12, v2, v4}, Lcom/samsung/android/scloud/syncadapter/calendar/CalendarSyncAdapter;->setup(Landroid/accounts/Account;Landroid/content/ContentProviderClient;)V

    iget-object v12, v1, Lcom/samsung/android/scloud/syncadapter/calendar/CalendarSyncAdapterProxy;->taskSync:Lcom/samsung/android/scloud/syncadapter/calendar/CalendarTaskSyncAdapter;

    invoke-virtual {v12, v2, v4}, Lcom/samsung/android/scloud/syncadapter/calendar/CalendarTaskSyncAdapter;->setup(Landroid/accounts/Account;Landroid/content/ContentProviderClient;)V
    ...
    invoke-virtual {v12, v13, v15}, Lcom/samsung/android/scloud/sync/setting/SyncSettingManager;->setSyncStatus(Lc4/e;Z)V

    invoke-static/range {p2 .. p3}, La8/y;->b(Landroid/os/Bundle;Ljava/lang/String;)V

    invoke-direct {v1, v2, v4}, Lcom/samsung/android/scloud/syncadapter/calendar/CalendarSyncAdapterProxy;->initTelemetry(Landroid/accounts/Account;Landroid/content/ContentProviderClient;)V
    ...
    invoke-direct {v1, v2, v4}, Lcom/samsung/android/scloud/syncadapter/calendar/CalendarSyncAdapterProxy;->calculateContentQuotaInfo(Landroid/accounts/Account;Landroid/content/ContentProviderClient;)Ljava/util/HashMap;
    ...
    :cond_0
    :try_start_3
    iput-object v3, v1, Lcom/samsung/android/scloud/syncadapter/calendar/CalendarSyncAdapterProxy;->authority:Ljava/lang/String;

    iput-boolean v15, v1, Lcom/samsung/android/scloud/syncadapter/calendar/CalendarSyncAdapterProxy;->canceled:Z
    ...
    invoke-virtual {v12, v13, v3, v0}, Lcom/samsung/android/scloud/sync/policy/SyncPolicyManager;->verify(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;)I
    ...
    invoke-direct {v5, v3, v6, v12}, Lc4/e;-><init>(Ljava/lang/String;Ljava/lang/String;I)V
    ...
    iget-object v10, v1, Lcom/samsung/android/scloud/syncadapter/calendar/CalendarSyncAdapterProxy;->calendarSync:Lcom/samsung/android/scloud/syncadapter/calendar/CalendarSyncAdapter;
    ...
    :goto_1
    :try_start_6
    invoke-static {v11, v6, v0}, Lcom/samsung/android/scloud/common/util/LOG;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-direct {v6, v3, v7, v12}, Lc4/e;-><init>(Ljava/lang/String;Ljava/lang/String;I)V
...
.method public handleSync(Landroid/accounts/Account;Landroid/os/Bundle;Ljava/lang/String;Landroid/content/ContentProviderClient;Landroid/content/SyncResult;)V
    ...
    invoke-direct/range {p0 .. p5}, Lcom/samsung/android/scloud/syncadapter/calendar/CalendarSyncAdapterProxy;->onPerformSyncInternal(Landroid/accounts/Account;Landroid/os/Bundle;Ljava/lang/String;Landroid/content/ContentProviderClient;Landroid/content/SyncResult;)V
...
.method public onSyncCanceled()V
    ...
    iget-boolean v1, p0, Lcom/samsung/android/scloud/syncadapter/calendar/CalendarSyncAdapterProxy;->canceled:Z

    const-string v2, "CalendarSyncAdapterProxy"

    invoke-static {v0, v1, v2}, Landroidx/work/impl/c;->y(Ljava/lang/StringBuilder;ZLjava/lang/String;)V

    iget-boolean v0, p0, Lcom/samsung/android/scloud/syncadapter/calendar/CalendarSyncAdapterProxy;->canceled:Z
    ...
    iget-object v3, p0, Lcom/samsung/android/scloud/syncadapter/calendar/CalendarSyncAdapterProxy;->authority:Ljava/lang/String;
    ...
    iput-boolean v0, p0, Lcom/samsung/android/scloud/syncadapter/calendar/CalendarSyncAdapterProxy;->canceled:Z

    iget-object v0, p0, Lcom/samsung/android/scloud/syncadapter/calendar/CalendarSyncAdapterProxy;->calendarSync:Lcom/samsung/android/scloud/syncadapter/calendar/CalendarSyncAdapter;

    invoke-virtual {v0}, Lcom/samsung/android/scloud/syncadapter/core/dapi/g;->cancelSync()V

    iget-object v0, p0, Lcom/samsung/android/scloud/syncadapter/calendar/CalendarSyncAdapterProxy;->taskSync:Lcom/samsung/android/scloud/syncadapter/calendar/CalendarTaskSyncAdapter;
