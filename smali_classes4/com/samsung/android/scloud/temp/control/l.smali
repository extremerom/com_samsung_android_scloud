.class public abstract Lcom/samsung/android/scloud/temp/control/l;
...
.method public constructor <init>(Ljava/lang/String;Lcom/samsung/android/scloud/temp/repository/b;)V
    ...
    iput-object p1, p0, Lcom/samsung/android/scloud/temp/control/l;->a:Ljava/lang/String;

    iput-object p2, p0, Lcom/samsung/android/scloud/temp/control/l;->b:Lcom/samsung/android/scloud/temp/repository/b;

    new-instance p1, Ljava/util/HashMap;

    invoke-direct {p1}, Ljava/util/HashMap;-><init>()V

    iput-object p1, p0, Lcom/samsung/android/scloud/temp/control/l;->c:Ljava/util/Map;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, Lcom/samsung/android/scloud/temp/control/l;->d:Ljava/util/List;
    ...
    iput-object p1, p0, Lcom/samsung/android/scloud/temp/control/l;->e:Lkotlin/Lazy;

    return-void
.end method

.method public static synthetic a(Lcom/samsung/android/scloud/temp/control/l;)Ljava/util/Map;
    .locals 0

    invoke-static {p0}, Lcom/samsung/android/scloud/temp/control/l;->appToUiMap_delegate$lambda$0(Lcom/samsung/android/scloud/temp/control/l;)Ljava/util/Map;
...
.method private static final appToUiMap_delegate$lambda$0(Lcom/samsung/android/scloud/temp/control/l;)Ljava/util/Map;
    .locals 0

    iget-object p0, p0, Lcom/samsung/android/scloud/temp/control/l;->b:Lcom/samsung/android/scloud/temp/repository/b;
...
.method private final getAppToUiMap()Ljava/util/Map;
    ...
    iget-object v0, p0, Lcom/samsung/android/scloud/temp/control/l;->e:Lkotlin/Lazy;
...
.method private final initializeTaskTable(Ljava/util/List;)V
    .locals 18
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v1, v0, Lcom/samsung/android/scloud/temp/control/l;->c:Ljava/util/Map;

    invoke-interface {v1}, Ljava/util/Map;->clear()V

    invoke-virtual/range {p0 .. p0}, Lcom/samsung/android/scloud/temp/control/l;->getDefaultTaskMap()Ljava/util/Map;
    ...
    :cond_0
    invoke-direct/range {p0 .. p0}, Lcom/samsung/android/scloud/temp/control/l;->getAppToUiMap()Ljava/util/Map;
    ...
    iget-object v13, v0, Lcom/samsung/android/scloud/temp/control/l;->a:Ljava/lang/String;

    if-eqz v4, :cond_3

    iget-object v14, v0, Lcom/samsung/android/scloud/temp/control/l;->c:Ljava/util/Map;
    ...
    check-cast v4, Lcom/samsung/android/scloud/temp/control/s;
    ...
    :cond_1
    invoke-virtual {v4}, Lcom/samsung/android/scloud/temp/control/s;->getExecutor()Ljava/lang/String;

    move-result-object v7

    invoke-virtual {v4}, Lcom/samsung/android/scloud/temp/control/s;->getImportance()I
...
.method public final getRepository()Lcom/samsung/android/scloud/temp/repository/b;
    ...
    iget-object v0, p0, Lcom/samsung/android/scloud/temp/control/l;->b:Lcom/samsung/android/scloud/temp/repository/b;
...
.method public final getServerCategoryList()Ljava/util/List;
    ...
    iget-object v0, p0, Lcom/samsung/android/scloud/temp/control/l;->d:Ljava/util/List;
...
.method public final getTag()Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/samsung/android/scloud/temp/control/l;->a:Ljava/lang/String;
...
.method public final getTaskTable()Ljava/util/Map;
    ...
    iget-object v0, p0, Lcom/samsung/android/scloud/temp/control/l;->c:Ljava/util/Map;
...
.method public final initialize(Ljava/util/List;)V
    ...
    iget-object p1, p0, Lcom/samsung/android/scloud/temp/control/l;->d:Ljava/util/List;

    invoke-direct {p0, p1}, Lcom/samsung/android/scloud/temp/control/l;->initializeTaskTable(Ljava/util/List;)V
...
.method public final setComplete(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/samsung/android/scloud/temp/control/l;->setComplete(Ljava/lang/String;Ljava/util/List;)V
...
.method public final setComplete(Ljava/lang/String;Ljava/util/List;)V
    ...
    iget-object v2, p0, Lcom/samsung/android/scloud/temp/control/l;->c:Ljava/util/Map;
    ...
    iget-object v4, p0, Lcom/samsung/android/scloud/temp/control/l;->a:Ljava/lang/String;
    ...
    iget-object p1, p0, Lcom/samsung/android/scloud/temp/control/l;->b:Lcom/samsung/android/scloud/temp/repository/b;
