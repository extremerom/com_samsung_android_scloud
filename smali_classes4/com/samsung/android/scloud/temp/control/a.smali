.class public final Lcom/samsung/android/scloud/temp/control/a;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/samsung/android/scloud/temp/control/a$a;
    }
.end annotation
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/samsung/android/scloud/temp/control/a$a;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Lcom/samsung/android/scloud/temp/control/a$a;-><init>(Lkotlin/jvm/internal/DefaultConstructorMarker;)V

    const-class v0, Lcom/samsung/android/scloud/temp/control/a;

    invoke-virtual {v0}, Ljava/lang/Class;->getSimpleName()Ljava/lang/String;

    move-result-object v0

    sput-object v0, Lcom/samsung/android/scloud/temp/control/a;->c:Ljava/lang/String;
...
.method public constructor <init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lcom/samsung/android/scloud/temp/control/a;->a:Ljava/lang/String;

    iput-object p2, p0, Lcom/samsung/android/scloud/temp/control/a;->b:Ljava/lang/String;
...
.method private final createDownloadAppEntity(Ljava/lang/String;)LQ8/c;
    ...
    iget-object v1, p0, Lcom/samsung/android/scloud/temp/control/a;->b:Ljava/lang/String;
...
.method private final queryFiles(Ljava/lang/String;Lcom/samsung/android/scloud/temp/data/smartswitch/URIInfo;Ljava/util/ArrayList;Ljava/util/ArrayList;)V
    .locals 5
    ...
    invoke-direct {p0}, Lcom/samsung/android/scloud/temp/control/a;->getDataRepository()Lcom/samsung/android/scloud/temp/repository/a;

    move-result-object v0

    invoke-virtual {v0, p1}, Lcom/samsung/android/scloud/temp/repository/b;->findAppCategory(Ljava/lang/String;)LQ8/a;
    ...
    sget-object p2, Lcom/samsung/android/scloud/temp/business/d;->a:Lcom/samsung/android/scloud/temp/business/d;

    invoke-virtual {p2, p1}, Lcom/samsung/android/scloud/temp/business/d;->getMediaControl(Ljava/lang/String;)LL8/i;

    move-result-object p2

    if-eqz p2, :cond_0

    invoke-direct {p0}, Lcom/samsung/android/scloud/temp/control/a;->getTimeMeasure()Lcom/samsung/android/scloud/temp/performance/TimeMeasure;

    move-result-object v1

    invoke-virtual {v1, v4}, Lcom/samsung/android/scloud/temp/performance/TimeMeasure;->startMedia(Z)V

    invoke-direct {p0, p3, p1, p2}, Lcom/samsung/android/scloud/temp/control/a;->saveMedia(Ljava/util/List;Ljava/lang/String;LL8/i;)V

    invoke-direct {p0}, Lcom/samsung/android/scloud/temp/control/a;->getTimeMeasure()Lcom/samsung/android/scloud/temp/performance/TimeMeasure;

    move-result-object p1

    invoke-virtual {p1, v3}, Lcom/samsung/android/scloud/temp/performance/TimeMeasure;->startMedia(Z)V
    ...
    invoke-direct {p0, p3, p2}, Lcom/samsung/android/scloud/temp/control/a;->saveDefaultItem(Ljava/util/List;Lcom/samsung/android/scloud/temp/data/smartswitch/URIInfo;)V
    ...
    sget-object p1, Lcom/samsung/android/scloud/temp/repository/SmartSwitchRepository;->k:Lcom/samsung/android/scloud/temp/repository/SmartSwitchRepository$a;

    invoke-virtual {p1}, Lcom/samsung/android/scloud/temp/repository/SmartSwitchRepository$a;->getInstance()Lcom/samsung/android/scloud/temp/repository/SmartSwitchRepository;

    move-result-object p1

    invoke-virtual {p1}, Lcom/samsung/android/scloud/temp/repository/SmartSwitchRepository;->getDownloadAppInfo()LK8/b;

    move-result-object p1

    if-eqz p1, :cond_4

    invoke-direct {p0, p3, p1}, Lcom/samsung/android/scloud/temp/control/a;->saveApp(Ljava/util/List;LK8/b;)V
    ...
    new-instance p3, Lcom/samsung/android/scloud/temp/data/app/DownloadAppMetaData;

    invoke-virtual {p1}, LK8/b;->getAppList()Ljava/util/List;

    move-result-object p1

    invoke-direct {p3, p1}, Lcom/samsung/android/scloud/temp/data/app/DownloadAppMetaData;-><init>(Ljava/util/List;)V

    invoke-virtual {p2}, Lrb/a;->getSerializersModule()Lkotlinx/serialization/modules/d;

    sget-object p1, Lcom/samsung/android/scloud/temp/data/app/DownloadAppMetaData;->Companion:Lcom/samsung/android/scloud/temp/data/app/DownloadAppMetaData$b;

    invoke-virtual {p1}, Lcom/samsung/android/scloud/temp/data/app/DownloadAppMetaData$b;->serializer()Lmb/c;

    move-result-object p1

    invoke-virtual {p2, p1, p3}, Lrb/a;->encodeToString(Lmb/j;Ljava/lang/Object;)Ljava/lang/String;

    move-result-object p1

    invoke-virtual {v0, p1}, LQ8/a;->setMeta(Ljava/lang/String;)V
    ...
    :cond_5
    invoke-direct {p0, p3, v0, p1}, Lcom/samsung/android/scloud/temp/control/a;->saveSmartSwitchItem(Ljava/util/List;LQ8/a;Ljava/lang/String;)Z
    ...
    iget-object p3, p0, Lcom/samsung/android/scloud/temp/control/a;->a:Ljava/lang/String;

    invoke-virtual {p2, p3, p1}, Lcom/samsung/android/scloud/temp/repository/b;->setSelectedButEmpty(Ljava/lang/String;Ljava/lang/String;)V

    :cond_6
    :goto_1
    if-eqz v3, :cond_8

    invoke-virtual {v0, v4}, LQ8/a;->setProgressState(I)V
    ...
    const-string p3, "cannot add file list : "

    invoke-direct {p2, p3}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    invoke-virtual {p2, p1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string p1, " NOT IN DB"
    ...
    sget-object p2, Lcom/samsung/android/scloud/temp/control/a;->c:Ljava/lang/String;
...
.method private final saveApp(Ljava/util/List;LK8/b;)V
    ...
    sget-object v6, Lcom/samsung/android/scloud/temp/control/a;->c:Ljava/lang/String;
    ...
    invoke-direct {v1, v0}, Lcom/samsung/android/scloud/temp/control/a;->createDownloadAppEntity(Ljava/lang/String;)LQ8/c;
    ...
    invoke-direct {v1, v7}, Lcom/samsung/android/scloud/temp/control/a;->createDownloadAppEntity(Ljava/lang/String;)LQ8/c;
    ...
    iget-object v8, v1, Lcom/samsung/android/scloud/temp/control/a;->b:Ljava/lang/String;
    ...
    iget-object v4, v1, Lcom/samsung/android/scloud/temp/control/a;->b:Ljava/lang/String;
...
.method public static synthetic saveCategory$default(Lcom/samsung/android/scloud/temp/control/a;Ljava/lang/String;Lcom/samsung/android/scloud/temp/data/smartswitch/URIInfo;ILjava/lang/Object;)V
    .locals 0
    ...
    :cond_0
    invoke-virtual {p0, p1, p2}, Lcom/samsung/android/scloud/temp/control/a;->saveCategory(Ljava/lang/String;Lcom/samsung/android/scloud/temp/data/smartswitch/URIInfo;)V
...
.method private final saveDefaultItem(Ljava/util/List;Lcom/samsung/android/scloud/temp/data/smartswitch/URIInfo;)V
    ...
    iget-object v3, p0, Lcom/samsung/android/scloud/temp/control/a;->b:Ljava/lang/String;
...
.method private final saveMedia(Ljava/util/List;Ljava/lang/String;LL8/i;)V
    ...
    sget-object v1, Lcom/samsung/android/scloud/temp/control/a;->c:Ljava/lang/String;
...
.method private final saveSmartSwitchItem(Ljava/util/List;LQ8/a;Ljava/lang/String;)Z
    ...
    sget-object v5, Lcom/samsung/android/scloud/temp/control/a;->c:Ljava/lang/String;
    ...
    :try_start_3
    iget-object v9, v4, Lcom/samsung/android/scloud/temp/control/a;->b:Ljava/lang/String;
...
# virtual methods
.method public final saveCategory(Ljava/lang/String;Lcom/samsung/android/scloud/temp/data/smartswitch/URIInfo;)V
    .locals 2
    ...
    invoke-direct {p0, p1, p2, v0, v1}, Lcom/samsung/android/scloud/temp/control/a;->queryFiles(Ljava/lang/String;Lcom/samsung/android/scloud/temp/data/smartswitch/URIInfo;Ljava/util/ArrayList;Ljava/util/ArrayList;)V
