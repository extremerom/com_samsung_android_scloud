.class public final Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel$a;
    }
.end annotation


# static fields
.field public static final j:Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel$a;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel$a;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel$a;-><init>(Lkotlin/jvm/internal/DefaultConstructorMarker;)V

    sput-object v0, Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel;->j:Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel$a;

    const-class v0, Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel;

    invoke-virtual {v0}, Ljava/lang/Class;->getSimpleName()Ljava/lang/String;

    move-result-object v0

    sput-object v0, Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel;->k:Ljava/lang/String;
...
.method public constructor <init>(Landroid/os/Bundle;)V
    ...
    iput-object p1, p0, Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel;->d:Landroidx/lifecycle/MutableLiveData;

    new-instance p1, Landroidx/lifecycle/MutableLiveData;

    invoke-direct {p1}, Landroidx/lifecycle/MutableLiveData;-><init>()V

    iput-object p1, p0, Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel;->e:Landroidx/lifecycle/MutableLiveData;

    new-instance p1, Lb2/g;

    invoke-direct {p1}, Lb2/g;-><init>()V

    iput-object p1, p0, Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel;->f:Lb2/g;

    const/4 p1, 0x1

    iput-boolean p1, p0, Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel;->h:Z

    invoke-static {p0}, Landroidx/lifecycle/ViewModelKt;->getViewModelScope(Landroidx/lifecycle/ViewModel;)Lkotlinx/coroutines/O;

    move-result-object v0

    new-instance v3, Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel$1;

    const/4 p1, 0x0

    invoke-direct {v3, p0, p1}, Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel$1;-><init>(Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel;Lkotlin/coroutines/Continuation;)V
...
.method public static final synthetic access$getDataRepository(Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel;)Lcom/samsung/android/scloud/temp/repository/c;
    .locals 0

    invoke-direct {p0}, Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel;->getDataRepository()Lcom/samsung/android/scloud/temp/repository/c;
...
.method public static final synthetic access$getRemoteRepository(Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel;)Lcom/samsung/android/scloud/temp/repository/CtbRemoteRepository;
    .locals 0

    invoke-direct {p0}, Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel;->getRemoteRepository()Lcom/samsung/android/scloud/temp/repository/CtbRemoteRepository;
...
.method public static final synthetic access$getTAG$cp()Ljava/lang/String;
    ...
    sget-object v0, Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel;->k:Ljava/lang/String;

    return-object v0
.end method

.method public static final synthetic access$get_categories$p(Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel;)Landroidx/lifecycle/MutableLiveData;
    .locals 0

    iget-object p0, p0, Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel;->f:Lb2/g;

    return-object p0
.end method

.method public static final synthetic access$get_state$p(Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel;)Landroidx/lifecycle/MutableLiveData;
    .locals 0

    iget-object p0, p0, Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel;->e:Landroidx/lifecycle/MutableLiveData;

    return-object p0
.end method

.method public static final synthetic access$isRequesting$p(Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel;)Z
    .locals 0

    iget-boolean p0, p0, Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel;->g:Z

    return p0
.end method

.method public static final synthetic access$requestCategoriesInternal(Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel;Ljava/util/List;Z)Ljava/util/List;
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel;->requestCategoriesInternal(Ljava/util/List;Z)Ljava/util/List;
...
.method public static final synthetic access$setRequesting$p(Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel;Z)V
    .locals 0

    iput-boolean p1, p0, Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel;->g:Z
...
.method private final getGoogleMessageSupported(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-direct {p0, p1}, Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel;->isGoogleMessageAppInstalled(Landroid/content/Context;)Z

    move-result v0

    sget-object v1, Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel;->k:Ljava/lang/String;
    ...
    :cond_0
    invoke-direct {p0, p1}, Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel;->isGoogleMessageDefaultApp(Landroid/content/Context;)Z

    move-result v0

    if-nez v0, :cond_2

    invoke-direct {p0, p1}, Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel;->isGoogleMessageEnabled(Landroid/content/Context;)Z
    ...
    :cond_2
    invoke-direct {p0, p1}, Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel;->isGoogleMessageRestoreSupportVersion(Landroid/content/Context;)Z
...
.method private final isGoogleMessageRestoreSupportVersion(Landroid/content/Context;)Z
    ...
    sget-object p1, Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel;->k:Ljava/lang/String;
...
.method private final requestCategoriesInternal(Ljava/util/List;Z)Ljava/util/List;
    ...
    invoke-direct/range {p0 .. p0}, Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel;->getDataRepository()Lcom/samsung/android/scloud/temp/repository/c;
    ...
    invoke-direct {v6, v0}, Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel;->getDownloadAppsSize(Ljava/util/List;)J
    ...
    sget-object v4, Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel;->k:Ljava/lang/String;
    ...
    :cond_8
    invoke-direct/range {p0 .. p0}, Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel;->getTimeMeasure()Lcom/samsung/android/scloud/temp/performance/TimeMeasure;
...
.method public final extendBackupExpiredTime(Ljava/lang/String;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    instance-of v0, p2, Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel$extendBackupExpiredTime$1;

    if-eqz v0, :cond_0

    move-object v0, p2

    check-cast v0, Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel$extendBackupExpiredTime$1;

    iget v1, v0, Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel$extendBackupExpiredTime$1;->label:I
    ...
    iput v1, v0, Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel$extendBackupExpiredTime$1;->label:I

    goto :goto_0

    :cond_0
    new-instance v0, Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel$extendBackupExpiredTime$1;

    invoke-direct {v0, p0, p2}, Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel$extendBackupExpiredTime$1;-><init>(Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel;Lkotlin/coroutines/Continuation;)V

    :goto_0
    iget-object p2, v0, Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel$extendBackupExpiredTime$1;->result:Ljava/lang/Object;

    invoke-static {}, Lkotlin/coroutines/intrinsics/IntrinsicsKt;->getCOROUTINE_SUSPENDED()Ljava/lang/Object;

    move-result-object v1

    iget v2, v0, Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel$extendBackupExpiredTime$1;->label:I
    ...
    iput v3, v0, Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel$extendBackupExpiredTime$1;->label:I
...
.method public final getCategories()Landroidx/lifecycle/LiveData;
    ...
    iget-object v0, p0, Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel;->f:Lb2/g;
...
.method public final getMessageSupportStatus(Landroid/content/Context;Lcom/samsung/android/scloud/temp/repository/data/BackupDeviceInfoVo;)Ljava/lang/String;
    ...
    invoke-direct {p0, p1}, Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel;->isSmsCapable(Landroid/content/Context;)Z
    ...
    invoke-direct {p0, p2}, Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel;->hasGoogleMessageBackup(Lcom/samsung/android/scloud/temp/repository/data/BackupDeviceInfoVo;)Z

    move-result p2

    if-eqz p2, :cond_0

    invoke-direct {p0, p1}, Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel;->getGoogleMessageSupported(Landroid/content/Context;)Ljava/lang/String;
...
.method public final getResult()Landroidx/lifecycle/LiveData;
    ...
    iget-object v0, p0, Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel;->d:Landroidx/lifecycle/MutableLiveData;
...
.method public getShowTipCardAgain()Z
    ...
    iget-boolean v0, p0, Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel;->h:Z
...
.method public final getState()Landroidx/lifecycle/LiveData;
    ...
    iget-object v0, p0, Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel;->e:Landroidx/lifecycle/MutableLiveData;
...
.method public final needMessageUIRefresh(Landroid/content/Context;Lcom/samsung/android/scloud/temp/repository/data/BackupDeviceInfoVo;Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, p1, p2}, Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel;->getMessageSupportStatus(Landroid/content/Context;Lcom/samsung/android/scloud/temp/repository/data/BackupDeviceInfoVo;)Ljava/lang/String;
...
.method public final requestCategories(Lcom/samsung/android/scloud/temp/repository/data/BackupDeviceInfoVo;)V
    ...
    invoke-direct {p0}, Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel;->getTimeMeasure()Lcom/samsung/android/scloud/temp/performance/TimeMeasure;
    ...
    new-instance v5, Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel$requestCategories$1;

    const/4 v0, 0x0

    invoke-direct {v5, p0, p1, v0}, Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel$requestCategories$1;-><init>(Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel;Lcom/samsung/android/scloud/temp/repository/data/BackupDeviceInfoVo;Lkotlin/coroutines/Continuation;)V
...
.method public final startRestore(Landroid/content/Context;Lcom/samsung/android/scloud/temp/repository/data/BackupDeviceInfoVo;Ljava/util/ArrayList;)Lkotlinx/coroutines/A0;
    ...
    new-instance v0, Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel$startRestore$1;
    ...
    invoke-direct/range {v3 .. v8}, Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel$startRestore$1;-><init>(Lcom/samsung/android/scloud/temp/ui/data/CtbRestoreViewModel;Ljava/util/ArrayList;Landroid/content/Context;Lcom/samsung/android/scloud/temp/repository/data/BackupDeviceInfoVo;Lkotlin/coroutines/Continuation;)V
