.class public Lcom/samsung/android/scloud/sync/dependency/NewGallerySyncDependency;
...
.method public static synthetic i(Lcom/samsung/android/scloud/sync/dependency/NewGallerySyncDependency;ILjava/lang/Boolean;)Lkotlin/Unit;
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/samsung/android/scloud/sync/dependency/NewGallerySyncDependency;->lambda$verifyHeatEmissionInRuntime$0(ILjava/lang/Boolean;)Lkotlin/Unit;
...
.method private synthetic lambda$verifyHeatEmissionInRuntime$0(ILjava/lang/Boolean;)Lkotlin/Unit;
    .locals 2
    ...
    const-string/jumbo v0, "verifyHeatEmissionInRuntime. current siop: "

    const-string v1, ", threadhold: 4 cancel sync. syncCategoryVo.authority: "
    ...
    invoke-static {}, Lcom/samsung/android/scloud/sync/dependency/SyncDependencyHandler;->cancelSync()V
...
.method public changeNetworkOption(I)V
    ...
    invoke-static {}, Lcom/samsung/android/scloud/sync/dependency/SyncDependencyHandler;->wifiOnlyOn()V
    ...
    :cond_0
    invoke-static {}, Lcom/samsung/android/scloud/sync/dependency/SyncDependencyHandler;->wifiOnlyOff()V
...
.method public getAutoSync()Z
    ...
    invoke-static {}, Lcom/samsung/android/scloud/sync/dependency/SyncDependencyHandler;->isSyncOn()Z
...
.method public getLastSuccessTime()J
    ...
    invoke-static {}, Lcom/samsung/android/scloud/sync/dependency/SyncDependencyHandler;->getLastSyncTime()J
...
.method public getNetworkOption()I
    ...
    invoke-static {}, Lcom/samsung/android/scloud/sync/dependency/SyncDependencyHandler;->isWiFiOnly()Z
...
.method public isSupported()Z
    ...
    invoke-static {}, Lcom/samsung/android/scloud/sync/dependency/SyncDependencyHandler;->isSupported()Z
...
.method public provisioningIsSyncable(I)I
    ...
    invoke-virtual {p0}, Lcom/samsung/android/scloud/sync/dependency/NewGallerySyncDependency;->getIsSyncable()I
...
.method public requestSync(Landroid/os/Bundle;)V
    ...
    invoke-static {p1, v0}, Lcom/samsung/android/scloud/sync/dependency/SyncDependencyHandler;->requestSync(ZZ)V
...
.method public setAutoSync(Z)V
    ...
    invoke-virtual {p0, p1}, Lcom/samsung/android/scloud/sync/dependency/NewGallerySyncDependency;->switchOnOffV2(Z)V
...
.method public setAutoSyncFromRpc(ZLjava/util/concurrent/CompletableFuture;)V
    ...
    :try_start_0
    invoke-static {}, Lcom/samsung/android/scloud/sync/dependency/SyncDependencyHandler;->syncOn()V
    ...
    :cond_0
    invoke-static {}, Lcom/samsung/android/scloud/sync/dependency/SyncDependencyHandler;->syncOff()V
...
.method public verifyHeatEmissionInRuntime(I)V
    ...
    new-instance v0, Lcom/samsung/android/scloud/sync/dependency/g;

    invoke-direct {v0, p0, p1}, Lcom/samsung/android/scloud/sync/dependency/g;-><init>(Lcom/samsung/android/scloud/sync/dependency/NewGallerySyncDependency;I)V

    invoke-static {v0}, Lcom/samsung/android/scloud/sync/dependency/SyncDependencyHandler;->checkSyncSetting(Lkotlin/jvm/functions/Function1;)V
