...
.method public static b(Ljava/lang/Exception;)LH4/o;
    .locals 8
    ...
    invoke-direct {p0, v2, v0}, LH4/o;-><init>(ZI)V
    ...
    invoke-static {v1, v4}, Lsamsung/scsp/usage/v1/x;->l(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v1, p0, v0, v2}, LH4/o;-><init>(ILjava/lang/String;Z)V
    ...
    invoke-direct {p0, v3, v0, v2}, LH4/o;-><init>(ILjava/lang/String;Z)V
    ...
    invoke-direct {v0, v3, p0, v2}, LH4/o;-><init>(ILjava/lang/String;Z)V

    return-object v0
.end method

.method public static c(Landroid/content/Context;Lsamsung/scsp/usage/v1/x;I)LH4/o;
    .locals 18
    ...
    :cond_0
    invoke-virtual {v2, v1}, Lsamsung/scsp/usage/v1/x;->y(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {v1, v0, v9}, Lcom/samsung/android/sdk/smp/common/network/d;->c(Landroid/content/Context;Lsamsung/scsp/usage/v1/x;I)LH4/o;

    move-result-object v0

    iget-boolean v9, v0, LH4/o;->c:Z

    iget-object v12, v0, LH4/o;->d:Ljava/lang/Object;
    ...
    invoke-direct {v0, v8, v9}, LH4/o;-><init>(ZI)V
    ...
    invoke-virtual {v12, v13, v0}, LHb/D;->u(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_1
    ...
    invoke-direct {v0, v11, v10}, LH4/o;-><init>(ZI)V
    :try_end_2
    ...
    invoke-static {v6, v9}, Lsamsung/scsp/usage/v1/x;->l(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :try_start_5
    invoke-virtual/range {p1 .. p1}, Lsamsung/scsp/usage/v1/x;->u()Lorg/json/JSONObject;
    ...
    invoke-virtual/range {p1 .. p1}, Lsamsung/scsp/usage/v1/x;->G()Z

    move-result v5

    if-eqz v5, :cond_6

    invoke-static {v15}, Lu9/b;->d(Ljava/lang/String;)[B

    move-result-object v15

    new-instance v5, Lcom/samsung/android/sdk/smp/common/network/b;

    invoke-virtual/range {p1 .. p1}, Lsamsung/scsp/usage/v1/x;->x()I
    ...
    invoke-static {v6, v1}, Lsamsung/scsp/usage/v1/x;->B(Ljava/lang/String;Ljava/lang/String;)V

    new-instance v1, LH4/o;

    invoke-direct {v1, v10, v0, v11}, LH4/o;-><init>(ILjava/lang/String;Z)V
    :try_end_5
    ...
    :goto_5
    invoke-static {v0}, Lcom/samsung/android/sdk/smp/common/network/d;->b(Ljava/lang/Exception;)LH4/o;
    ...
    invoke-direct {v0, v8, v7}, LH4/o;-><init>(ZI)V
