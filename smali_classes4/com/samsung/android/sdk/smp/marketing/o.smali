...
.method public final C(Landroid/content/Context;)Z
    ...
    invoke-static {v4, v3, v0}, Lsamsung/scsp/usage/v1/x;->n(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method public final g(Landroid/content/Context;)Z
    ...
    invoke-virtual {p0, p1}, Lcom/samsung/android/sdk/smp/marketing/o;->C(Landroid/content/Context;)Z
...
.method public final i()Landroid/os/Bundle;
    ...
    iget v1, p0, Lcom/samsung/android/sdk/smp/marketing/o;->K:I

    const-string v2, "template_type"

    invoke-virtual {v0, v2, v1}, Landroid/os/BaseBundle;->putInt(Ljava/lang/String;I)V

    iget-boolean v1, p0, Lcom/samsung/android/sdk/smp/marketing/o;->L:Z

    const-string v2, "bottom_visible"

    invoke-virtual {v0, v2, v1}, Landroid/os/BaseBundle;->putBoolean(Ljava/lang/String;Z)V

    iget-boolean v1, p0, Lcom/samsung/android/sdk/smp/marketing/o;->M:Z

    const-string v2, "close_visible"

    invoke-virtual {v0, v2, v1}, Landroid/os/BaseBundle;->putBoolean(Ljava/lang/String;Z)V

    iget v1, p0, Lcom/samsung/android/sdk/smp/marketing/o;->T:I

    const-string v2, "btn_align"

    invoke-virtual {v0, v2, v1}, Landroid/os/BaseBundle;->putInt(Ljava/lang/String;I)V

    iget v1, p0, Lcom/samsung/android/sdk/smp/marketing/o;->O:I

    const-string v2, "color_bg"

    invoke-virtual {v0, v2, v1}, Landroid/os/BaseBundle;->putInt(Ljava/lang/String;I)V

    iget v1, p0, Lcom/samsung/android/sdk/smp/marketing/o;->P:I

    const-string v2, "color_bottom"

    invoke-virtual {v0, v2, v1}, Landroid/os/BaseBundle;->putInt(Ljava/lang/String;I)V

    iget v1, p0, Lcom/samsung/android/sdk/smp/marketing/o;->R:I

    const-string v2, "color_btn_text"

    invoke-virtual {v0, v2, v1}, Landroid/os/BaseBundle;->putInt(Ljava/lang/String;I)V

    iget v1, p0, Lcom/samsung/android/sdk/smp/marketing/o;->Q:I

    const-string v2, "color_body"

    invoke-virtual {v0, v2, v1}, Landroid/os/BaseBundle;->putInt(Ljava/lang/String;I)V

    iget v1, p0, Lcom/samsung/android/sdk/smp/marketing/o;->S:I

    const-string v2, "color_line"

    invoke-virtual {v0, v2, v1}, Landroid/os/BaseBundle;->putInt(Ljava/lang/String;I)V

    iget-object v1, p0, Lcom/samsung/android/sdk/smp/marketing/o;->W:Landroid/text/Spanned;

    const-string v2, "body_text"

    invoke-virtual {v0, v2, v1}, Landroid/os/Bundle;->putCharSequence(Ljava/lang/String;Ljava/lang/CharSequence;)V

    iget-object v1, p0, Lcom/samsung/android/sdk/smp/marketing/o;->Z:Ljava/lang/String;

    const-string/jumbo v2, "web"

    invoke-virtual {v0, v2, v1}, Landroid/os/BaseBundle;->putString(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v1, p0, Lcom/samsung/android/sdk/smp/marketing/o;->X:Ljava/lang/String;

    const-string v2, "btn1_text"

    invoke-virtual {v0, v2, v1}, Landroid/os/BaseBundle;->putString(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v1, p0, Lcom/samsung/android/sdk/smp/marketing/o;->Y:Ljava/lang/String;

    const-string v2, "btn2_text"

    invoke-virtual {v0, v2, v1}, Landroid/os/BaseBundle;->putString(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v1, p0, Lcom/samsung/android/sdk/smp/marketing/o;->a0:Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/samsung/android/sdk/smp/marketing/o;->U:Ljava/util/ArrayList;
    ...
    iget-object v5, p0, Lcom/samsung/android/sdk/smp/marketing/o;->U:Ljava/util/ArrayList;
    ...
    check-cast v5, Lcom/samsung/android/sdk/smp/marketing/j;

    const-string v6, "btn1_link"

    invoke-static {v2, v6}, LA1/c;->f(ILjava/lang/String;)Ljava/lang/String;

    move-result-object v6

    invoke-virtual {v5}, Lcom/samsung/android/sdk/smp/marketing/j;->f()Landroid/os/Bundle;

    move-result-object v7

    invoke-virtual {v0, v6, v7}, Landroid/os/Bundle;->putBundle(Ljava/lang/String;Landroid/os/Bundle;)V

    invoke-virtual {v5}, Lcom/samsung/android/sdk/smp/marketing/j;->b()Ljava/lang/String;
    ...
    :cond_1
    iget-object v2, p0, Lcom/samsung/android/sdk/smp/marketing/o;->V:Ljava/util/ArrayList;
    ...
    iget-object v5, p0, Lcom/samsung/android/sdk/smp/marketing/o;->V:Ljava/util/ArrayList;
    ...
    :cond_4
    iget-boolean v1, p0, Lcom/samsung/android/sdk/smp/marketing/o;->N:Z
...
.method public final o()Z
    ...
    iget v0, p0, Lcom/samsung/android/sdk/smp/marketing/o;->K:I
