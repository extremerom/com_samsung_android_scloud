...
# instance fields
.field private mConsumeList:Ljava/util/ArrayList;
...
.field private final mOnConsumePurchasedItemsListener:Lcom/samsung/android/sdk/iap/lib/listener/OnConsumePurchasedItemsListener;

.field private purchaseIds:Ljava/lang/String;


# direct methods
.method public constructor <init>(Landroid/content/Context;ZILjava/lang/String;Lcom/samsung/android/sdk/iap/lib/listener/OnConsumePurchasedItemsListener;)V
    .locals 0
    ...
    iput-object p1, p0, Lcom/samsung/android/sdk/iap/lib/service/ConsumePurchasedItems;->purchaseIds:Ljava/lang/String;

    const/4 p1, 0x0

    iput-object p1, p0, Lcom/samsung/android/sdk/iap/lib/service/ConsumePurchasedItems;->mConsumeList:Ljava/util/ArrayList;

    iput-object p5, p0, Lcom/samsung/android/sdk/iap/lib/service/ConsumePurchasedItems;->mOnConsumePurchasedItemsListener:Lcom/samsung/android/sdk/iap/lib/listener/OnConsumePurchasedItemsListener;

    return-void
.end method

.method public static synthetic a(Lcom/samsung/android/sdk/iap/lib/service/ConsumePurchasedItems;Lcom/samsung/android/sdk/iap/lib/vo/ErrorVo;Ljava/lang/Object;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/samsung/android/sdk/iap/lib/service/ConsumePurchasedItems;->lambda$safeConsumePurchasedItems$0(Lcom/samsung/android/sdk/iap/lib/vo/ErrorVo;Ljava/lang/Object;)V

    return-void
.end method

.method private synthetic lambda$safeConsumePurchasedItems$0(Lcom/samsung/android/sdk/iap/lib/vo/ErrorVo;Ljava/lang/Object;)V
    .locals 2

    sget-object v0, Lcom/samsung/android/sdk/iap/lib/service/ConsumePurchasedItems;->TAG:Ljava/lang/String;

    const-string v1, "ConsumePurchasedItems.onCompleted()"

    invoke-static {v0, v1}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    check-cast p2, Ljava/util/ArrayList;

    iput-object p2, p0, Lcom/samsung/android/sdk/iap/lib/service/ConsumePurchasedItems;->mConsumeList:Ljava/util/ArrayList;
...
.method private safeConsumePurchasedItems()Z
    .locals 10

    const/4 v0, 0x0

    :try_start_0
    new-instance v9, Lcom/samsung/android/sdk/iap/lib/task/ConsumePurchasedItemsTask;
    ...
    iget-object v4, p0, Lcom/samsung/android/sdk/iap/lib/service/ConsumePurchasedItems;->purchaseIds:Ljava/lang/String;
    ...
    invoke-direct/range {v1 .. v8}, Lcom/samsung/android/sdk/iap/lib/task/ConsumePurchasedItemsTask;-><init>(Landroid/content/Context;Lz1/c;Ljava/lang/String;ZILjava/lang/String;Lcom/samsung/android/sdk/iap/lib/task/AsyncTaskCallback;)V

    sput-object v9, Lcom/samsung/android/sdk/iap/lib/service/ServiceScheduler;->consumePurchasedItemsTask:Lcom/samsung/android/sdk/iap/lib/task/ConsumePurchasedItemsTask;
...
.method public releaseProcess()V
    ...
    const-string v1, "ConsumePurchasedItems.releaseProcess"
...
.method public runServiceProcess()V
    ...
    const-string v1, "consumePurchasedItems has been started!"

    invoke-static {v0, v1}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    invoke-direct {p0}, Lcom/samsung/android/sdk/iap/lib/service/ConsumePurchasedItems;->safeConsumePurchasedItems()Z
