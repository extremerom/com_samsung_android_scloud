...
.field private mOnGetPromotionEligibilityListener:Lcom/samsung/android/sdk/iap/lib/listener/OnGetPromotionEligibilityListener;
...
# direct methods
.method public constructor <init>(Landroid/content/Context;ZILjava/lang/String;Lcom/samsung/android/sdk/iap/lib/listener/OnGetPromotionEligibilityListener;)V
    .locals 0
    ...
    iput-object p1, p0, Lcom/samsung/android/sdk/iap/lib/service/PromotionEligibility;->mItemIDs:Ljava/lang/String;

    iput-object p5, p0, Lcom/samsung/android/sdk/iap/lib/service/PromotionEligibility;->mOnGetPromotionEligibilityListener:Lcom/samsung/android/sdk/iap/lib/listener/OnGetPromotionEligibilityListener;

    return-void
.end method

.method public static synthetic a(Lcom/samsung/android/sdk/iap/lib/service/PromotionEligibility;Lcom/samsung/android/sdk/iap/lib/vo/ErrorVo;Ljava/lang/Object;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/samsung/android/sdk/iap/lib/service/PromotionEligibility;->lambda$safeGetPromotionEligibility$0(Lcom/samsung/android/sdk/iap/lib/vo/ErrorVo;Ljava/lang/Object;)V

    return-void
.end method

.method private synthetic lambda$safeGetPromotionEligibility$0(Lcom/samsung/android/sdk/iap/lib/vo/ErrorVo;Ljava/lang/Object;)V
    .locals 2

    sget-object v0, Lcom/samsung/android/sdk/iap/lib/service/PromotionEligibility;->TAG:Ljava/lang/String;

    const-string v1, "PromotionEligibility.onCompleted()"

    invoke-static {v0, v1}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    check-cast p2, Ljava/util/ArrayList;

    iput-object p2, p0, Lcom/samsung/android/sdk/iap/lib/service/PromotionEligibility;->mPromotionEligibility:Ljava/util/ArrayList;
...
.method private safeGetPromotionEligibility(Ljava/lang/String;)Z
    .locals 10
    ...
    :try_start_0
    new-instance v9, Lcom/samsung/android/sdk/iap/lib/task/GetPromotionEligibilityTask;
    ...
    invoke-direct/range {v1 .. v8}, Lcom/samsung/android/sdk/iap/lib/task/GetPromotionEligibilityTask;-><init>(Landroid/content/Context;Lz1/c;Ljava/lang/String;ZILjava/lang/String;Lcom/samsung/android/sdk/iap/lib/task/AsyncTaskCallback;)V

    sput-object v9, Lcom/samsung/android/sdk/iap/lib/service/ServiceScheduler;->getPromotionEligibilityTask:Lcom/samsung/android/sdk/iap/lib/task/GetPromotionEligibilityTask;
...
.method public releaseProcess()V
    ...
    const-string v1, "PromotionEligibility.releaseProcess"

    invoke-static {v0, v1}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    :try_start_0
    iget-object v0, p0, Lcom/samsung/android/sdk/iap/lib/service/PromotionEligibility;->mOnGetPromotionEligibilityListener:Lcom/samsung/android/sdk/iap/lib/listener/OnGetPromotionEligibilityListener;
...
.method public runServiceProcess()V
    ...
    const-string v1, "GetPromotionEligibility has been started!"

    invoke-static {v0, v1}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    iget-object v0, p0, Lcom/samsung/android/sdk/iap/lib/service/PromotionEligibility;->mItemIDs:Ljava/lang/String;

    invoke-direct {p0, v0}, Lcom/samsung/android/sdk/iap/lib/service/PromotionEligibility;->safeGetPromotionEligibility(Ljava/lang/String;)Z
