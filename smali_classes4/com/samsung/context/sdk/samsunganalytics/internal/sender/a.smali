...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v0}, Ls9/c;->K()Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;LJ9/b;)V
    ...
    invoke-static {p1, p2}, LQ9/a;->d(Landroid/content/Context;LJ9/b;)LQ9/a;
...
.method public static h(Lp9/a;)Lorg/json/JSONArray;
    .locals 5
    ...
    invoke-virtual {p0}, Lp9/a;->x()Ljava/util/HashMap;
...
.method public a(Lv9/b;)V
    ...
    invoke-virtual {v0, v1}, Ls9/c;->U(I)V
    ...
    invoke-virtual {v0, v4, v2, v3}, LHb/D;->t(Ljava/lang/String;J)V
    :try_end_0
    ...
    iget-object v2, p1, Lv9/b;->t:Lorg/json/JSONArray;
    ...
    invoke-virtual {v4, v6, v7}, Lp9/a;->s(Ljava/lang/String;Lorg/json/JSONArray;)V
    :try_end_1
    ...
    invoke-static {v5, v6, v3}, Lcom/samsung/android/scloud/app/ui/newgallery/developer/b;->C(Ljava/lang/Exception;Ljava/lang/StringBuilder;Ljava/lang/String;)V
    ...
    invoke-virtual {v0}, Lp9/a;->l()V

    invoke-virtual {v0}, Lp9/a;->p()V

    invoke-virtual {v0}, Lp9/a;->c()V

    :cond_2
    iget-object v0, p1, Lv9/b;->o:Lorg/json/JSONObject;
    ...
    invoke-virtual {v1, v2, v0}, LHb/D;->u(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_2

    monitor-exit v1

    iget-object v0, p1, Lv9/b;->p:Lorg/json/JSONObject;
    ...
    invoke-virtual {v2, v1, v0}, LHb/D;->u(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_3
    .catchall {:try_start_3 .. :try_end_3} :catchall_1

    monitor-exit v2

    iget-object p1, p1, Lv9/b;->q:Lorg/json/JSONArray;
    ...
    invoke-virtual {v0, v1, p1}, LHb/D;->u(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_4
...
.method public c(ILjava/lang/String;)V
    ...
    invoke-static {p2}, Lv9/d;->b(Landroid/content/Context;)V
    ...
    invoke-virtual {p1, p2, v0}, LHb/D;->u(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
...
.method public abstract d(Lv9/b;Ljava/lang/String;)V
.end method

.method public abstract e()Z
.end method

.method public f(Lp9/a;)Lorg/json/JSONObject;
    .locals 11
    ...
    :try_start_1
    iget-object v2, p1, Lp9/a;->b:Ljava/lang/Object;
    ...
    invoke-static {p1}, Lu9/a;->r(Landroid/content/Context;)Z

    move-result p1

    if-eqz p1, :cond_2

    const-string p1, "p_deviceId"
    ...
    invoke-static {p1, v0}, Lsamsung/scsp/usage/v1/x;->z(Ljava/lang/String;Ljava/lang/String;)V
...
.method public g()Lorg/json/JSONObject;
    ...
    invoke-static {v0}, Lu9/a;->f(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v9, v0}, Lsamsung/scsp/usage/v1/x;->U(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v2, "buildBasicData error. country code and sim mcc null"
    ...
    const-string v2, "SMP_0103"

    const-string v3, "Fail to init. device and sim country code are empty"

    invoke-direct {v0, v2, v3}, Lcom/samsung/android/sdk/smp/common/exception/InternalException$BuildClientsException;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v11, "isProductShip"
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_2
    ...
    invoke-static {v10, v0}, Lsamsung/scsp/usage/v1/x;->U(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v2, v0}, Lu9/a;->d(Landroid/content/Context;Ljava/lang/String;)Landroid/os/Bundle;
    ...
    invoke-static {v0, v15}, Lsamsung/scsp/usage/v1/x;->U(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :try_start_6
    invoke-static {v2, v15, v0}, Lsamsung/scsp/plan/v1/d0;->s(Landroid/content/Context;ILjava/lang/String;)Landroid/content/pm/PackageInfo;
    ...
    :goto_e
    invoke-static {v2}, Lu9/a;->g(Landroid/content/Context;)I
    ...
    invoke-virtual {v15, v10}, Ls9/c;->F(I)Ljava/lang/String;

    move-result-object v15

    :try_start_7
    invoke-static {v0, v15}, Lu9/a;->m(Landroid/content/Context;Ljava/lang/String;)Z

    move-result v15
    :try_end_7
    .catch Lcom/samsung/android/sdk/smp/common/exception/InternalException$IllegalPushChannelException; {:try_start_7 .. :try_end_7} :catch_4
    ...
    invoke-virtual {v10, v11}, Ls9/c;->F(I)Ljava/lang/String;

    move-result-object v10

    :try_start_8
    invoke-static {v0, v10}, Lu9/a;->m(Landroid/content/Context;Ljava/lang/String;)Z

    move-result v0
    :try_end_8
    .catch Lcom/samsung/android/sdk/smp/common/exception/InternalException$IllegalPushChannelException; {:try_start_8 .. :try_end_8} :catch_5
    ...
    invoke-static {v2}, Lu9/a;->r(Landroid/content/Context;)Z
    ...
    invoke-static {v2, v15}, Lsamsung/scsp/gallery/admin/v1/a;->z(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v11, v0}, Lsamsung/scsp/usage/v1/x;->B(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_9
    ...
    invoke-static {v11, v0}, Lsamsung/scsp/usage/v1/x;->l(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v10, v15, v11}, LHb/D;->j(ILjava/lang/String;)I
    ...
    invoke-virtual {v10}, Ls9/c;->L()Ljava/lang/String;
    ...
    invoke-virtual {v15, v0}, LHb/D;->g(Ljava/lang/String;)Z
    ...
    invoke-virtual {v15, v10, v11, v1}, LHb/D;->l(JLjava/lang/String;)Ljava/lang/Long;
    ...
    invoke-static {v2}, Lu9/a;->k(Landroid/content/Context;)Z

    move-result v1

    invoke-static {v2}, Lu9/a;->q(Landroid/content/Context;)Z
...
.method public i()Lorg/json/JSONObject;
    ...
    invoke-static {v0}, LF9/a;->a(Landroid/content/Context;)V
    ...
    sget-object v1, LF9/a;->c:Ljava/lang/String;
...
.method public k(Lorg/json/JSONObject;)V
    ...
    invoke-virtual {v1, v2, v0}, LHb/D;->q(Ljava/lang/String;Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_1
    ...
    :try_start_1
    const-string v1, "debugJob"

    invoke-virtual {v0, v1, p1}, LHb/D;->q(Ljava/lang/String;Z)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public l(Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v3, v1}, LHb/D;->q(Ljava/lang/String;Z)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    invoke-virtual {v3, v4, v1, v2}, LHb/D;->t(Ljava/lang/String;J)V
    :try_end_5
    ...
    invoke-virtual {v2, v1, v3}, LHb/D;->s(ILjava/lang/String;)V
    :try_end_d
    .catchall {:try_start_d .. :try_end_d} :catchall_3
    ...
    invoke-virtual {v3, v1, v2}, Ls9/c;->Q(J)V
    ...
    invoke-virtual {v2, v3, v1}, LHb/D;->u(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_11
    ...
    invoke-virtual {v2, v1}, Ls9/c;->R(Ljava/lang/String;)V
    ...
    const-string v2, "send intent : sps policy"
...
.method public m(Ljava/util/HashMap;)V
    ...
    invoke-static {v0, v4}, La0/a;->n(Ljava/util/Map;Lcom/samsung/context/sdk/samsunganalytics/internal/util/Utils$Depth;)Ljava/lang/String;
    ...
    iget-object p1, p0, Lcom/samsung/context/sdk/samsunganalytics/internal/sender/a;->c:Ljava/lang/Object;

    check-cast p1, LQ9/a;

    invoke-virtual {p1, v6}, LQ9/a;->e(Lcom/samsung/context/sdk/samsunganalytics/internal/sender/c;)V
