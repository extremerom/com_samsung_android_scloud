...
.method public static synthetic e(Landroid/net/ConnectivityManager$NetworkCallback;)V
    .locals 0

    invoke-static {p0}, Lcom/samsung/scsp/common/UtilityImpl;->lambda$requestNetwork$4(Landroid/net/ConnectivityManager$NetworkCallback;)V
...
.method private encodeHex([B)Ljava/lang/String;
    ...
    sget-object v5, Lcom/samsung/scsp/common/UtilityImpl;->DIGITS_LOWER:[C
...
.method public static synthetic f(Landroid/net/ConnectivityManager$NetworkCallback;)V
    ...
    invoke-static {p0}, Lcom/samsung/scsp/common/UtilityImpl;->lambda$unregisterNetworkCallback$5(Landroid/net/ConnectivityManager$NetworkCallback;)V
...
.method private static synthetic lambda$requestNetwork$4(Landroid/net/ConnectivityManager$NetworkCallback;)V
    .locals 3
...
.method private static synthetic lambda$unregisterNetworkCallback$5(Landroid/net/ConnectivityManager$NetworkCallback;)V
    .locals 2
...
.method public batch(Lcom/samsung/scsp/common/BatchRequest;)I
    ...
    :goto_0
    iget v3, p1, Lcom/samsung/scsp/common/BatchRequest;->total:I
    ...
    :cond_0
    iget-object v3, p1, Lcom/samsung/scsp/common/BatchRequest;->request:Ljava/util/function/BiFunction;
    ...
    iget v1, p1, Lcom/samsung/scsp/common/BatchRequest;->size:I
...
.method public deviceName()Ljava/lang/String;
    ...
    invoke-direct {v2, v1, v3}, Lcom/samsung/scsp/common/E;-><init>(Landroid/content/Context;I)V

    new-instance v4, Lcom/samsung/scsp/common/E;

    const/4 v5, 0x1

    invoke-direct {v4, v1, v5}, Lcom/samsung/scsp/common/E;-><init>(Landroid/content/Context;I)V

    new-instance v1, Lcom/samsung/scsp/common/F;

    invoke-direct {v1, v3}, Lcom/samsung/scsp/common/F;-><init>(I)V

    new-array v6, v0, [Lcom/samsung/scsp/error/FaultBarrier$ThrowableSupplier;
...
.method public networkConnected(I)Z
    ...
    invoke-direct {v0, p1}, Lcom/samsung/scsp/common/G;-><init>(I)V
...
.method public requestNetwork(Landroid/net/ConnectivityManager$NetworkCallback;)V
    ...
    invoke-direct {v0, p1, v1}, Lcom/samsung/scsp/common/D;-><init>(Landroid/net/ConnectivityManager$NetworkCallback;I)V
...
.method public transaction(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/Runnable;)V
    ...
    :try_start_1
    const-string v0, "UtilityFactory"

    invoke-static {v0}, Lcom/samsung/scsp/error/Logger;->get(Ljava/lang/String;)Lcom/samsung/scsp/error/Logger;

    move-result-object v0

    const-string/jumbo v1, "transaction failed."

    invoke-virtual {v0, v1, p2}, Lcom/samsung/scsp/error/Logger;->e(Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1
