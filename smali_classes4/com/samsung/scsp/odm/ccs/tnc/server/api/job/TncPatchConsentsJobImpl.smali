.class public final Lcom/samsung/scsp/odm/ccs/tnc/server/api/job/TncPatchConsentsJobImpl;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/samsung/scsp/odm/ccs/tnc/server/api/job/TncPatchConsentsJobImpl$Companion;
    }
.end annotation
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "Lcom/samsung/scsp/odm/ccs/tnc/server/api/job/TncPatchConsentsJobImpl;",
...
# static fields
.field public static final Companion:Lcom/samsung/scsp/odm/ccs/tnc/server/api/job/TncPatchConsentsJobImpl$Companion;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/samsung/scsp/odm/ccs/tnc/server/api/job/TncPatchConsentsJobImpl$Companion;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Lcom/samsung/scsp/odm/ccs/tnc/server/api/job/TncPatchConsentsJobImpl$Companion;-><init>(Lkotlin/jvm/internal/DefaultConstructorMarker;)V

    sput-object v0, Lcom/samsung/scsp/odm/ccs/tnc/server/api/job/TncPatchConsentsJobImpl;->Companion:Lcom/samsung/scsp/odm/ccs/tnc/server/api/job/TncPatchConsentsJobImpl$Companion;

    const-string v0, "TncPatchConsentsJobImpl"

    invoke-static {v0}, Lcom/samsung/scsp/error/Logger;->get(Ljava/lang/String;)Lcom/samsung/scsp/error/Logger;

    move-result-object v0

    const-string v1, "get(\"TncPatchConsentsJobImpl\")"

    invoke-static {v0, v1}, Lkotlin/jvm/internal/Intrinsics;->checkNotNullExpressionValue(Ljava/lang/Object;Ljava/lang/String;)V

    sput-object v0, Lcom/samsung/scsp/odm/ccs/tnc/server/api/job/TncPatchConsentsJobImpl;->logger:Lcom/samsung/scsp/error/Logger;
...
.method public static synthetic a(Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lcom/samsung/scsp/odm/ccs/tnc/server/api/job/TncPatchConsentsJobImpl;->createRequest$lambda-0(Ljava/lang/StringBuilder;)Ljava/lang/String;
...
.method public createRequest(Lcom/samsung/scsp/framework/core/api/ApiContext;Lcom/samsung/scsp/framework/core/listeners/Listeners;)Lcom/samsung/scsp/framework/core/network/HttpRequest;
    ...
    sget-object v2, Lcom/samsung/scsp/odm/ccs/tnc/server/api/job/TncPatchConsentsJobImpl;->logger:Lcom/samsung/scsp/error/Logger;
