.class public final Lcom/samsung/scsp/odm/ccs/tnc/server/api/job/TncGetConsentsJobImpl;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/samsung/scsp/odm/ccs/tnc/server/api/job/TncGetConsentsJobImpl$Companion;
    }
.end annotation
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "Lcom/samsung/scsp/odm/ccs/tnc/server/api/job/TncGetConsentsJobImpl;",
...
# static fields
.field public static final Companion:Lcom/samsung/scsp/odm/ccs/tnc/server/api/job/TncGetConsentsJobImpl$Companion;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/samsung/scsp/odm/ccs/tnc/server/api/job/TncGetConsentsJobImpl$Companion;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Lcom/samsung/scsp/odm/ccs/tnc/server/api/job/TncGetConsentsJobImpl$Companion;-><init>(Lkotlin/jvm/internal/DefaultConstructorMarker;)V

    sput-object v0, Lcom/samsung/scsp/odm/ccs/tnc/server/api/job/TncGetConsentsJobImpl;->Companion:Lcom/samsung/scsp/odm/ccs/tnc/server/api/job/TncGetConsentsJobImpl$Companion;

    const-string v0, "TncGetConsentsJobImpl"

    invoke-static {v0}, Lcom/samsung/scsp/error/Logger;->get(Ljava/lang/String;)Lcom/samsung/scsp/error/Logger;

    move-result-object v0

    const-string v1, "get(\"TncGetConsentsJobImpl\")"

    invoke-static {v0, v1}, Lkotlin/jvm/internal/Intrinsics;->checkNotNullExpressionValue(Ljava/lang/Object;Ljava/lang/String;)V

    sput-object v0, Lcom/samsung/scsp/odm/ccs/tnc/server/api/job/TncGetConsentsJobImpl;->logger:Lcom/samsung/scsp/error/Logger;
...
.method public static synthetic f(Ljava/util/Map;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lcom/samsung/scsp/odm/ccs/tnc/server/api/job/TncGetConsentsJobImpl;->onStream$lambda-1(Ljava/util/Map;)Ljava/lang/String;
...
.method public static synthetic g(Ljava/lang/StringBuilder;)Ljava/lang/String;
    .locals 0

    invoke-static {p0}, Lcom/samsung/scsp/odm/ccs/tnc/server/api/job/TncGetConsentsJobImpl;->createRequest$lambda-0(Ljava/lang/StringBuilder;)Ljava/lang/String;
...
.method public createRequest(Lcom/samsung/scsp/framework/core/api/ApiContext;Lcom/samsung/scsp/framework/core/listeners/Listeners;)Lcom/samsung/scsp/framework/core/network/HttpRequest;
    ...
    sget-object v1, Lcom/samsung/scsp/odm/ccs/tnc/server/api/job/TncGetConsentsJobImpl;->logger:Lcom/samsung/scsp/error/Logger;

    new-instance v2, Lcom/samsung/android/scloud/platformconfig/server/b;

    const/4 v3, 0x1

    invoke-direct {v2, v3, v0}, Lcom/samsung/android/scloud/platformconfig/server/b;-><init>(ILjava/lang/StringBuilder;)V
...
.method public onStream(Lcom/samsung/scsp/framework/core/network/HttpRequest;Ljava/util/Map;Ljava/io/InputStream;)V
    ...
    new-instance v2, Lcom/samsung/android/scloud/auth/s;

    const/4 v3, 0x1

    invoke-direct {v2, v3, p2}, Lcom/samsung/android/scloud/auth/s;-><init>(ILjava/util/Map;)V
    ...
    invoke-static {p2, v1, v0, v2}, Lkotlin/text/StringsKt;->T(Ljava/lang/String;[CII)Ljava/util/List;
