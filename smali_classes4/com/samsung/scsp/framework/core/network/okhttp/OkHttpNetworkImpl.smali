...
.field private final okHttpClient:Lokhttp3/D;
...
.method public constructor <init>(Ljava/util/function/Predicate;)V
    ...
    invoke-virtual {v0}, Lokhttp3/D$a;->build()Lokhttp3/D;

    move-result-object v0

    iput-object v0, p0, Lcom/samsung/scsp/framework/core/network/okhttp/OkHttpNetworkImpl;->okHttpClient:Lokhttp3/D;
...
.method private checkNetworkClosing()V
    ...
    :try_start_0
    iget-boolean v1, p0, Lcom/samsung/scsp/framework/core/network/okhttp/OkHttpNetworkImpl;->isClosing:Z
    ...
    const-string v2, "Network is closing, try again later."
...
.method private createCall(Lcom/samsung/scsp/framework/core/network/HttpRequest;Lokhttp3/E;)Lokhttp3/g;
    .locals 3
    ...
    iget-object v0, p0, Lcom/samsung/scsp/framework/core/network/okhttp/OkHttpNetworkImpl;->okHttpClient:Lokhttp3/D;

    invoke-virtual {v0}, Lokhttp3/D;->newBuilder()Lokhttp3/D$a;
    ...
    invoke-virtual {v0, v1, v2, p1}, Lokhttp3/D$a;->connectTimeout(JLjava/util/concurrent/TimeUnit;)Lokhttp3/D$a;

    move-result-object v0

    invoke-virtual {v0, v1, v2, p1}, Lokhttp3/D$a;->readTimeout(JLjava/util/concurrent/TimeUnit;)Lokhttp3/D$a;

    move-result-object v0

    invoke-virtual {v0, v1, v2, p1}, Lokhttp3/D$a;->writeTimeout(JLjava/util/concurrent/TimeUnit;)Lokhttp3/D$a;
    ...
    invoke-virtual {p1, p2}, Lokhttp3/D;->newCall(Lokhttp3/E;)Lokhttp3/g;
    ...
    :cond_0
    iget-object p1, p0, Lcom/samsung/scsp/framework/core/network/okhttp/OkHttpNetworkImpl;->okHttpClient:Lokhttp3/D;
...
.method public static synthetic e(Lokhttp3/g;)Z
    .locals 0

    invoke-static {p0}, Lcom/samsung/scsp/framework/core/network/okhttp/OkHttpNetworkImpl;->lambda$close$3(Lokhttp3/g;)Z
...
.method private execute(Lcom/samsung/scsp/framework/core/network/HttpRequest;Lcom/samsung/scsp/framework/core/network/okhttp/OkHttpNetworkImpl$RequestSetter;Lcom/samsung/scsp/framework/core/network/Network$StreamListener;)V
    ...
    invoke-virtual {v5, v7, v6}, Lokhttp3/E$a;->addHeader(Ljava/lang/String;Ljava/lang/String;)Lokhttp3/E$a;
    ...
    :cond_1
    invoke-interface {p2, v5}, Lcom/samsung/scsp/framework/core/network/okhttp/OkHttpNetworkImpl$RequestSetter;->setup(Lokhttp3/E$a;)V

    invoke-virtual {v5}, Lokhttp3/E$a;->build()Lokhttp3/E;

    move-result-object v1

    invoke-direct {p0, p1, v1}, Lcom/samsung/scsp/framework/core/network/okhttp/OkHttpNetworkImpl;->createCall(Lcom/samsung/scsp/framework/core/network/HttpRequest;Lokhttp3/E;)Lokhttp3/g;
    ...
    :cond_2
    invoke-interface {v1}, Lokhttp3/g;->execute()Lokhttp3/G;
    ...
    invoke-direct {v6, v1, v7}, Lcom/samsung/scsp/framework/core/network/okhttp/c;-><init>(Lokhttp3/G;I)V
    ...
    invoke-virtual {v7}, Lokhttp3/x;->names()Ljava/util/Set;
    ...
    invoke-direct {v9, v1}, Lcom/samsung/scsp/framework/core/network/okhttp/f;-><init>(Lokhttp3/G;)V
    ...
    invoke-direct {v8, v1, v9}, Lcom/samsung/scsp/framework/core/network/okhttp/c;-><init>(Lokhttp3/G;I)V
    ...
    invoke-virtual {v1, p2}, Lokhttp3/G;->header(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v1}, Lokhttp3/H;->byteStream()Ljava/io/InputStream;
    ...
    new-instance p2, Lorg/brotli/dec/b;

    invoke-direct {p2, v1}, Lorg/brotli/dec/b;-><init>(Ljava/io/InputStream;)V
    ...
    invoke-virtual {v1, v5}, Lokhttp3/G;->header(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {p2, p0, p3, v2, p1}, LI/a;-><init>(Ljava/lang/Object;ILjava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-direct {p3, v1, p1, p2}, Lcom/samsung/android/scloud/smartswitch/c;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-direct {p3, p0, v0, v2, p1}, LI/a;-><init>(Ljava/lang/Object;ILjava/lang/Object;Ljava/lang/Object;)V
    ...
    const-string p3, "Network is not allowed."
...
.method public static synthetic f(ILokhttp3/g;)Z
    .locals 0

    invoke-static {p0, p1}, Lcom/samsung/scsp/framework/core/network/okhttp/OkHttpNetworkImpl;->lambda$close$4(ILokhttp3/g;)Z
...
.method public static synthetic h(Lcom/samsung/scsp/framework/core/network/HttpRequest;Lokhttp3/E$a;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/samsung/scsp/framework/core/network/okhttp/OkHttpNetworkImpl;->lambda$put$1(Lcom/samsung/scsp/framework/core/network/HttpRequest;Lokhttp3/E$a;)V
...
.method public static synthetic j(Lcom/samsung/scsp/framework/core/network/HttpRequest;Lokhttp3/E$a;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/samsung/scsp/framework/core/network/okhttp/OkHttpNetworkImpl;->lambda$patch$2(Lcom/samsung/scsp/framework/core/network/HttpRequest;Lokhttp3/E$a;)V
...
.method public static synthetic l(Lokhttp3/G;)Ljava/lang/String;
    .locals 0

    invoke-static {p0}, Lcom/samsung/scsp/framework/core/network/okhttp/OkHttpNetworkImpl;->lambda$execute$8(Lokhttp3/G;)Ljava/lang/String;
...
.method private static synthetic lambda$close$3(Lokhttp3/g;)Z
    .locals 0
...
.method private static synthetic lambda$close$4(ILokhttp3/g;)Z
    .locals 0
...
.method private static synthetic lambda$execute$15(Lcom/samsung/scsp/common/Holder;)V
    ...
    invoke-virtual {p0}, Lokhttp3/G;->close()V
...
.method private synthetic lambda$execute$16(Lcom/samsung/scsp/common/Holder;Lcom/samsung/scsp/framework/core/network/HttpRequest;)V
    ...
    iget-object v0, p0, Lcom/samsung/scsp/framework/core/network/okhttp/OkHttpNetworkImpl;->logger:Lcom/samsung/scsp/error/Logger;

    const-string v1, "call is removed."
    ...
    invoke-interface {p2, p1}, Lcom/samsung/scsp/framework/core/listeners/NetworkStatusListener;->onClosed(I)V

    :cond_0
    return-void
.end method

.method private static synthetic lambda$execute$6(Lokhttp3/G;)Ljava/lang/String;
    .locals 2
    ...
    invoke-virtual {p0}, Lokhttp3/G;->protocol()Lokhttp3/Protocol;
...
.method private static synthetic lambda$execute$8(Lokhttp3/G;)Ljava/lang/String;
    .locals 2
...
.method private static synthetic lambda$patch$2(Lcom/samsung/scsp/framework/core/network/HttpRequest;Lokhttp3/E$a;)V
    .locals 2
    ...
    invoke-static {p0, v1, v0}, Lcom/samsung/scsp/framework/core/network/okhttp/RequestBodyFactory;->get(Lcom/samsung/scsp/framework/core/network/HttpRequest;Ljava/lang/Object;Ljava/lang/String;)Lokhttp3/F;

    move-result-object p0

    invoke-virtual {p1, p0}, Lokhttp3/E$a;->patch(Lokhttp3/F;)Lokhttp3/E$a;

    return-void
.end method

.method private static synthetic lambda$post$0(Lcom/samsung/scsp/framework/core/network/HttpRequest;Lokhttp3/E$a;)V
    .locals 7
    ...
    sget-object v3, Lokhttp3/C;->h:Lokhttp3/B;

    invoke-virtual {v1, v3}, Lokhttp3/C$a;->setType(Lokhttp3/B;)Lokhttp3/C$a;
    ...
    invoke-static {p0, v4, v5}, Lcom/samsung/scsp/framework/core/network/okhttp/RequestBodyFactory;->get(Lcom/samsung/scsp/framework/core/network/HttpRequest;Ljava/lang/Object;Ljava/lang/String;)Lokhttp3/F;

    move-result-object v4

    if-eqz v3, :cond_0

    new-instance v5, Lokhttp3/x$a;

    invoke-direct {v5}, Lokhttp3/x$a;-><init>()V

    new-instance v6, Lcom/samsung/scsp/framework/core/network/okhttp/i;

    invoke-direct {v6, v5}, Lcom/samsung/scsp/framework/core/network/okhttp/i;-><init>(Lokhttp3/x$a;)V

    invoke-interface {v3, v6}, Ljava/util/Map;->forEach(Ljava/util/function/BiConsumer;)V

    invoke-virtual {v5}, Lokhttp3/x$a;->build()Lokhttp3/x;

    move-result-object v3

    invoke-static {v3, v4}, Lokhttp3/C$c;->create(Lokhttp3/x;Lokhttp3/F;)Lokhttp3/C$c;

    move-result-object v3

    invoke-virtual {v1, v3}, Lokhttp3/C$a;->addPart(Lokhttp3/C$c;)Lokhttp3/C$a;

    goto :goto_1

    :cond_0
    invoke-static {v4}, Lokhttp3/C$c;->create(Lokhttp3/F;)Lokhttp3/C$c;
    ...
    :cond_1
    invoke-virtual {v1}, Lokhttp3/C$a;->build()Lokhttp3/C;

    move-result-object p0

    invoke-virtual {p1, p0}, Lokhttp3/E$a;->post(Lokhttp3/F;)Lokhttp3/E$a;
    ...
    invoke-static {p0, v0, v1}, Lcom/samsung/scsp/framework/core/network/okhttp/RequestBodyFactory;->get(Lcom/samsung/scsp/framework/core/network/HttpRequest;Ljava/lang/Object;Ljava/lang/String;)Lokhttp3/F;
...
.method private static synthetic lambda$put$1(Lcom/samsung/scsp/framework/core/network/HttpRequest;Lokhttp3/E$a;)V
    .locals 2
    ...
    invoke-virtual {p1, p0}, Lokhttp3/E$a;->put(Lokhttp3/F;)Lokhttp3/E$a;
...
.method public static synthetic n(Lcom/samsung/scsp/framework/core/network/HttpRequest;Lokhttp3/E$a;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/samsung/scsp/framework/core/network/okhttp/OkHttpNetworkImpl;->lambda$post$0(Lcom/samsung/scsp/framework/core/network/HttpRequest;Lokhttp3/E$a;)V
...
.method private printHeader(Lcom/samsung/scsp/framework/core/network/HttpRequest;Ljava/util/Map;)V
    ...
    invoke-direct {v1, v2, p2, p1}, Lcom/samsung/android/scloud/newgallery/data/datasource/local/M;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V
...
.method public static synthetic q(Lokhttp3/G;)Ljava/lang/String;
    .locals 0

    invoke-static {p0}, Lcom/samsung/scsp/framework/core/network/okhttp/OkHttpNetworkImpl;->lambda$execute$6(Lokhttp3/G;)Ljava/lang/String;
...
.method public close(I)V
    ...
    new-instance v0, Lcom/samsung/android/motionphoto/utils/v2/i;

    const/16 v1, 0xb

    invoke-direct {v0, p1, v1}, Lcom/samsung/android/motionphoto/utils/v2/i;-><init>(II)V
