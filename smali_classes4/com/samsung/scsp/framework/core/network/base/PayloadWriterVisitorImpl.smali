...
.method private visit(Lcom/samsung/scsp/framework/core/network/visitor/PayloadWriterVisitor$Payload;Ljava/io/FileInputStream;Z)V
    ...
    iget-wide v0, p1, Lcom/samsung/scsp/framework/core/network/visitor/PayloadWriterVisitor$Payload;->transferred:J
    ...
    :try_start_0
    iget-object v1, p1, Lcom/samsung/scsp/framework/core/network/visitor/PayloadWriterVisitor$Payload;->httpRequest:Lcom/samsung/scsp/framework/core/network/HttpRequest;

    invoke-interface {v1}, Lcom/samsung/scsp/framework/core/network/HttpRequest;->getProgressListener()Lcom/samsung/scsp/framework/core/listeners/ProgressListener;
    ...
    iget-wide v2, p1, Lcom/samsung/scsp/framework/core/network/visitor/PayloadWriterVisitor$Payload;->length:J

    invoke-static {v1, p2, v7, v2, v3}, Lcom/samsung/scsp/framework/core/network/ByteBufferWriter;->write(Ljava/io/OutputStream;Ljava/io/InputStream;Lcom/samsung/scsp/framework/core/network/ByteBufferWriter$BufferWriterListener;J)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    if-eqz p3, :cond_1

    new-instance p1, Lcom/samsung/scsp/framework/core/network/base/i;

    const/4 p3, 0x2

    invoke-direct {p1, p2, p3}, Lcom/samsung/scsp/framework/core/network/base/i;-><init>(Ljava/lang/Object;I)V

    invoke-static {p1, v0}, Lcom/samsung/scsp/error/FaultBarrier;->run(Lcom/samsung/scsp/error/FaultBarrier$ThrowableRunnable;Z)Lcom/samsung/scsp/error/Result;
    ...
    new-instance p3, Lcom/samsung/scsp/framework/core/network/base/i;

    const/4 v1, 0x2

    invoke-direct {p3, p2, v1}, Lcom/samsung/scsp/framework/core/network/base/i;-><init>(Ljava/lang/Object;I)V
...
.method public visit(Lcom/samsung/scsp/framework/core/network/visitor/PayloadWriterVisitor$Payload;Lcom/samsung/scsp/framework/core/network/visitor/StringPayloadWriter;)V
    ...
    invoke-direct {v0, p1}, Lcom/samsung/scsp/framework/core/network/base/j;-><init>(Lcom/samsung/scsp/framework/core/network/visitor/PayloadWriterVisitor$Payload;)V
