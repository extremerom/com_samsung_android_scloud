...
.method private synthetic lambda$update$0(Lcom/samsung/scsp/framework/core/identity/PushInfoList;Lcom/samsung/scsp/framework/core/identity/DeviceInfo;)V
    ...
    iget-object v0, p0, Lcom/samsung/scsp/framework/core/identity/UserUpdater;->updateApi:Lcom/samsung/scsp/framework/core/identity/UserUpdateApiImpl;

    invoke-virtual {v0, p1, p2}, Lcom/samsung/scsp/framework/core/identity/UserUpdateApiImpl;->update(Lcom/samsung/scsp/framework/core/identity/PushInfoList;Lcom/samsung/scsp/framework/core/identity/DeviceInfo;)V
...
.method public getNewPushInfoList()Lcom/samsung/scsp/framework/core/identity/PushInfoList;
    ...
    invoke-direct {v3, v0}, Lcom/samsung/scsp/framework/core/identity/PushInfoList;-><init>([Lcom/samsung/scsp/framework/core/identity/PushInfo;)V
    ...
    :cond_1
    invoke-virtual {v3}, Lcom/samsung/scsp/framework/core/identity/PushInfoList;->getPushInfoList()Ljava/util/List;

    move-result-object v0

    new-instance v3, Lcom/samsung/scsp/framework/core/identity/PushInfoList;

    invoke-direct {v3, v1}, Lcom/samsung/scsp/framework/core/identity/PushInfoList;-><init>(Ljava/lang/String;)V
    ...
    new-instance v6, Lcom/samsung/scsp/framework/core/identity/l;

    const/4 v7, 0x0

    invoke-direct {v6, v4, v7}, Lcom/samsung/scsp/framework/core/identity/l;-><init>(Lcom/samsung/scsp/framework/core/identity/PushInfo;I)V
    ...
    invoke-virtual {v5, v4}, Lcom/samsung/scsp/framework/core/identity/PushInfo;->equalsValue(Lcom/samsung/scsp/framework/core/identity/PushInfo;)Z
    ...
    invoke-direct {v6, v5, v7}, Lcom/samsung/scsp/framework/core/identity/l;-><init>(Lcom/samsung/scsp/framework/core/identity/PushInfo;I)V
    ...
    invoke-direct {v0, v3}, Lcom/samsung/scsp/framework/core/identity/PushInfoList;-><init>(Ljava/util/List;)V

    return-object v0

    :cond_6
    :goto_1
    iget-object v0, p0, Lcom/samsung/scsp/framework/core/identity/UserUpdater;->logger:Lcom/samsung/scsp/error/Logger;

    const-string v1, "no push info or account info. skip to update push info."
...
.method public update()V
    ...
    invoke-direct {v2, p0, v3, v0, v1}, Lcom/samsung/scsp/framework/core/identity/d;-><init>(Ljava/lang/Object;ILjava/lang/Object;Ljava/lang/Object;)V
