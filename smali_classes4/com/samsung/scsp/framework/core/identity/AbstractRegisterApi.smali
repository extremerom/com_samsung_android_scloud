...
.method public static synthetic a(Lcom/google/gson/l;)Ljava/lang/String;
    .locals 0

    invoke-static {p0}, Lcom/samsung/scsp/framework/core/identity/AbstractRegisterApi;->lambda$register$0(Lcom/google/gson/l;)Ljava/lang/String;
...
.method public static synthetic c(Lcom/google/gson/l;)V
    .locals 0

    invoke-static {p0}, Lcom/samsung/scsp/framework/core/identity/AbstractRegisterApi;->lambda$makeDevicePayload$4(Lcom/google/gson/l;)V

    return-void
.end method

.method public static synthetic d(Lcom/samsung/scsp/framework/core/identity/AbstractRegisterApi;Ljava/util/Map;Lcom/google/gson/l;Lcom/samsung/scsp/framework/core/network/HttpRequest;Ljava/util/Map;Ljava/io/InputStream;)V
    .locals 0

    invoke-direct/range {p0 .. p5}, Lcom/samsung/scsp/framework/core/identity/AbstractRegisterApi;->lambda$register$1(Ljava/util/Map;Lcom/google/gson/l;Lcom/samsung/scsp/framework/core/network/HttpRequest;Ljava/util/Map;Ljava/io/InputStream;)V
...
.method private static synthetic lambda$makeDevicePayload$4(Lcom/google/gson/l;)V
    .locals 2
    ...
    invoke-virtual {p0, v1, v0}, Lcom/google/gson/l;->j(Ljava/lang/String;Ljava/lang/String;)V
...
.method private synthetic lambda$makeRequestHeader$2(Lcom/samsung/scsp/framework/core/SContextHolder;)Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/samsung/scsp/framework/core/identity/AbstractRegisterApi;->deviceId:Lcom/samsung/scsp/framework/core/identity/DeviceId;
    ...
    invoke-virtual {v0, p1}, Lcom/samsung/scsp/framework/core/identity/DeviceId;->getPhysicalDeviceId(Lcom/samsung/scsp/framework/core/identity/DeviceIdSupplier;)Ljava/lang/String;
...
.method private static synthetic lambda$register$0(Lcom/google/gson/l;)Ljava/lang/String;
    .locals 2
...
.method private lambda$register$1(Ljava/util/Map;Lcom/google/gson/l;Lcom/samsung/scsp/framework/core/network/HttpRequest;Ljava/util/Map;Ljava/io/InputStream;)V
    .locals 1
    ...
    const-class p4, Lcom/google/gson/l;
    ...
    invoke-direct {p5, p3, v0}, Lcom/samsung/scsp/framework/core/identity/b;-><init>(Lcom/google/gson/l;I)V
    ...
    invoke-virtual {p3, p5}, Lcom/google/gson/l;->k(Ljava/lang/String;)Lcom/google/gson/j;

    move-result-object p5

    invoke-virtual {p5}, Lcom/google/gson/j;->f()Ljava/lang/String;
    ...
    invoke-virtual {p3, p4}, Lcom/google/gson/l;->l(Ljava/lang/String;)Lcom/google/gson/i;

    move-result-object p3

    invoke-direct {p0, p3}, Lcom/samsung/scsp/framework/core/identity/AbstractRegisterApi;->saveTokens(Lcom/google/gson/i;)V
    ...
    invoke-virtual {p0, p1}, Lcom/samsung/scsp/framework/core/identity/AbstractRegisterApi;->saveAppPayload(Lcom/google/gson/l;)V
    ...
    invoke-direct {p0, p1}, Lcom/samsung/scsp/framework/core/identity/AbstractRegisterApi;->saveDevicePayload(Lcom/google/gson/l;)V

    :cond_0
    return-void
.end method

.method private makeDevicePayload()Lcom/google/gson/l;
    .locals 4
    ...
    const-string v3, "osUserId"

    invoke-virtual {v1, v3, v2}, Lcom/google/gson/l;->j(Ljava/lang/String;Ljava/lang/String;)V

    new-instance v2, Lcom/samsung/scsp/framework/core/identity/a;

    const/4 v3, 0x1

    invoke-direct {v2, v1, v3}, Lcom/samsung/scsp/framework/core/identity/a;-><init>(Ljava/lang/Object;I)V

    invoke-static {v2, v3}, Lcom/samsung/scsp/error/FaultBarrier;->run(Lcom/samsung/scsp/error/FaultBarrier$ThrowableRunnable;Z)Lcom/samsung/scsp/error/Result;
    ...
    invoke-virtual {v1, v2, v0}, Lcom/google/gson/l;->j(Ljava/lang/String;Ljava/lang/String;)V
...
.method private saveDevicePayload(Lcom/google/gson/l;)V
    .locals 3
    ...
    iget-object v0, v0, Lcom/samsung/scsp/framework/core/identity/ScspCorePreferences;->deviceAlias:Lcom/samsung/scsp/common/PreferenceItem;
    ...
    iget-object v2, v2, Lcom/samsung/scsp/framework/core/identity/ScspCorePreferences;->simMcc:Lcom/samsung/scsp/common/PreferenceItem;
    ...
    invoke-virtual {v2, v1}, Lcom/samsung/scsp/common/PreferenceItem;->accept(Ljava/lang/Object;)V
    ...
    iget-object v0, v0, Lcom/samsung/scsp/framework/core/identity/ScspCorePreferences;->simMnc:Lcom/samsung/scsp/common/PreferenceItem;
...
.method private saveTokens(Lcom/google/gson/i;)V
    .locals 10

    const/4 v0, 0x0

    :goto_0
    iget-object v1, p1, Lcom/google/gson/i;->a:Ljava/util/ArrayList;
    ...
    invoke-virtual {p1, v0}, Lcom/google/gson/i;->i(I)Lcom/google/gson/j;
    ...
    invoke-virtual {v1, v4}, Lcom/google/gson/l;->k(Ljava/lang/String;)Lcom/google/gson/j;
    ...
    invoke-virtual {v1, v6}, Lcom/google/gson/l;->k(Ljava/lang/String;)Lcom/google/gson/j;
...
.method public makeAppPayload()Lcom/google/gson/l;
    ...
    iget-object v1, v1, Lcom/samsung/scsp/framework/core/SContextHolder;->version:Ljava/lang/String;
...
.method public makeRequestHeader(Lcom/samsung/scsp/framework/core/SContextHolder;)Ljava/util/Map;
    ...
    :cond_1
    iget-object p1, p0, Lcom/samsung/scsp/framework/core/identity/AbstractRegisterApi;->deviceId:Lcom/samsung/scsp/framework/core/identity/DeviceId;
    ...
    invoke-direct {v1, p1, v3}, Lcom/samsung/scsp/framework/core/identity/a;-><init>(Ljava/lang/Object;I)V
    ...
    const-string/jumbo v1, "x-sc-ssdid"
    ...
    const-string v1, "There is no cdid."
...
.method public register()V
    ...
    invoke-virtual {p0}, Lcom/samsung/scsp/framework/core/identity/AbstractRegisterApi;->makeAppPayload()Lcom/google/gson/l;

    move-result-object v4

    invoke-virtual {v2, v3, v4}, Lcom/google/gson/l;->g(Ljava/lang/String;Lcom/google/gson/j;)V

    const-string v3, "device"

    invoke-direct {p0}, Lcom/samsung/scsp/framework/core/identity/AbstractRegisterApi;->makeDevicePayload()Lcom/google/gson/l;
    ...
    invoke-direct {v4, p0, v5, v1, v2}, Lcom/samsung/scsp/framework/core/identity/d;-><init>(Ljava/lang/Object;ILjava/lang/Object;Ljava/lang/Object;)V
