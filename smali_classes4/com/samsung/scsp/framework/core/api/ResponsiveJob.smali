...
.method public onStream(Lcom/samsung/scsp/framework/core/network/HttpRequest;Ljava/util/Map;Ljava/io/InputStream;)V
    ...
    :cond_0
    iget-object p3, p0, Lcom/samsung/scsp/framework/core/api/ResponsiveJob;->responseClass:Ljava/lang/Class;

    invoke-static {p3}, Ljava/util/Objects;->requireNonNull(Ljava/lang/Object;)Ljava/lang/Object;

    new-instance v1, Lcom/samsung/scsp/framework/core/api/b;

    const/4 v3, 0x1

    invoke-direct {v1, p3, v3}, Lcom/samsung/scsp/framework/core/api/b;-><init>(Ljava/lang/Class;I)V
    ...
    invoke-virtual {v1, v3, p3}, Lcom/google/gson/g;->e(Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/Object;

    move-result-object p3

    :goto_1
    instance-of v1, p3, Lcom/samsung/scsp/framework/core/api/CacheableResponse;

    const/4 v3, 0x1

    if-eqz v1, :cond_3

    new-instance v1, Lcom/samsung/scsp/framework/core/api/f;

    const/4 v4, 0x0

    invoke-direct {v1, v4, p2}, Lcom/samsung/scsp/framework/core/api/f;-><init>(ILjava/util/Map;)V
    ...
    check-cast v4, Lcom/samsung/scsp/framework/core/api/CacheableResponse;

    invoke-interface {v4, v0, v1}, Lcom/samsung/scsp/framework/core/api/CacheableResponse;->update(ILjava/lang/String;)V

    :cond_3
    instance-of v0, p3, Lcom/samsung/scsp/framework/core/api/DrsSupportableResponse;
    ...
    new-instance v1, Lcom/samsung/scsp/framework/core/api/g;
    ...
    invoke-direct {v0, v1, p2}, Lcom/samsung/scsp/framework/core/api/f;-><init>(ILjava/util/Map;)V

    const-string v1, "false"

    invoke-static {v0, v1, v3}, Lcom/samsung/scsp/error/FaultBarrier;->get(Lcom/samsung/scsp/error/FaultBarrier$ThrowableSupplier;Ljava/lang/Object;Z)Lcom/samsung/scsp/error/Response;
    ...
    check-cast v2, Lcom/samsung/scsp/framework/core/api/DrsSupportableResponse;

    invoke-interface {v2, v0, v1}, Lcom/samsung/scsp/framework/core/api/DrsSupportableResponse;->update(ZLjava/lang/String;)V
    ...
    invoke-interface {p1, p3, p2}, Lcom/samsung/scsp/framework/core/listeners/ResponseListener;->onResponse(Ljava/lang/Object;Ljava/util/Map;)V
