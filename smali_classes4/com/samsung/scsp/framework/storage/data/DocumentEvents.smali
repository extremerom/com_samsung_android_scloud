.class public Lcom/samsung/scsp/framework/storage/data/DocumentEvents;
...
.field private deletedList:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Lcom/samsung/scsp/framework/storage/data/DeletedDocument;",
            ">;"
        }
    .end annotation
.end field
...
.field private updatedList:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "TT;>;"
...
.method private constructor <init>(Landroid/content/Context;Ljava/lang/String;Ljava/lang/Class;)V
    ...
    iput-object v0, p0, Lcom/samsung/scsp/framework/storage/data/DocumentEvents;->updatedList:Ljava/util/List;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/samsung/scsp/framework/storage/data/DocumentEvents;->deletedList:Ljava/util/List;

    iput-object p1, p0, Lcom/samsung/scsp/framework/storage/data/DocumentEvents;->context:Landroid/content/Context;

    iput-object p2, p0, Lcom/samsung/scsp/framework/storage/data/DocumentEvents;->downloadPath:Ljava/lang/String;

    iput-object p3, p0, Lcom/samsung/scsp/framework/storage/data/DocumentEvents;->responseClass:Ljava/lang/Class;
    ...
    :goto_0
    iput-boolean p1, p0, Lcom/samsung/scsp/framework/storage/data/DocumentEvents;->isJsonType:Z

    return-void
.end method

.method private constructor <init>(Landroid/content/Context;Ljava/util/List;Ljava/util/List;Ljava/lang/Class;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p4, p0, Lcom/samsung/scsp/framework/storage/data/DocumentEvents;->responseClass:Ljava/lang/Class;

    iput-object p2, p0, Lcom/samsung/scsp/framework/storage/data/DocumentEvents;->updatedList:Ljava/util/List;

    iput-object p3, p0, Lcom/samsung/scsp/framework/storage/data/DocumentEvents;->deletedList:Ljava/util/List;

    return-void
.end method

.method public static getDocumentEventsFromFile(Landroid/content/Context;Ljava/lang/String;Ljava/lang/Class;)Lcom/samsung/scsp/framework/storage/data/DocumentEvents;
    .locals 1

    invoke-static {p2}, Lcom/samsung/scsp/framework/storage/data/DocumentEvents;->verifyResponseClass(Ljava/lang/Class;)V

    new-instance v0, Lcom/samsung/scsp/framework/storage/data/DocumentEvents;

    invoke-direct {v0, p0, p1, p2}, Lcom/samsung/scsp/framework/storage/data/DocumentEvents;-><init>(Landroid/content/Context;Ljava/lang/String;Ljava/lang/Class;)V

    invoke-direct {v0}, Lcom/samsung/scsp/framework/storage/data/DocumentEvents;->loadNextInfoFromFile()V

    return-object v0
.end method

.method public static getDocumentsFromResponse(Landroid/content/Context;Lcom/google/gson/l;Ljava/lang/Class;)Lcom/samsung/scsp/framework/storage/data/DocumentEvents;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<U:",
    ...
    invoke-virtual {v3}, Lcom/google/gson/j;->c()Lcom/google/gson/i;
    ...
    :goto_0
    iget-object v6, v3, Lcom/google/gson/i;->a:Ljava/util/ArrayList;
    ...
    invoke-virtual {v3, v5}, Lcom/google/gson/i;->i(I)Lcom/google/gson/j;
    ...
    invoke-virtual {v2, v6, p2}, Lcom/google/gson/g;->c(Lcom/google/gson/j;Ljava/lang/Class;)Ljava/lang/Object;
    ...
    :goto_1
    iget-object v5, v3, Lcom/google/gson/i;->a:Ljava/util/ArrayList;
    ...
    invoke-virtual {v3, v4}, Lcom/google/gson/i;->i(I)Lcom/google/gson/j;

    move-result-object v5

    invoke-virtual {v5}, Lcom/google/gson/j;->d()Lcom/google/gson/l;

    move-result-object v5

    const-class v6, Lcom/samsung/scsp/framework/storage/data/DeletedDocument;

    invoke-virtual {v2, v5, v6}, Lcom/google/gson/g;->c(Lcom/google/gson/j;Ljava/lang/Class;)Ljava/lang/Object;

    move-result-object v5

    check-cast v5, Lcom/samsung/scsp/framework/storage/data/DeletedDocument;
    ...
    :cond_1
    new-instance v2, Lcom/samsung/scsp/framework/storage/data/DocumentEvents;

    invoke-direct {v2, p0, v0, v1, p2}, Lcom/samsung/scsp/framework/storage/data/DocumentEvents;-><init>(Landroid/content/Context;Ljava/util/List;Ljava/util/List;Ljava/lang/Class;)V

    invoke-direct {v2, p1}, Lcom/samsung/scsp/framework/storage/data/DocumentEvents;->loadNextInfoFromResponse(Lcom/google/gson/l;)V
...
.method private loadNextInfoFromFile()V
    ...
    iget-object v2, p0, Lcom/samsung/scsp/framework/storage/data/DocumentEvents;->downloadPath:Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/samsung/scsp/framework/storage/data/DocumentEvents;->hasNext:Ljava/lang/Boolean;
    ...
    iput-wide v3, p0, Lcom/samsung/scsp/framework/storage/data/DocumentEvents;->checkPoint:J
...
.method private loadNextInfoFromResponse(Lcom/google/gson/l;)V
    ...
    iput-wide v0, p0, Lcom/samsung/scsp/framework/storage/data/DocumentEvents;->checkPoint:J
...
.method private toInstanceOfResponseClass(Lcom/google/gson/g;Lcom/google/gson/l;)Ljava/lang/Object;
    ...
    iget-boolean v0, p0, Lcom/samsung/scsp/framework/storage/data/DocumentEvents;->isJsonType:Z
    ...
    iget-object v1, p0, Lcom/samsung/scsp/framework/storage/data/DocumentEvents;->responseClass:Ljava/lang/Class;
...
.method public getCheckPoint()J
    ...
    iget-wide v0, p0, Lcom/samsung/scsp/framework/storage/data/DocumentEvents;->checkPoint:J
...
.method public getDeleted()Ljava/util/List;
    ...
    iget-object v4, p0, Lcom/samsung/scsp/framework/storage/data/DocumentEvents;->downloadPath:Ljava/lang/String;
    ...
    :try_start_3
    const-class v5, Lcom/samsung/scsp/framework/storage/data/DeletedDocument;
...
.method public getDeletedList()Ljava/util/List;
    ...
    iget-object v0, p0, Lcom/samsung/scsp/framework/storage/data/DocumentEvents;->deletedList:Ljava/util/List;
...
.method public getFileSize()J
    ...
    iget-object v0, p0, Lcom/samsung/scsp/framework/storage/data/DocumentEvents;->downloadPath:Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/samsung/scsp/framework/storage/data/DocumentEvents;->downloadPath:Ljava/lang/String;
...
.method public getUpdated()Ljava/util/List;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-virtual {v2, v5}, Lcom/google/gson/l;->k(Ljava/lang/String;)Lcom/google/gson/j;

    move-result-object v2

    invoke-virtual {v2}, Lcom/google/gson/j;->d()Lcom/google/gson/l;

    move-result-object v2

    invoke-direct {p0, v0, v2}, Lcom/samsung/scsp/framework/storage/data/DocumentEvents;->toInstanceOfResponseClass(Lcom/google/gson/g;Lcom/google/gson/l;)Ljava/lang/Object;
...
.method public getUpdatedIdList()Ljava/util/List;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    iget-object v0, p0, Lcom/samsung/scsp/framework/storage/data/DocumentEvents;->updatedList:Ljava/util/List;
...
.method public hasNext()Z
    ...
    iget-object v0, p0, Lcom/samsung/scsp/framework/storage/data/DocumentEvents;->hasNext:Ljava/lang/Boolean;
