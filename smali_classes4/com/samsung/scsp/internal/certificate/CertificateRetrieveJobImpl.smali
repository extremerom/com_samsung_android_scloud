.class Lcom/samsung/scsp/internal/certificate/CertificateRetrieveJobImpl;
...
.method public static synthetic f(Lcom/samsung/scsp/framework/core/api/Response;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lcom/samsung/scsp/internal/certificate/CertificateRetrieveJobImpl;->lambda$onStream$0(Lcom/samsung/scsp/framework/core/api/Response;)Ljava/lang/String;
...
.method public onStream(Lcom/samsung/scsp/framework/core/network/HttpRequest;Ljava/util/Map;Ljava/io/InputStream;)V
    ...
    const-string p3, "CertificateRetrieveJobImpl"

    invoke-static {p3}, Lcom/samsung/scsp/error/Logger;->get(Ljava/lang/String;)Lcom/samsung/scsp/error/Logger;

    move-result-object p3

    new-instance v0, Lcom/samsung/scsp/internal/certificate/a;

    invoke-direct {v0, p2}, Lcom/samsung/scsp/internal/certificate/a;-><init>(Lcom/samsung/scsp/framework/core/api/Response;)V

    invoke-virtual {p3, v0}, Lcom/samsung/scsp/error/Logger;->d(Ljava/util/function/Supplier;)V

    const-class p3, Lcom/samsung/scsp/internal/certificate/CertificateInfo;

    invoke-virtual {p2, p3}, Lcom/samsung/scsp/framework/core/api/Response;->create(Ljava/lang/Class;)Ljava/lang/Object;

    move-result-object p2

    check-cast p2, Lcom/samsung/scsp/internal/certificate/CertificateInfo;
