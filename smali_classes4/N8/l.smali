...
.field public final c:Lcom/samsung/android/scloud/temp/data/smartswitch/CRMInfo;
...
.method public constructor <init>(Ljava/util/List;Ljava/util/List;Lcom/samsung/android/scloud/temp/data/smartswitch/CRMInfo;)V
    ...
    iput-object p1, p0, LN8/l;->a:Ljava/util/List;

    iput-object p2, p0, LN8/l;->b:Ljava/util/List;

    iput-object p3, p0, LN8/l;->c:Lcom/samsung/android/scloud/temp/data/smartswitch/CRMInfo;
...
.method private final createEtc()Ljava/lang/String;
    ...
    iget-object v1, p0, LN8/l;->a:Ljava/util/List;
...
.method public final getCRM()Ljava/lang/String;
    ...
    iget-object v1, p0, LN8/l;->c:Lcom/samsung/android/scloud/temp/data/smartswitch/CRMInfo;
...
.method public final getCategories()Ljava/util/List;
    ...
    iget-object v0, p0, LN8/l;->a:Ljava/util/List;
...
.method public final getCrmInfo()Lcom/samsung/android/scloud/temp/data/smartswitch/CRMInfo;
    ...
    iget-object v0, p0, LN8/l;->c:Lcom/samsung/android/scloud/temp/data/smartswitch/CRMInfo;

    return-object v0
.end method

.method public final getSuwMainCategories()Ljava/util/List;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    iget-object v0, p0, LN8/l;->b:Ljava/util/List;

    return-object v0
.end method

.method public final suwMainToJson()Ljava/lang/String;
    .locals 3
    ...
    new-instance v1, Lcom/samsung/android/scloud/temp/data/smartswitch/SuwStartBnrInfo;

    invoke-virtual {p0}, LN8/l;->toSuwMainBackupCategoryList()Ljava/util/List;

    move-result-object v2

    invoke-direct {v1, v2}, Lcom/samsung/android/scloud/temp/data/smartswitch/SuwStartBnrInfo;-><init>(Ljava/util/List;)V

    invoke-virtual {v0}, Lrb/a;->getSerializersModule()Lkotlinx/serialization/modules/d;

    sget-object v2, Lcom/samsung/android/scloud/temp/data/smartswitch/SuwStartBnrInfo;->Companion:Lcom/samsung/android/scloud/temp/data/smartswitch/SuwStartBnrInfo$b;

    invoke-virtual {v2}, Lcom/samsung/android/scloud/temp/data/smartswitch/SuwStartBnrInfo$b;->serializer()Lmb/c;
...
.method public final toJson()Ljava/lang/String;
    ...
    invoke-direct {p0}, LN8/l;->createEtc()Ljava/lang/String;
    ...
    invoke-virtual {p0}, LN8/l;->toBackupCategoryList()Ljava/util/List;

    move-result-object v3

    invoke-virtual {p0}, LN8/l;->toDeltaCategoryList()Ljava/util/List;
...
.method public abstract toSuwMainBackupCategoryList()Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
            "Ljava/util/List<",
