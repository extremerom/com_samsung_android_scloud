...
.method public static cancel(Ljava/util/concurrent/atomic/AtomicReference;)Z
    ...
    invoke-interface {p0}, Lzd/d;->cancel()V
...
.method public static deferredRequest(Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/atomic/AtomicLong;J)V
    ...
    invoke-interface {v0, p2, p3}, Lzd/d;->request(J)V
    ...
    invoke-static {p1, p2, p3}, LM0/a;->a(Ljava/util/concurrent/atomic/AtomicLong;J)J
    ...
    invoke-interface {p0, v0, v1}, Lzd/d;->request(J)V
...
.method public static deferredSetOnce(Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/atomic/AtomicLong;Lzd/d;)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p0, p2}, Lio/reactivex/internal/subscriptions/SubscriptionHelper;->setOnce(Ljava/util/concurrent/atomic/AtomicReference;Lzd/d;)Z
    ...
    invoke-interface {p2, p0, p1}, Lzd/d;->request(J)V
...
.method public static replace(Ljava/util/concurrent/atomic/AtomicReference;Lzd/d;)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static set(Ljava/util/concurrent/atomic/AtomicReference;Lzd/d;)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static setOnce(Ljava/util/concurrent/atomic/AtomicReference;Lzd/d;)Z
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static setOnce(Ljava/util/concurrent/atomic/AtomicReference;Lzd/d;J)Z
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p1, p2, p3}, Lzd/d;->request(J)V
...
.method public static validate(Lzd/d;Lzd/d;)Z
    .locals 1
    ...
    invoke-static {p0}, Ly9/a;->D(Ljava/lang/Throwable;)V
