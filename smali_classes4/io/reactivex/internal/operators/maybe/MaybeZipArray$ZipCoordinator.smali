...
# direct methods
.method public constructor <init>(LXa/j;ILZa/h;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/maybe/MaybeZipArray$ZipCoordinator;->downstream:LXa/j;

    iput-object p3, p0, Lio/reactivex/internal/operators/maybe/MaybeZipArray$ZipCoordinator;->zipper:LZa/h;
...
.method public innerComplete(I)V
    ...
    iget-object p1, p0, Lio/reactivex/internal/operators/maybe/MaybeZipArray$ZipCoordinator;->downstream:LXa/j;
...
.method public innerError(Ljava/lang/Throwable;I)V
    ...
    iget-object p2, p0, Lio/reactivex/internal/operators/maybe/MaybeZipArray$ZipCoordinator;->downstream:LXa/j;

    invoke-interface {p2, p1}, LXa/j;->onError(Ljava/lang/Throwable;)V
...
.method public innerSuccess(Ljava/lang/Object;I)V
    ...
    :try_start_0
    iget-object p1, p0, Lio/reactivex/internal/operators/maybe/MaybeZipArray$ZipCoordinator;->zipper:LZa/h;

    iget-object p2, p0, Lio/reactivex/internal/operators/maybe/MaybeZipArray$ZipCoordinator;->values:[Ljava/lang/Object;

    invoke-interface {p1, p2}, LZa/h;->apply(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-interface {p2, p1}, LXa/j;->onSuccess(Ljava/lang/Object;)V
