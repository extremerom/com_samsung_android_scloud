...
.method public constructor <init>(Lzd/c;)V
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableMergeWithSingle$MergeWithObserver;->downstream:Lzd/c;
...
.method public cancel()V
    ...
    iput-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableMergeWithSingle$MergeWithObserver;->queue:Lbb/f;
...
.method public drainLoop()V
    ...
    iget-object v1, v0, Lio/reactivex/internal/operators/flowable/FlowableMergeWithSingle$MergeWithObserver;->downstream:Lzd/c;
    ...
    iput-object v13, v0, Lio/reactivex/internal/operators/flowable/FlowableMergeWithSingle$MergeWithObserver;->queue:Lbb/f;
    ...
    invoke-interface {v1, v10}, Lzd/c;->onNext(Ljava/lang/Object;)V
    ...
    iget-object v11, v0, Lio/reactivex/internal/operators/flowable/FlowableMergeWithSingle$MergeWithObserver;->queue:Lbb/f;
    ...
    :cond_6
    invoke-interface {v1, v11}, Lzd/c;->onNext(Ljava/lang/Object;)V
    ...
    invoke-interface {v4, v10, v11}, Lzd/d;->request(J)V
    ...
    iget-object v8, v0, Lio/reactivex/internal/operators/flowable/FlowableMergeWithSingle$MergeWithObserver;->queue:Lbb/f;

    if-eqz v8, :cond_c

    invoke-interface {v8}, Lbb/g;->isEmpty()Z
...
.method public getOrCreateQueue()Lbb/f;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableMergeWithSingle$MergeWithObserver;->queue:Lbb/f;
...
.method public onNext(Ljava/lang/Object;)V
    ...
    iget-object v4, p0, Lio/reactivex/internal/operators/flowable/FlowableMergeWithSingle$MergeWithObserver;->queue:Lbb/f;

    if-eqz v4, :cond_1

    invoke-interface {v4}, Lbb/g;->isEmpty()Z
    ...
    :cond_0
    invoke-interface {v4, p1}, Lbb/g;->offer(Ljava/lang/Object;)Z
    ...
    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/FlowableMergeWithSingle$MergeWithObserver;->downstream:Lzd/c;

    invoke-interface {v2, p1}, Lzd/c;->onNext(Ljava/lang/Object;)V
    ...
    :cond_3
    invoke-virtual {p0}, Lio/reactivex/internal/operators/flowable/FlowableMergeWithSingle$MergeWithObserver;->getOrCreateQueue()Lbb/f;
...
.method public otherSuccess(Ljava/lang/Object;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableMergeWithSingle$MergeWithObserver;->downstream:Lzd/c;
