...
# direct methods
.method public constructor <init>(Lzd/c;LZa/c;Ljava/lang/Object;I)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableScanSeed$ScanSeedSubscriber;->downstream:Lzd/c;

    iput-object p2, p0, Lio/reactivex/internal/operators/flowable/FlowableScanSeed$ScanSeedSubscriber;->accumulator:LZa/c;
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableScanSeed$ScanSeedSubscriber;->queue:Lbb/f;

    invoke-interface {p1, p3}, Lbb/g;->offer(Ljava/lang/Object;)Z
...
.method public cancel()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableScanSeed$ScanSeedSubscriber;->upstream:Lzd/d;
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableScanSeed$ScanSeedSubscriber;->queue:Lbb/f;
...
.method public drain()V
    ...
    :cond_0
    iget-object v1, v0, Lio/reactivex/internal/operators/flowable/FlowableScanSeed$ScanSeedSubscriber;->downstream:Lzd/c;

    iget-object v2, v0, Lio/reactivex/internal/operators/flowable/FlowableScanSeed$ScanSeedSubscriber;->queue:Lbb/f;
    ...
    invoke-interface {v1, v15}, Lzd/c;->onError(Ljava/lang/Throwable;)V
    ...
    iget-object v4, v0, Lio/reactivex/internal/operators/flowable/FlowableScanSeed$ScanSeedSubscriber;->upstream:Lzd/d;

    int-to-long v13, v3

    invoke-interface {v4, v13, v14}, Lzd/d;->request(J)V
    ...
    invoke-interface {v1, v7}, Lzd/c;->onError(Ljava/lang/Throwable;)V

    return-void

    :cond_9
    invoke-interface {v2}, Lbb/g;->isEmpty()Z
    ...
    invoke-static {v7, v11, v12}, LM0/a;->w(Ljava/util/concurrent/atomic/AtomicLong;J)V
...
.method public onNext(Ljava/lang/Object;)V
    ...
    :try_start_0
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableScanSeed$ScanSeedSubscriber;->accumulator:LZa/c;
...
.method public onSubscribe(Lzd/d;)V
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableScanSeed$ScanSeedSubscriber;->upstream:Lzd/d;

    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableScanSeed$ScanSeedSubscriber;->downstream:Lzd/c;
