...
# direct methods
.method public constructor <init>(Lbb/a;LXa/u;ZI)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, p2, p3, p4}, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;-><init>(LXa/u;ZI)V

    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnConditionalSubscriber;->downstream:Lbb/a;
...
.method public onSubscribe(Lzd/d;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->upstream:Lzd/d;
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->upstream:Lzd/d;
    ...
    iput-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->queue:Lbb/g;

    iput-boolean v2, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->done:Z

    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnConditionalSubscriber;->downstream:Lbb/a;
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnConditionalSubscriber;->downstream:Lbb/a;
...
.method public poll()Ljava/lang/Object;
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->queue:Lbb/g;
    ...
    iget-object v3, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->upstream:Lzd/d;

    invoke-interface {v3, v1, v2}, Lzd/d;->request(J)V
...
.method public runAsync()V
    ...
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->queue:Lbb/g;
    ...
    :goto_2
    invoke-virtual {p0, v11, v13, v0}, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->checkTerminated(ZZLzd/c;)Z
    ...
    :cond_4
    invoke-interface {v0, v12}, Lbb/a;->tryOnNext(Ljava/lang/Object;)Z
    ...
    iget-object v10, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->upstream:Lzd/d;

    invoke-interface {v10, v4, v5}, Lzd/d;->request(J)V
    ...
    invoke-static {v2}, Lsamsung/scsp/gallery/admin/v1/a;->F(Ljava/lang/Throwable;)V
    ...
    invoke-interface {v0, v2}, Lzd/c;->onError(Ljava/lang/Throwable;)V

    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->worker:LXa/u;
    ...
    invoke-interface {v1}, Lbb/g;->isEmpty()Z

    move-result v9

    invoke-virtual {p0, v8, v9, v0}, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->checkTerminated(ZZLzd/c;)Z
...
.method public runBackfused()V
    ...
    iget-object v3, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnConditionalSubscriber;->downstream:Lbb/a;

    const/4 v4, 0x0

    invoke-interface {v3, v4}, Lzd/c;->onNext(Ljava/lang/Object;)V
    ...
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnConditionalSubscriber;->downstream:Lbb/a;

    invoke-interface {v1, v0}, Lzd/c;->onError(Ljava/lang/Throwable;)V
...
.method public runSync()V
    ...
    :cond_3
    invoke-interface {v0, v8}, Lbb/a;->tryOnNext(Ljava/lang/Object;)Z
    ...
    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->upstream:Lzd/d;

    invoke-interface {v2}, Lzd/d;->cancel()V
