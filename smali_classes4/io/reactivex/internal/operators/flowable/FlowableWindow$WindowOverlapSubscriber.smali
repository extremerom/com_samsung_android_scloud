...
# direct methods
.method public constructor <init>(Lzd/c;JJI)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableWindow$WindowOverlapSubscriber;->downstream:Lzd/c;
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableWindow$WindowOverlapSubscriber;->queue:Lio/reactivex/internal/queue/b;
...
.method public checkTerminated(ZZLzd/c;Lio/reactivex/internal/queue/b;)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(ZZ",
...
.method public drain()V
    ...
    :cond_0
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableWindow$WindowOverlapSubscriber;->downstream:Lzd/c;

    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableWindow$WindowOverlapSubscriber;->queue:Lio/reactivex/internal/queue/b;
    ...
    :goto_1
    invoke-virtual {p0, v11, v13, v0, v1}, Lio/reactivex/internal/operators/flowable/FlowableWindow$WindowOverlapSubscriber;->checkTerminated(ZZLzd/c;Lio/reactivex/internal/queue/b;)Z
    ...
    :cond_4
    invoke-interface {v0, v12}, Lzd/c;->onNext(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, v10, v11, v0, v1}, Lio/reactivex/internal/operators/flowable/FlowableWindow$WindowOverlapSubscriber;->checkTerminated(ZZLzd/c;Lio/reactivex/internal/queue/b;)Z
...
.method public onError(Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v1, p1}, Lio/reactivex/processors/g;->onError(Ljava/lang/Throwable;)V
...
.method public onNext(Ljava/lang/Object;)V
    ...
    invoke-direct {v5, v4, p0}, Lio/reactivex/processors/g;-><init>(ILjava/lang/Runnable;)V
    ...
    iget-object v4, p0, Lio/reactivex/internal/operators/flowable/FlowableWindow$WindowOverlapSubscriber;->queue:Lio/reactivex/internal/queue/b;

    invoke-virtual {v4, v5}, Lio/reactivex/internal/queue/b;->offer(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v7, p1}, Lio/reactivex/processors/g;->onNext(Ljava/lang/Object;)V
    ...
    check-cast p1, Lio/reactivex/processors/g;

    invoke-virtual {p1}, Lio/reactivex/processors/g;->onComplete()V
...
.method public onSubscribe(Lzd/d;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableWindow$WindowOverlapSubscriber;->upstream:Lzd/d;
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableWindow$WindowOverlapSubscriber;->upstream:Lzd/d;

    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableWindow$WindowOverlapSubscriber;->downstream:Lzd/c;
...
.method public request(J)V
    ...
    invoke-static {v0, v1, p1, p2}, LM0/a;->v(JJ)J
