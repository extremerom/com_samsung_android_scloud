...
# direct methods
.method public constructor <init>(Lzd/c;LZa/h;IIZ)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableCombineLatest$CombineLatestCoordinator;->downstream:Lzd/c;

    iput-object p2, p0, Lio/reactivex/internal/operators/flowable/FlowableCombineLatest$CombineLatestCoordinator;->combiner:LZa/h;
...
.method public checkTerminated(ZZLzd/c;Lio/reactivex/internal/queue/b;)Z
    ...
    sget-object p2, Lio/reactivex/internal/util/c;->a:Ljava/lang/Throwable;
...
.method public drainAsync()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableCombineLatest$CombineLatestCoordinator;->downstream:Lzd/c;
    ...
    :goto_1
    invoke-virtual {p0, v11, v13, v0, v1}, Lio/reactivex/internal/operators/flowable/FlowableCombineLatest$CombineLatestCoordinator;->checkTerminated(ZZLzd/c;Lio/reactivex/internal/queue/b;)Z
    ...
    :try_start_0
    iget-object v11, p0, Lio/reactivex/internal/operators/flowable/FlowableCombineLatest$CombineLatestCoordinator;->combiner:LZa/h;

    invoke-interface {v11, v10}, LZa/h;->apply(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v10

    const-string v11, "The combiner returned a null value"

    invoke-static {v10, v11}, Lio/reactivex/internal/functions/b;->b(Ljava/lang/Object;Ljava/lang/String;)V
    :try_end_0
    ...
    invoke-virtual {p0, v10, v11, v0, v1}, Lio/reactivex/internal/operators/flowable/FlowableCombineLatest$CombineLatestCoordinator;->checkTerminated(ZZLzd/c;Lio/reactivex/internal/queue/b;)Z
...
.method public drainOutput()V
    ...
    invoke-interface {v0, v3}, Lzd/c;->onError(Ljava/lang/Throwable;)V
    ...
    invoke-interface {v0, v5}, Lzd/c;->onNext(Ljava/lang/Object;)V
...
.method public poll()Ljava/lang/Object;
    ...
    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/FlowableCombineLatest$CombineLatestCoordinator;->combiner:LZa/h;

    invoke-interface {v2, v1}, LZa/h;->apply(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public subscribe([Lzd/b;I)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "([",
    ...
    invoke-interface {v2, v3}, Lzd/b;->subscribe(Lzd/c;)V
