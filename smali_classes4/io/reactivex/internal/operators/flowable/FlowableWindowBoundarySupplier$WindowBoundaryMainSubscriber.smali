...
# static fields
.field static final BOUNDARY_DISPOSED:Lio/reactivex/internal/operators/flowable/z;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lio/reactivex/internal/operators/flowable/z;"
        }
    .end annotation
.end field
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lio/reactivex/internal/operators/flowable/z;-><init>(Lio/reactivex/internal/operators/flowable/FlowableWindowBoundarySupplier$WindowBoundaryMainSubscriber;)V

    sput-object v0, Lio/reactivex/internal/operators/flowable/FlowableWindowBoundarySupplier$WindowBoundaryMainSubscriber;->BOUNDARY_DISPOSED:Lio/reactivex/internal/operators/flowable/z;
...
.method public constructor <init>(Lzd/c;ILjava/util/concurrent/Callable;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableWindowBoundarySupplier$WindowBoundaryMainSubscriber;->downstream:Lzd/c;
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableWindowBoundarySupplier$WindowBoundaryMainSubscriber;->queue:Lio/reactivex/internal/queue/a;
...
.method public cancel()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableWindowBoundarySupplier$WindowBoundaryMainSubscriber;->upstream:Lzd/d;
...
.method public disposeBoundary()V
    ...
    sget-object v1, Lio/reactivex/internal/operators/flowable/FlowableWindowBoundarySupplier$WindowBoundaryMainSubscriber;->BOUNDARY_DISPOSED:Lio/reactivex/internal/operators/flowable/z;
...
.method public drain()V
    ...
    :cond_0
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableWindowBoundarySupplier$WindowBoundaryMainSubscriber;->downstream:Lzd/c;

    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableWindowBoundarySupplier$WindowBoundaryMainSubscriber;->queue:Lio/reactivex/internal/queue/a;
    ...
    iput-object v8, p0, Lio/reactivex/internal/operators/flowable/FlowableWindowBoundarySupplier$WindowBoundaryMainSubscriber;->window:Lio/reactivex/processors/g;

    return-void

    :cond_2
    iget-object v7, p0, Lio/reactivex/internal/operators/flowable/FlowableWindowBoundarySupplier$WindowBoundaryMainSubscriber;->window:Lio/reactivex/processors/g;
    ...
    invoke-virtual {v7, v1}, Lio/reactivex/processors/g;->onError(Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v7}, Lio/reactivex/processors/g;->onComplete()V
    ...
    invoke-virtual {v7, v10}, Lio/reactivex/processors/g;->onNext(Ljava/lang/Object;)V
    ...
    new-instance v9, Lio/reactivex/processors/g;

    invoke-direct {v9, v7, p0}, Lio/reactivex/processors/g;-><init>(ILjava/lang/Runnable;)V

    iput-object v9, p0, Lio/reactivex/internal/operators/flowable/FlowableWindowBoundarySupplier$WindowBoundaryMainSubscriber;->window:Lio/reactivex/processors/g;
    ...
    invoke-static {v7, v10}, Lio/reactivex/internal/functions/b;->b(Ljava/lang/Object;Ljava/lang/String;)V

    check-cast v7, Lzd/b;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    new-instance v10, Lio/reactivex/internal/operators/flowable/z;

    invoke-direct {v10, p0}, Lio/reactivex/internal/operators/flowable/z;-><init>(Lio/reactivex/internal/operators/flowable/FlowableWindowBoundarySupplier$WindowBoundaryMainSubscriber;)V
    ...
    invoke-interface {v7, v10}, Lzd/b;->subscribe(Lzd/c;)V

    const-wide/16 v7, 0x1

    add-long/2addr v3, v7

    invoke-interface {v0, v9}, Lzd/c;->onNext(Ljava/lang/Object;)V
    ...
    invoke-static {v7}, Lsamsung/scsp/gallery/admin/v1/a;->F(Ljava/lang/Throwable;)V
    ...
    :cond_f
    iget-object v7, p0, Lio/reactivex/internal/operators/flowable/FlowableWindowBoundarySupplier$WindowBoundaryMainSubscriber;->upstream:Lzd/d;

    invoke-interface {v7}, Lzd/d;->cancel()V
...
.method public innerNext(Lio/reactivex/internal/operators/flowable/z;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :goto_0
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableWindowBoundarySupplier$WindowBoundaryMainSubscriber;->queue:Lio/reactivex/internal/queue/a;
...
.method public onNext(Ljava/lang/Object;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableWindowBoundarySupplier$WindowBoundaryMainSubscriber;->queue:Lio/reactivex/internal/queue/a;
...
.method public onSubscribe(Lzd/d;)V
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableWindowBoundarySupplier$WindowBoundaryMainSubscriber;->upstream:Lzd/d;
