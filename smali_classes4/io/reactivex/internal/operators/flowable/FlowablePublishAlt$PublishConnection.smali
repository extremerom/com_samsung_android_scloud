...
.method public checkTerminated(ZZ)Z
    ...
    iget-object v1, v1, Lio/reactivex/internal/operators/flowable/FlowablePublishAlt$InnerSubscription;->downstream:Lzd/c;
...
.method public drain()V
    ...
    :cond_0
    iget-object v0, v1, Lio/reactivex/internal/operators/flowable/FlowablePublishAlt$PublishConnection;->queue:Lbb/g;
    ...
    invoke-virtual {v6}, Lio/reactivex/internal/operators/flowable/FlowablePublishAlt$InnerSubscription;->isCancelled()Z

    move-result v19

    if-nez v19, :cond_9

    iget-object v14, v6, Lio/reactivex/internal/operators/flowable/FlowablePublishAlt$InnerSubscription;->downstream:Lzd/c;

    invoke-interface {v14, v12}, Lzd/c;->onNext(Ljava/lang/Object;)V

    iget-wide v14, v6, Lio/reactivex/internal/operators/flowable/FlowablePublishAlt$InnerSubscription;->emitted:J

    add-long v14, v14, v16

    iput-wide v14, v6, Lio/reactivex/internal/operators/flowable/FlowablePublishAlt$InnerSubscription;->emitted:J
    ...
    invoke-interface {v0, v12, v13}, Lzd/d;->request(J)V
    ...
    iget-object v6, v1, Lio/reactivex/internal/operators/flowable/FlowablePublishAlt$PublishConnection;->subscribers:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    iget-object v2, v1, Lio/reactivex/internal/operators/flowable/FlowablePublishAlt$PublishConnection;->queue:Lbb/g;
...
.method public onNext(Ljava/lang/Object;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowablePublishAlt$PublishConnection;->queue:Lbb/g;
...
.method public onSubscribe(Lzd/d;)V
    ...
    invoke-static {v0, p1}, Lio/reactivex/internal/subscriptions/SubscriptionHelper;->setOnce(Ljava/util/concurrent/atomic/AtomicReference;Lzd/d;)Z
    ...
    iput-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowablePublishAlt$PublishConnection;->queue:Lbb/g;
...
.method public signalError(Ljava/lang/Throwable;)V
    ...
    iget-object v3, v3, Lio/reactivex/internal/operators/flowable/FlowablePublishAlt$InnerSubscription;->downstream:Lzd/c;

    invoke-interface {v3, p1}, Lzd/c;->onError(Ljava/lang/Throwable;)V
