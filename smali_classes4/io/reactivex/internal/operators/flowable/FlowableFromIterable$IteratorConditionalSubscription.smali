...
# direct methods
.method public constructor <init>(Lbb/a;Ljava/util/Iterator;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableFromIterable$IteratorConditionalSubscription;->downstream:Lbb/a;
...
.method public fastPath()V
    ...
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableFromIterable$IteratorConditionalSubscription;->downstream:Lbb/a;
    ...
    :cond_3
    invoke-interface {v1, v2}, Lbb/a;->tryOnNext(Ljava/lang/Object;)Z
...
.method public slowPath(J)V
    ...
    invoke-interface {v1, p1}, Lzd/c;->onError(Ljava/lang/Throwable;)V

    return-void

    :cond_4
    invoke-interface {v1, v6}, Lbb/a;->tryOnNext(Ljava/lang/Object;)Z
