...
# direct methods
.method public constructor <init>(LXa/b;JLjava/util/concurrent/TimeUnit;LXa/v;Z)V
    .locals 0

    invoke-direct {p0}, Ljava/util/concurrent/atomic/AtomicReference;-><init>()V

    iput-object p1, p0, Lio/reactivex/internal/operators/completable/CompletableDelay$Delay;->downstream:LXa/b;
    ...
    iput-object p5, p0, Lio/reactivex/internal/operators/completable/CompletableDelay$Delay;->scheduler:LXa/v;
...
.method public onComplete()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/completable/CompletableDelay$Delay;->scheduler:LXa/v;
    ...
    invoke-virtual {v0, p0, v1, v2, v3}, LXa/v;->d(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lio/reactivex/disposables/b;
...
.method public onError(Ljava/lang/Throwable;)V
    ...
    iget-object p1, p0, Lio/reactivex/internal/operators/completable/CompletableDelay$Delay;->scheduler:LXa/v;
    ...
    invoke-virtual {p1, p0, v0, v1, v2}, LXa/v;->d(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lio/reactivex/disposables/b;
...
.method public onSubscribe(Lio/reactivex/disposables/b;)V
    ...
    iget-object p1, p0, Lio/reactivex/internal/operators/completable/CompletableDelay$Delay;->downstream:LXa/b;
...
.method public run()V
    ...
    iget-object v1, p0, Lio/reactivex/internal/operators/completable/CompletableDelay$Delay;->downstream:LXa/b;
    ...
    :cond_0
    iget-object v0, p0, Lio/reactivex/internal/operators/completable/CompletableDelay$Delay;->downstream:LXa/b;
