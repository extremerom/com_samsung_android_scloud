...
.method public constructor <init>(LXa/q;LZa/h;ZII)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->downstream:LXa/q;

    iput-object p2, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->mapper:LZa/h;
...
.method public checkTerminate()Z
    ...
    iget-object v2, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->downstream:LXa/q;

    invoke-interface {v2, v0}, LXa/q;->onError(Ljava/lang/Throwable;)V
...
.method public drainLoop()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->downstream:LXa/q;
    ...
    :cond_1
    iget-object v2, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->queue:Lbb/f;
    ...
    :cond_2
    invoke-interface {v2}, Lbb/g;->poll()Ljava/lang/Object;
    ...
    :cond_3
    invoke-interface {v0, v5}, LXa/q;->onNext(Ljava/lang/Object;)V
    ...
    iget-object v6, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->queue:Lbb/f;
    ...
    invoke-interface {v6}, Lbb/g;->isEmpty()Z
    ...
    iget-object v10, v6, Lio/reactivex/internal/operators/observable/ObservableFlatMap$InnerObserver;->queue:Lbb/g;

    if-eqz v10, :cond_15

    :cond_12
    :try_start_1
    invoke-interface {v10}, Lbb/g;->poll()Ljava/lang/Object;
    ...
    iget-object v11, v6, Lio/reactivex/internal/operators/observable/ObservableFlatMap$InnerObserver;->queue:Lbb/g;
...
.method public onNext(Ljava/lang/Object;)V
    ...
    :cond_0
    :try_start_0
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->mapper:LZa/h;
    ...
    :cond_2
    :goto_1
    invoke-virtual {p0, p1}, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->subscribeInner(LXa/p;)V
...
.method public onSubscribe(Lio/reactivex/disposables/b;)V
    ...
    iget-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->downstream:LXa/q;
...
.method public subscribeInner(LXa/p;)V
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p1, v0}, LXa/p;->subscribe(LXa/q;)V
...
.method public tryEmit(Ljava/lang/Object;Lio/reactivex/internal/operators/observable/ObservableFlatMap$InnerObserver;)V
    ...
    iget-object p2, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->downstream:LXa/q;

    invoke-interface {p2, p1}, LXa/q;->onNext(Ljava/lang/Object;)V
    ...
    :cond_0
    iget-object v0, p2, Lio/reactivex/internal/operators/observable/ObservableFlatMap$InnerObserver;->queue:Lbb/g;
    ...
    iput-object v0, p2, Lio/reactivex/internal/operators/observable/ObservableFlatMap$InnerObserver;->queue:Lbb/g;
...
.method public tryEmitScalar(Ljava/util/concurrent/Callable;)Z
    ...
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->downstream:LXa/q;
    ...
    :cond_1
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->queue:Lbb/f;
    ...
    :goto_0
    iput-object v1, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->queue:Lbb/f;

    :cond_3
    invoke-interface {v1, p1}, Lbb/g;->offer(Ljava/lang/Object;)Z
