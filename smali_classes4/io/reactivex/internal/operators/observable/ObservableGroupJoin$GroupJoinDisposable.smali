...
.method public constructor <init>(LXa/q;LZa/h;LZa/h;LZa/c;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableGroupJoin$GroupJoinDisposable;->downstream:LXa/q;
    ...
    iput-object p2, p0, Lio/reactivex/internal/operators/observable/ObservableGroupJoin$GroupJoinDisposable;->leftEnd:LZa/h;

    iput-object p3, p0, Lio/reactivex/internal/operators/observable/ObservableGroupJoin$GroupJoinDisposable;->rightEnd:LZa/h;

    iput-object p4, p0, Lio/reactivex/internal/operators/observable/ObservableGroupJoin$GroupJoinDisposable;->resultSelector:LZa/c;
...
.method public drain()V
    ...
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/ObservableGroupJoin$GroupJoinDisposable;->downstream:LXa/q;
    ...
    invoke-virtual {p0, v1}, Lio/reactivex/internal/operators/observable/ObservableGroupJoin$GroupJoinDisposable;->errorAll(LXa/q;)V
    ...
    check-cast v2, Lio/reactivex/subjects/k;

    invoke-virtual {v2}, Lio/reactivex/subjects/k;->onComplete()V
    ...
    invoke-interface {v1}, LXa/q;->onComplete()V
    ...
    new-instance v5, Lio/reactivex/subjects/k;

    sget v6, LXa/e;->a:I

    invoke-direct {v5, v6}, Lio/reactivex/subjects/k;-><init>(I)V
    ...
    :try_start_0
    iget-object v7, p0, Lio/reactivex/internal/operators/observable/ObservableGroupJoin$GroupJoinDisposable;->leftEnd:LZa/h;

    invoke-interface {v7, v4}, LZa/h;->apply(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {v8, p0, v2, v6}, Lio/reactivex/internal/operators/observable/ObservableGroupJoin$LeftRightEndObserver;-><init>(Lio/reactivex/internal/operators/observable/m;ZI)V
    ...
    invoke-interface {v7, v8}, LXa/p;->subscribe(LXa/q;)V
    ...
    :cond_9
    :try_start_1
    iget-object v6, p0, Lio/reactivex/internal/operators/observable/ObservableGroupJoin$GroupJoinDisposable;->resultSelector:LZa/c;

    invoke-interface {v6, v4, v5}, LZa/c;->apply(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-interface {v1, v4}, LXa/q;->onNext(Ljava/lang/Object;)V
    ...
    invoke-virtual {v5, v6}, Lio/reactivex/subjects/k;->onNext(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, v2, v1, v0}, Lio/reactivex/internal/operators/observable/ObservableGroupJoin$GroupJoinDisposable;->fail(Ljava/lang/Throwable;LXa/q;Lio/reactivex/internal/queue/b;)V
    ...
    :try_start_2
    iget-object v7, p0, Lio/reactivex/internal/operators/observable/ObservableGroupJoin$GroupJoinDisposable;->rightEnd:LZa/h;
    ...
    invoke-direct {v8, p0, v5, v6}, Lio/reactivex/internal/operators/observable/ObservableGroupJoin$LeftRightEndObserver;-><init>(Lio/reactivex/internal/operators/observable/m;ZI)V
    ...
    check-cast v6, Lio/reactivex/subjects/k;

    invoke-virtual {v6, v4}, Lio/reactivex/subjects/k;->onNext(Ljava/lang/Object;)V
    ...
    check-cast v5, Lio/reactivex/subjects/k;
    ...
    invoke-virtual {v5}, Lio/reactivex/subjects/k;->onComplete()V
...
.method public errorAll(LXa/q;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v2, v0}, Lio/reactivex/subjects/k;->onError(Ljava/lang/Throwable;)V
...
.method public fail(Ljava/lang/Throwable;LXa/q;Lio/reactivex/internal/queue/b;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, p2}, Lio/reactivex/internal/operators/observable/ObservableGroupJoin$GroupJoinDisposable;->errorAll(LXa/q;)V
