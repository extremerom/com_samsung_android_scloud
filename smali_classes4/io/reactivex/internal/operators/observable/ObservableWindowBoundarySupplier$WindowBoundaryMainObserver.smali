...
# static fields
.field static final BOUNDARY_DISPOSED:Lio/reactivex/internal/operators/observable/H;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lio/reactivex/internal/operators/observable/H;-><init>(Lio/reactivex/internal/operators/observable/ObservableWindowBoundarySupplier$WindowBoundaryMainObserver;)V

    sput-object v0, Lio/reactivex/internal/operators/observable/ObservableWindowBoundarySupplier$WindowBoundaryMainObserver;->BOUNDARY_DISPOSED:Lio/reactivex/internal/operators/observable/H;
...
.method public constructor <init>(LXa/q;ILjava/util/concurrent/Callable;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableWindowBoundarySupplier$WindowBoundaryMainObserver;->downstream:LXa/q;
...
.method public disposeBoundary()V
    ...
    sget-object v1, Lio/reactivex/internal/operators/observable/ObservableWindowBoundarySupplier$WindowBoundaryMainObserver;->BOUNDARY_DISPOSED:Lio/reactivex/internal/operators/observable/H;
...
.method public drain()V
    ...
    :cond_0
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableWindowBoundarySupplier$WindowBoundaryMainObserver;->downstream:LXa/q;
    ...
    iput-object v6, p0, Lio/reactivex/internal/operators/observable/ObservableWindowBoundarySupplier$WindowBoundaryMainObserver;->window:Lio/reactivex/subjects/k;

    return-void

    :cond_2
    iget-object v5, p0, Lio/reactivex/internal/operators/observable/ObservableWindowBoundarySupplier$WindowBoundaryMainObserver;->window:Lio/reactivex/subjects/k;
    ...
    invoke-virtual {v5, v1}, Lio/reactivex/subjects/k;->onError(Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v5, v8}, Lio/reactivex/subjects/k;->onNext(Ljava/lang/Object;)V
    ...
    new-instance v7, Lio/reactivex/subjects/k;

    invoke-direct {v7, v5, p0}, Lio/reactivex/subjects/k;-><init>(ILjava/lang/Runnable;)V

    iput-object v7, p0, Lio/reactivex/internal/operators/observable/ObservableWindowBoundarySupplier$WindowBoundaryMainObserver;->window:Lio/reactivex/subjects/k;
    ...
    new-instance v8, Lio/reactivex/internal/operators/observable/H;

    invoke-direct {v8, p0}, Lio/reactivex/internal/operators/observable/H;-><init>(Lio/reactivex/internal/operators/observable/ObservableWindowBoundarySupplier$WindowBoundaryMainObserver;)V
    ...
    invoke-interface {v5, v8}, LXa/p;->subscribe(LXa/q;)V
    ...
    invoke-static {v5}, Lsamsung/scsp/gallery/admin/v1/a;->F(Ljava/lang/Throwable;)V
...
.method public innerNext(Lio/reactivex/internal/operators/observable/H;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public onSubscribe(Lio/reactivex/disposables/b;)V
    ...
    iget-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableWindowBoundarySupplier$WindowBoundaryMainObserver;->downstream:LXa/q;
