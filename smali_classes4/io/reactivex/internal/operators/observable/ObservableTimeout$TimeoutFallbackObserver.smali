...
.implements Lio/reactivex/internal/operators/observable/B;
...
.field final itemTimeoutIndicator:LZa/h;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "LZa/h;"
        }
...
# direct methods
.method public constructor <init>(LXa/q;LZa/h;LXa/p;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableTimeout$TimeoutFallbackObserver;->downstream:LXa/q;

    iput-object p2, p0, Lio/reactivex/internal/operators/observable/ObservableTimeout$TimeoutFallbackObserver;->itemTimeoutIndicator:LZa/h;
    ...
    iput-object p3, p0, Lio/reactivex/internal/operators/observable/ObservableTimeout$TimeoutFallbackObserver;->fallback:LXa/p;
...
.method public onComplete()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableTimeout$TimeoutFallbackObserver;->downstream:LXa/q;
...
.method public onNext(Ljava/lang/Object;)V
    ...
    :try_start_0
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableTimeout$TimeoutFallbackObserver;->itemTimeoutIndicator:LZa/h;
    ...
    invoke-direct {v0, v5, v6, p0}, Lio/reactivex/internal/operators/observable/ObservableTimeout$TimeoutConsumer;-><init>(JLio/reactivex/internal/operators/observable/B;)V
...
.method public onTimeout(J)V
    ...
    iget-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableTimeout$TimeoutFallbackObserver;->fallback:LXa/p;

    const/4 p2, 0x0

    iput-object p2, p0, Lio/reactivex/internal/operators/observable/ObservableTimeout$TimeoutFallbackObserver;->fallback:LXa/p;

    new-instance p2, Lio/reactivex/internal/operators/observable/C;

    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableTimeout$TimeoutFallbackObserver;->downstream:LXa/q;

    invoke-direct {p2, v0, p0}, Lio/reactivex/internal/operators/observable/C;-><init>(LXa/q;Ljava/util/concurrent/atomic/AtomicReference;)V

    invoke-interface {p1, p2}, LXa/p;->subscribe(LXa/q;)V
...
.method public onTimeoutError(JLjava/lang/Throwable;)V
    ...
    iget-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableTimeout$TimeoutFallbackObserver;->downstream:LXa/q;

    invoke-interface {p1, p3}, LXa/q;->onError(Ljava/lang/Throwable;)V

    goto :goto_0

    :cond_0
    invoke-static {p3}, Ly9/a;->D(Ljava/lang/Throwable;)V

    :goto_0
    return-void
.end method

.method public startFirstTimeout(LXa/p;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, v1, v2, p0}, Lio/reactivex/internal/operators/observable/ObservableTimeout$TimeoutConsumer;-><init>(JLio/reactivex/internal/operators/observable/B;)V
