...
.method public constructor <init>(LXa/q;LZa/h;LZa/h;LZa/c;)V
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableJoin$JoinDisposable;->downstream:LXa/q;
    ...
    iput-object p2, p0, Lio/reactivex/internal/operators/observable/ObservableJoin$JoinDisposable;->leftEnd:LZa/h;

    iput-object p3, p0, Lio/reactivex/internal/operators/observable/ObservableJoin$JoinDisposable;->rightEnd:LZa/h;

    iput-object p4, p0, Lio/reactivex/internal/operators/observable/ObservableJoin$JoinDisposable;->resultSelector:LZa/c;
...
.method public drain()V
    ...
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/ObservableJoin$JoinDisposable;->downstream:LXa/q;
    ...
    invoke-virtual {p0, v1}, Lio/reactivex/internal/operators/observable/ObservableJoin$JoinDisposable;->errorAll(LXa/q;)V
    ...
    :try_start_0
    iget-object v6, p0, Lio/reactivex/internal/operators/observable/ObservableJoin$JoinDisposable;->leftEnd:LZa/h;

    invoke-interface {v6, v4}, LZa/h;->apply(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {v7, p0, v2, v5}, Lio/reactivex/internal/operators/observable/ObservableGroupJoin$LeftRightEndObserver;-><init>(Lio/reactivex/internal/operators/observable/m;ZI)V
    ...
    invoke-interface {v6, v7}, LXa/p;->subscribe(LXa/q;)V
    ...
    :try_start_1
    iget-object v7, p0, Lio/reactivex/internal/operators/observable/ObservableJoin$JoinDisposable;->resultSelector:LZa/c;

    invoke-interface {v7, v4, v6}, LZa/c;->apply(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-interface {v1, v6}, LXa/q;->onNext(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, v2, v1, v0}, Lio/reactivex/internal/operators/observable/ObservableJoin$JoinDisposable;->fail(Ljava/lang/Throwable;LXa/q;Lio/reactivex/internal/queue/b;)V
    ...
    :try_start_2
    iget-object v7, p0, Lio/reactivex/internal/operators/observable/ObservableJoin$JoinDisposable;->rightEnd:LZa/h;
    ...
    invoke-direct {v9, p0, v5, v6}, Lio/reactivex/internal/operators/observable/ObservableGroupJoin$LeftRightEndObserver;-><init>(Lio/reactivex/internal/operators/observable/m;ZI)V

    iget-object v5, p0, Lio/reactivex/internal/operators/observable/ObservableJoin$JoinDisposable;->disposables:Lio/reactivex/disposables/a;

    invoke-virtual {v5, v9}, Lio/reactivex/disposables/a;->b(Lio/reactivex/disposables/b;)Z

    invoke-interface {v7, v9}, LXa/p;->subscribe(LXa/q;)V
    ...
    invoke-interface {v7, v6, v4}, LZa/c;->apply(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public fail(Ljava/lang/Throwable;LXa/q;Lio/reactivex/internal/queue/b;)V
    ...
    invoke-virtual {p0, p2}, Lio/reactivex/internal/operators/observable/ObservableJoin$JoinDisposable;->errorAll(LXa/q;)V
