...
.implements Lio/reactivex/internal/observers/b;
...
# direct methods
.method public constructor <init>(LXa/q;LZa/h;IILio/reactivex/internal/util/ErrorMode;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableConcatMapEager$ConcatMapEagerMainObserver;->downstream:LXa/q;

    iput-object p2, p0, Lio/reactivex/internal/operators/observable/ObservableConcatMapEager$ConcatMapEagerMainObserver;->mapper:LZa/h;
...
.method public drain()V
    ...
    :cond_0
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableConcatMapEager$ConcatMapEagerMainObserver;->queue:Lbb/g;
    ...
    iget-object v2, p0, Lio/reactivex/internal/operators/observable/ObservableConcatMapEager$ConcatMapEagerMainObserver;->downstream:LXa/q;
    ...
    :cond_4
    iget-object v8, p0, Lio/reactivex/internal/operators/observable/ObservableConcatMapEager$ConcatMapEagerMainObserver;->mapper:LZa/h;

    invoke-interface {v8, v7}, LZa/h;->apply(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {v8, p0, v9}, Lio/reactivex/internal/observers/InnerQueuedObserver;-><init>(Lio/reactivex/internal/observers/b;I)V
    ...
    :cond_a
    invoke-interface {v2}, LXa/q;->onComplete()V
    ...
    invoke-virtual {v6}, Lio/reactivex/internal/observers/InnerQueuedObserver;->queue()Lbb/g;
    ...
    :try_start_1
    invoke-interface {v8}, Lbb/g;->poll()Ljava/lang/Object;
    ...
    :cond_12
    invoke-interface {v2, v11}, LXa/q;->onNext(Ljava/lang/Object;)V
    ...
    invoke-static {v6}, Lsamsung/scsp/gallery/admin/v1/a;->F(Ljava/lang/Throwable;)V
...
.method public innerNext(Lio/reactivex/internal/observers/InnerQueuedObserver;Ljava/lang/Object;)V
    ...
    invoke-virtual {p1}, Lio/reactivex/internal/observers/InnerQueuedObserver;->queue()Lbb/g;

    move-result-object p1

    invoke-interface {p1, p2}, Lbb/g;->offer(Ljava/lang/Object;)Z
...
.method public onSubscribe(Lio/reactivex/disposables/b;)V
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableConcatMapEager$ConcatMapEagerMainObserver;->queue:Lbb/g;
    ...
    iget-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableConcatMapEager$ConcatMapEagerMainObserver;->downstream:LXa/q;
