...
# direct methods
.method public constructor <init>(Lzd/c;II)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, p1, p2, p3}, Lio/reactivex/internal/operators/parallel/ParallelJoin$JoinSubscriptionBase;-><init>(Lzd/c;II)V
...
.method public drainLoop()V
    ...
    iget-object v3, v0, Lio/reactivex/internal/operators/parallel/ParallelJoin$JoinSubscriptionBase;->downstream:Lzd/c;
    ...
    invoke-interface {v3, v12}, Lzd/c;->onError(Ljava/lang/Throwable;)V
    ...
    iget-object v13, v4, Lio/reactivex/internal/operators/parallel/ParallelJoin$JoinInnerSubscriber;->queue:Lbb/f;

    if-eqz v13, :cond_5

    invoke-interface {v13}, Lbb/g;->poll()Ljava/lang/Object;

    move-result-object v13

    if-eqz v13, :cond_5

    invoke-interface {v3, v13}, Lzd/c;->onNext(Ljava/lang/Object;)V
    ...
    invoke-interface {v3, v4}, Lzd/c;->onError(Ljava/lang/Throwable;)V
    ...
    iget-object v13, v13, Lio/reactivex/internal/operators/parallel/ParallelJoin$JoinInnerSubscriber;->queue:Lbb/f;

    if-eqz v13, :cond_c

    invoke-interface {v13}, Lbb/g;->isEmpty()Z
...
.method public onNext(Lio/reactivex/internal/operators/parallel/ParallelJoin$JoinInnerSubscriber;Ljava/lang/Object;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/parallel/ParallelJoin$JoinSubscriptionBase;->downstream:Lzd/c;
    ...
    :cond_1
    invoke-virtual {p1}, Lio/reactivex/internal/operators/parallel/ParallelJoin$JoinInnerSubscriber;->getQueue()Lbb/f;
    ...
    iget-object p2, p0, Lio/reactivex/internal/operators/parallel/ParallelJoin$JoinSubscriptionBase;->downstream:Lzd/c;
