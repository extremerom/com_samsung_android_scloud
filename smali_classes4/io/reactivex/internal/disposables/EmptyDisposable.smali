...
.method public static complete(LXa/b;)V
    ...
    invoke-interface {p0, v0}, LXa/b;->onSubscribe(Lio/reactivex/disposables/b;)V
...
.method public static complete(LXa/j;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p0, v0}, LXa/j;->onSubscribe(Lio/reactivex/disposables/b;)V

    invoke-interface {p0}, LXa/j;->onComplete()V

    return-void
.end method

.method public static complete(LXa/q;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p0, v0}, LXa/q;->onSubscribe(Lio/reactivex/disposables/b;)V
...
.method public static error(Ljava/lang/Throwable;LXa/j;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p1, p0}, LXa/j;->onError(Ljava/lang/Throwable;)V

    return-void
.end method

.method public static error(Ljava/lang/Throwable;LXa/q;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static error(Ljava/lang/Throwable;LXa/y;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p1, p0}, LXa/y;->onError(Ljava/lang/Throwable;)V
