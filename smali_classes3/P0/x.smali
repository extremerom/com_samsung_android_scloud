...
.method public constructor <init>(Lcom/google/android/material/textfield/TextInputLayout;Landroidx/appcompat/widget/TintTypedArray;)V
    ...
    iput-object p1, p0, LP0/x;->a:Lcom/google/android/material/textfield/TextInputLayout;
    ...
    iput-object v1, p0, LP0/x;->d:Lcom/google/android/material/internal/CheckableImageButton;
    ...
    iput-object v4, p0, LP0/x;->b:Landroidx/appcompat/widget/AppCompatTextView;

    invoke-virtual {p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v5

    invoke-static {v5}, LI0/d;->e(Landroid/content/Context;)Z
    ...
    :cond_0
    iget-object v5, p0, LP0/x;->j:Landroid/view/View$OnLongClickListener;

    const/4 v6, 0x0

    invoke-virtual {v1, v6}, Landroid/view/View;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    invoke-static {v1, v5}, Lcom/samsung/android/sdk/smp/marketing/n;->Q(Lcom/google/android/material/internal/CheckableImageButton;Landroid/view/View$OnLongClickListener;)V

    iput-object v6, p0, LP0/x;->j:Landroid/view/View$OnLongClickListener;

    invoke-virtual {v1, v6}, Landroid/view/View;->setOnLongClickListener(Landroid/view/View$OnLongClickListener;)V

    invoke-static {v1, v6}, Lcom/samsung/android/sdk/smp/marketing/n;->Q(Lcom/google/android/material/internal/CheckableImageButton;Landroid/view/View$OnLongClickListener;)V
    ...
    invoke-static {v7, p2, v5}, LI0/d;->b(Landroid/content/Context;Landroidx/appcompat/widget/TintTypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object v5

    iput-object v5, p0, LP0/x;->e:Landroid/content/res/ColorStateList;
    ...
    invoke-static {v5, v6}, Lcom/google/android/material/internal/t;->b(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object v5

    iput-object v5, p0, LP0/x;->f:Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-virtual {p0, v5}, LP0/x;->b(Landroid/graphics/drawable/Drawable;)V
    ...
    iget v7, p0, LP0/x;->g:I

    if-eq v5, v7, :cond_5

    iput v5, p0, LP0/x;->g:I
    ...
    invoke-static {v3}, Lcom/samsung/android/sdk/smp/marketing/n;->i(I)Landroid/widget/ImageView$ScaleType;

    move-result-object v3

    iput-object v3, p0, LP0/x;->h:Landroid/widget/ImageView$ScaleType;
    ...
    :goto_0
    iput-object v6, p0, LP0/x;->c:Ljava/lang/CharSequence;

    invoke-virtual {v4, p1}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    invoke-virtual {p0}, LP0/x;->e()V
...
.method public final a()I
    ...
    iget-object v0, p0, LP0/x;->d:Lcom/google/android/material/internal/CheckableImageButton;
    ...
    iget-object v2, p0, LP0/x;->b:Landroidx/appcompat/widget/AppCompatTextView;
...
.method public final b(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object p1, p0, LP0/x;->e:Landroid/content/res/ColorStateList;

    iget-object v1, p0, LP0/x;->f:Landroid/graphics/PorterDuff$Mode;

    iget-object v2, p0, LP0/x;->a:Lcom/google/android/material/textfield/TextInputLayout;
    ...
    invoke-virtual {p0, p1}, LP0/x;->c(Z)V

    iget-object p1, p0, LP0/x;->e:Landroid/content/res/ColorStateList;

    invoke-static {v2, v0, p1}, Lcom/samsung/android/sdk/smp/marketing/n;->O(Lcom/google/android/material/textfield/TextInputLayout;Lcom/google/android/material/internal/CheckableImageButton;Landroid/content/res/ColorStateList;)V
    ...
    iget-object p1, p0, LP0/x;->j:Landroid/view/View$OnLongClickListener;
    ...
    iput-object v1, p0, LP0/x;->j:Landroid/view/View$OnLongClickListener;
...
.method public final d()V
    ...
    iget-object v0, p0, LP0/x;->a:Lcom/google/android/material/textfield/TextInputLayout;
    ...
    :cond_0
    iget-object v1, p0, LP0/x;->d:Lcom/google/android/material/internal/CheckableImageButton;
    ...
    iget-object v4, p0, LP0/x;->b:Landroidx/appcompat/widget/AppCompatTextView;
...
.method public final e()V
    ...
    iget-object v0, p0, LP0/x;->c:Ljava/lang/CharSequence;
    ...
    :goto_0
    iget-object v3, p0, LP0/x;->d:Lcom/google/android/material/internal/CheckableImageButton;
    ...
    iget-object v1, p0, LP0/x;->b:Landroidx/appcompat/widget/AppCompatTextView;
