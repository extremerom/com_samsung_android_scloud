...
.method public synthetic constructor <init>(Ljava/lang/String;ILcom/google/common/cache/m;)V
    .locals 0
...
# virtual methods
.method public copyAccessEntry(Lcom/google/common/cache/S;Lcom/google/common/cache/S;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<K:",
    ...
    invoke-interface {p2, v0, v1}, Lcom/google/common/cache/S;->setAccessTime(J)V

    invoke-interface {p1}, Lcom/google/common/cache/S;->getPreviousInAccessQueue()Lcom/google/common/cache/S;

    move-result-object v0

    sget-object v1, Lcom/google/common/cache/M;->z:Ljava/util/logging/Logger;

    invoke-interface {v0, p2}, Lcom/google/common/cache/S;->setNextInAccessQueue(Lcom/google/common/cache/S;)V

    invoke-interface {p2, v0}, Lcom/google/common/cache/S;->setPreviousInAccessQueue(Lcom/google/common/cache/S;)V

    invoke-interface {p1}, Lcom/google/common/cache/S;->getNextInAccessQueue()Lcom/google/common/cache/S;

    move-result-object v0

    invoke-interface {p2, v0}, Lcom/google/common/cache/S;->setNextInAccessQueue(Lcom/google/common/cache/S;)V

    invoke-interface {v0, p2}, Lcom/google/common/cache/S;->setPreviousInAccessQueue(Lcom/google/common/cache/S;)V

    sget-object p2, Lcom/google/common/cache/LocalCache$NullEntry;->INSTANCE:Lcom/google/common/cache/LocalCache$NullEntry;

    invoke-interface {p1, p2}, Lcom/google/common/cache/S;->setNextInAccessQueue(Lcom/google/common/cache/S;)V

    invoke-interface {p1, p2}, Lcom/google/common/cache/S;->setPreviousInAccessQueue(Lcom/google/common/cache/S;)V
...
.method public copyEntry(Lcom/google/common/cache/LocalCache$Segment;Lcom/google/common/cache/S;Lcom/google/common/cache/S;Ljava/lang/Object;)Lcom/google/common/cache/S;
    ...
    invoke-interface {p2}, Lcom/google/common/cache/S;->getHash()I

    move-result p2

    invoke-virtual {p0, p1, p4, p2, p3}, Lcom/google/common/cache/LocalCache$EntryFactory;->newEntry(Lcom/google/common/cache/LocalCache$Segment;Ljava/lang/Object;ILcom/google/common/cache/S;)Lcom/google/common/cache/S;
...
.method public copyWriteEntry(Lcom/google/common/cache/S;Lcom/google/common/cache/S;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<K:",
    ...
    invoke-interface {p2, v0, v1}, Lcom/google/common/cache/S;->setWriteTime(J)V
    ...
    invoke-interface {v0, p2}, Lcom/google/common/cache/S;->setNextInWriteQueue(Lcom/google/common/cache/S;)V

    invoke-interface {p2, v0}, Lcom/google/common/cache/S;->setPreviousInWriteQueue(Lcom/google/common/cache/S;)V

    invoke-interface {p1}, Lcom/google/common/cache/S;->getNextInWriteQueue()Lcom/google/common/cache/S;

    move-result-object v0

    invoke-interface {p2, v0}, Lcom/google/common/cache/S;->setNextInWriteQueue(Lcom/google/common/cache/S;)V

    invoke-interface {v0, p2}, Lcom/google/common/cache/S;->setPreviousInWriteQueue(Lcom/google/common/cache/S;)V

    sget-object p2, Lcom/google/common/cache/LocalCache$NullEntry;->INSTANCE:Lcom/google/common/cache/LocalCache$NullEntry;

    invoke-interface {p1, p2}, Lcom/google/common/cache/S;->setNextInWriteQueue(Lcom/google/common/cache/S;)V

    invoke-interface {p1, p2}, Lcom/google/common/cache/S;->setPreviousInWriteQueue(Lcom/google/common/cache/S;)V

    return-void
.end method

.method public abstract newEntry(Lcom/google/common/cache/LocalCache$Segment;Ljava/lang/Object;ILcom/google/common/cache/S;)Lcom/google/common/cache/S;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<K:",
            "Ljava/lang/Object;",
