.class public Lcom/samsung/android/scloud/galleryproxy/contentcard/media/NewGalleryDataStore;
...
.field private mediaConvertUtil:Lcom/samsung/android/scloud/galleryproxy/contentcard/media/NewGalleryConvertible;
...
.method public constructor <init>()V
    ...
    new-instance v0, Lcom/samsung/android/scloud/galleryproxy/contentcard/media/NewGalleryConvertible;

    invoke-direct {v0}, Lcom/samsung/android/scloud/galleryproxy/contentcard/media/NewGalleryConvertible;-><init>()V

    iput-object v0, p0, Lcom/samsung/android/scloud/galleryproxy/contentcard/media/NewGalleryDataStore;->mediaConvertUtil:Lcom/samsung/android/scloud/galleryproxy/contentcard/media/NewGalleryConvertible;
    ...
    iput-object v0, p0, Lcom/samsung/android/scloud/galleryproxy/contentcard/media/NewGalleryDataStore;->URI:Landroid/net/Uri;
...
.method private synthetic lambda$create$0(ILjava/util/List;Ljava/lang/Integer;Ljava/lang/Integer;)Ljava/lang/Integer;
    ...
    invoke-virtual {p0}, Lcom/samsung/android/scloud/galleryproxy/contentcard/media/NewGalleryDataStore;->getTag()Ljava/lang/String;
    ...
    iget-object p1, p0, Lcom/samsung/android/scloud/galleryproxy/contentcard/media/NewGalleryDataStore;->mediaConvertUtil:Lcom/samsung/android/scloud/galleryproxy/contentcard/media/NewGalleryConvertible;
    ...
    invoke-virtual {p1, p2}, Lcom/samsung/android/scloud/galleryproxy/contentcard/media/NewGalleryConvertible;->toContentValuesList(Ljava/util/List;)Ljava/util/List;
    ...
    iget-object v0, p0, Lcom/samsung/android/scloud/galleryproxy/contentcard/media/NewGalleryDataStore;->URI:Landroid/net/Uri;
...
.method public bulkUpdate(Ljava/util/List;)V
    ...
    iget-object v2, p0, Lcom/samsung/android/scloud/galleryproxy/contentcard/media/NewGalleryDataStore;->mediaConvertUtil:Lcom/samsung/android/scloud/galleryproxy/contentcard/media/NewGalleryConvertible;

    invoke-virtual {v2, v1}, Lcom/samsung/android/scloud/galleryproxy/contentcard/media/NewGalleryConvertible;->toContentValues(Lcom/samsung/android/scloud/galleryproxy/contentcard/media/GalleryContentVo;)Landroid/content/ContentValues;
    ...
    iget-object v3, p0, Lcom/samsung/android/scloud/galleryproxy/contentcard/media/NewGalleryDataStore;->URI:Landroid/net/Uri;
...
.method public create(Ljava/util/List;)V
    ...
    invoke-direct {p0, v0, p1, v2, v3}, Lcom/samsung/android/scloud/galleryproxy/contentcard/media/NewGalleryDataStore;->lambda$create$0(ILjava/util/List;Ljava/lang/Integer;Ljava/lang/Integer;)Ljava/lang/Integer;
...
.method public bridge synthetic getId(Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-virtual {p0, p1}, Lcom/samsung/android/scloud/galleryproxy/contentcard/media/NewGalleryDataStore;->getId(Lsamsung/scsp/media/attribute/Media;)Ljava/lang/String;
...
.method public getId(Lsamsung/scsp/media/attribute/Media;)Ljava/lang/String;
    .locals 0
...
.method public readItem(Lcom/samsung/android/scloud/galleryproxy/contentcard/media/GalleryContentVo;)Landroid/database/Cursor;
    ...
    iget-object v1, p0, Lcom/samsung/android/scloud/galleryproxy/contentcard/media/NewGalleryDataStore;->URI:Landroid/net/Uri;
...
.method public bridge synthetic readItem(Ljava/lang/Object;)Landroid/database/Cursor;
    ...
    invoke-virtual {p0, p1}, Lcom/samsung/android/scloud/galleryproxy/contentcard/media/NewGalleryDataStore;->readItem(Lcom/samsung/android/scloud/galleryproxy/contentcard/media/GalleryContentVo;)Landroid/database/Cursor;
