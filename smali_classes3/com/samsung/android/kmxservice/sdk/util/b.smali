...
.method public constructor <init>(Ljava/security/cert/X509Certificate;)V
    ...
    invoke-static {v0}, Lcom/samsung/android/kmxservice/sdk/util/f;->e([B)LHb/x;
    ...
    invoke-static {v2}, Lcom/samsung/android/kmxservice/sdk/util/f;->h(LHb/g;)I
    ...
    invoke-static {v3}, Lcom/samsung/android/kmxservice/sdk/util/f;->h(LHb/g;)I

    const/4 v3, 0x2

    invoke-virtual {v0, v3}, LHb/x;->q(I)LHb/g;

    move-result-object v4

    invoke-static {v4}, Lcom/samsung/android/kmxservice/sdk/util/f;->h(LHb/g;)I
    ...
    invoke-static {v5}, Lcom/samsung/android/kmxservice/sdk/util/f;->h(LHb/g;)I

    const/4 v5, 0x4

    invoke-virtual {v0, v5}, LHb/x;->q(I)LHb/g;

    move-result-object v6

    invoke-static {v6}, Lcom/samsung/android/kmxservice/sdk/util/f;->g(LHb/g;)[B
    ...
    invoke-virtual {v0, v6}, LHb/x;->q(I)LHb/g;

    move-result-object v7

    invoke-static {v7}, Lcom/samsung/android/kmxservice/sdk/util/f;->g(LHb/g;)[B

    new-instance v7, Lcom/samsung/android/kmxservice/sdk/util/e;

    const/4 v8, 0x6

    invoke-virtual {v0, v8}, LHb/x;->q(I)LHb/g;

    move-result-object v8

    invoke-direct {v7, v8}, Lcom/samsung/android/kmxservice/sdk/util/e;-><init>(LHb/g;)V
    ...
    invoke-direct {v7, v0}, Lcom/samsung/android/kmxservice/sdk/util/e;-><init>(LHb/g;)V
    ...
    invoke-virtual {v0, v9}, LHb/x;->q(I)LHb/g;

    move-result-object v10

    instance-of v11, v10, LHb/B;

    if-eqz v11, :cond_9

    check-cast v10, LHb/B;

    iget v11, v10, LHb/B;->c:I

    if-ne v11, v6, :cond_9

    new-instance v7, Lcom/samsung/android/kmxservice/sdk/util/g;

    invoke-virtual {v10}, LHb/B;->q()LHb/t;
    ...
    :cond_4
    invoke-virtual {v9}, LHb/B;->q()LHb/t;

    move-result-object v9

    check-cast v9, LHb/i;

    invoke-virtual {v9}, LHb/i;->o()Ljava/math/BigInteger;
...
.method public final a()Lcom/samsung/android/kmxservice/sdk/util/g;
    ...
    iget-object v0, p0, Lcom/samsung/android/kmxservice/sdk/util/b;->c:Lcom/samsung/android/kmxservice/sdk/util/g;
