.class public final Lcom/samsung/android/kmxservice/sdk/util/j;
...
.method static constructor <clinit>()V
    ...
    const-class v0, Lcom/samsung/android/kmxservice/sdk/util/j;
    ...
    sput-object v0, Lcom/samsung/android/kmxservice/sdk/util/j;->b:Ljava/lang/String;
...
.method public constructor <init>()V
    ...
    invoke-static {v0}, Lcom/samsung/android/kmxservice/sdk/util/f;->d(Landroidx/compose/ui/graphics/colorspace/b;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lcom/samsung/android/security/keystore/AttestationUtils;

    iput-object v0, p0, Lcom/samsung/android/kmxservice/sdk/util/j;->a:Lcom/samsung/android/security/keystore/AttestationUtils;
...
.method public static e(Ljava/lang/String;Z)Ljava/lang/String;
    ...
    sget-object p1, Lcom/samsung/android/kmxservice/sdk/util/j;->b:Ljava/lang/String;
...
.method public static g([Ljava/security/cert/Certificate;[B)Z
    ...
    sget-object v0, Lcom/samsung/android/kmxservice/sdk/util/j;->b:Ljava/lang/String;
    ...
    :try_end_0
    .catch Ljava/security/cert/CertificateParsingException; {:try_start_0 .. :try_end_0} :catch_5
    ...
    :cond_5
    iget-object p0, p0, Lcom/samsung/android/kmxservice/sdk/util/e;->b:LJ9/b;

    iget p1, p0, LJ9/b;->c:I
    ...
    invoke-static {p0}, Lcom/samsung/android/kmxservice/sdk/util/h;->a(Ljava/lang/String;)Ljava/security/cert/X509Certificate;
...
.method public final b()I
    ...
    iget-object v3, p0, Lcom/samsung/android/kmxservice/sdk/util/j;->a:Lcom/samsung/android/security/keystore/AttestationUtils;
    ...
    const-string v2, "Not support attestation utils. Need to check build version :"
    ...
    monitor-enter v3
    :try_end_0
    .catch Lcom/samsung/android/security/keystore/DeviceIdAttestationException; {:try_start_0 .. :try_end_0} :catch_2
    .catch Ljava/security/KeyStoreException; {:try_start_0 .. :try_end_0} :catch_1

    :try_start_1
    iget-object v5, p0, Lcom/samsung/android/kmxservice/sdk/util/j;->a:Lcom/samsung/android/security/keystore/AttestationUtils;
    ...
    sget-object v5, Lcom/samsung/android/kmxservice/sdk/util/j;->b:Ljava/lang/String;
    ...
    iget-object v6, p0, Lcom/samsung/android/kmxservice/sdk/util/j;->a:Lcom/samsung/android/security/keystore/AttestationUtils;
    ...
    const-string v1, "getDeviceIntegrity certChain is null"
    ...
    :try_start_2
    new-instance v6, Lcom/samsung/android/kmxservice/sdk/util/b;

    invoke-direct {v6, v0}, Lcom/samsung/android/kmxservice/sdk/util/b;-><init>(Ljava/security/cert/X509Certificate;)V
    :try_end_2
    .catch Ljava/security/cert/CertificateParsingException; {:try_start_2 .. :try_end_2} :catch_0
    .catchall {:try_start_2 .. :try_end_2} :catchall_0

    :try_start_3
    invoke-virtual {v6}, Lcom/samsung/android/kmxservice/sdk/util/b;->a()Lcom/samsung/android/kmxservice/sdk/util/g;

    move-result-object v0

    if-eqz v0, :cond_a

    iget v6, v0, Lcom/samsung/android/kmxservice/sdk/util/g;->a:I
    ...
    :cond_3
    iget v8, v0, Lcom/samsung/android/kmxservice/sdk/util/g;->b:I
    ...
    :cond_4
    iget v9, v0, Lcom/samsung/android/kmxservice/sdk/util/g;->c:I
    ...
    sget-object v1, Lcom/samsung/android/kmxservice/sdk/util/j;->b:Ljava/lang/String;
    ...
    const-string v2, "getDeviceIntegrity certificate Parsing Error : "
    ...
    throw v0
    :try_end_4
    .catch Lcom/samsung/android/security/keystore/DeviceIdAttestationException; {:try_start_4 .. :try_end_4} :catch_2
...
.method public final c()Ljava/lang/String;
    ...
    invoke-static {v1}, Lcom/samsung/android/kmxservice/sdk/util/k;->a(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    iget-object v2, p0, Lcom/samsung/android/kmxservice/sdk/util/j;->a:Lcom/samsung/android/security/keystore/AttestationUtils;
    ...
    :try_start_1
    iget-object v4, p0, Lcom/samsung/android/kmxservice/sdk/util/j;->a:Lcom/samsung/android/security/keystore/AttestationUtils;
    ...
    invoke-static {v4, v5}, Lcom/samsung/android/kmxservice/sdk/util/j;->g([Ljava/security/cert/Certificate;[B)Z
    ...
    const-string v1, "certificate chain verification failed."
    ...
    invoke-static {v0, v1}, Lcom/samsung/android/kmxservice/sdk/util/j;->e(Ljava/lang/String;Z)Ljava/lang/String;
...
.method public final d(Ljava/lang/String;[B)[Ljava/security/cert/X509Certificate;
    .locals 8

    const-string v0, "getWrapKey cetChain length error 2: "

    const-string v1, "getWrapKey cetChain length error! Retry key generation : "

    const-string v2, "generate key for wrap key. : "

    sget-object v3, Lcom/samsung/android/kmxservice/sdk/util/j;->b:Ljava/lang/String;

    new-instance v4, Ljava/lang/StringBuilder;

    const-string v5, "[getWrapKey] : "
    ...
    invoke-direct {v6, p1, p2}, Lcom/samsung/android/security/keystore/AttestParameterSpec$Builder;-><init>(Ljava/lang/String;[B)V

    const-string p2, "RSA"

    invoke-virtual {v6, p2}, Lcom/samsung/android/security/keystore/AttestParameterSpec$Builder;->setAlgorithm(Ljava/lang/String;)Lcom/samsung/android/security/keystore/AttestParameterSpec$Builder;

    move-result-object p2

    invoke-virtual {p2, v4}, Lcom/samsung/android/security/keystore/AttestParameterSpec$Builder;->setKeyGenParameterSpec(Landroid/security/keystore/KeyGenParameterSpec;)Lcom/samsung/android/security/keystore/AttestParameterSpec$Builder;

    move-result-object p2

    const/4 v4, 0x1

    invoke-virtual {p2, v4}, Lcom/samsung/android/security/keystore/AttestParameterSpec$Builder;->setVerifiableIntegrity(Z)Lcom/samsung/android/security/keystore/AttestParameterSpec$Builder;
    ...
    invoke-virtual {v6, p1}, Lcom/samsung/android/security/keystore/AttestationUtils;->getKey(Ljava/lang/String;)Ljava/security/Key;
    ...
    invoke-virtual {v2, p2}, Lcom/samsung/android/security/keystore/AttestationUtils;->generateKeyPair(Lcom/samsung/android/security/keystore/AttestParameterSpec;)Ljava/security/KeyPair;
    ...
    invoke-virtual {v2, p1}, Lcom/samsung/android/security/keystore/AttestationUtils;->getCertificateChain(Ljava/lang/String;)[Ljava/security/cert/Certificate;
    ...
    const-string v1, "getWrapKey certChain is NULL. Retry key generation."
    ...
    :goto_0
    iget-object v1, p0, Lcom/samsung/android/kmxservice/sdk/util/j;->a:Lcom/samsung/android/security/keystore/AttestationUtils;

    invoke-virtual {v1, p2}, Lcom/samsung/android/security/keystore/AttestationUtils;->generateKeyPair(Lcom/samsung/android/security/keystore/AttestParameterSpec;)Ljava/security/KeyPair;
    ...
    :cond_3
    iget-object p2, p0, Lcom/samsung/android/kmxservice/sdk/util/j;->a:Lcom/samsung/android/security/keystore/AttestationUtils;

    invoke-virtual {p2, p1}, Lcom/samsung/android/security/keystore/AttestationUtils;->getCertificateChain(Ljava/lang/String;)[Ljava/security/cert/Certificate;
    ...
    new-array v5, p1, [Ljava/security/cert/X509Certificate;
...
.method public final f()V
    ...
    invoke-virtual {v1, v0}, Lcom/samsung/android/security/keystore/AttestationUtils;->deleteKey(Ljava/lang/String;)V
