...
.method public static d(Landroidx/compose/ui/graphics/colorspace/b;)Ljava/lang/Object;
    .locals 0

    :try_start_0
    invoke-static {}, Lcom/samsung/android/kmxservice/sdk/util/j;->a()Lcom/samsung/android/security/keystore/AttestationUtils;
...
.method public static e([B)LHb/x;
    .locals 2
    ...
    :try_start_1
    invoke-static {v0}, Lcom/samsung/android/kmxservice/sdk/util/f;->f(LHb/k;)LHb/x;
...
.method public static f(LHb/k;)LHb/x;
    .locals 3

    const-string v0, "Expected sequence, found "

    invoke-virtual {p0}, LHb/k;->f()LHb/t;

    move-result-object p0

    instance-of v1, p0, LHb/r;
    ...
    invoke-direct {v1, p0}, LHb/k;-><init>([B)V
...
.method public static g(LHb/g;)[B
    .locals 2
    ...
    :cond_1
    instance-of v1, p0, LHb/d0;

    if-eqz v1, :cond_2

    check-cast p0, LHb/d0;

    iget-object p0, p0, LHb/d0;->a:[B
...
.method public static h(LHb/g;)I
    .locals 3
    ...
    :cond_0
    instance-of v0, p0, LHb/i;

    if-eqz v0, :cond_1

    check-cast p0, LHb/i;

    invoke-virtual {p0}, LHb/i;->o()Ljava/math/BigInteger;
...
.method public static i(LHb/t;)Ljava/util/HashSet;
    .locals 4
    ...
    invoke-static {v1}, Lcom/samsung/android/kmxservice/sdk/util/f;->h(LHb/g;)I
...
.method public static j(LHb/g;)Ljava/lang/Long;
    .locals 3
...
.method public static l(LHb/g;)Ljava/lang/String;
    .locals 2
